...
ac.AGENT_REPORT_ID, pp.pol_ser || '-' || pp.pol_num pol_num, pi.contact_name strahov_name,
       ...
       drd.reg_date date_pay, nvl(ac.sum_premium,0) sum_premium, nvl(ac.comission_sum,0) comission_sum,
