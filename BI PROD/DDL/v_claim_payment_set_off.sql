create or replace view v_claim_payment_set_off as
select
  dso.parent_doc_id,
  dso.doc_set_off_id,
  dso.child_doc_id,
...
where
  ...
  cp.payment_id  = ai.ac_payment_add_info_id(+) and
...
union
select
  dso.child_doc_id parent_doc_id,
  dso.doc_set_off_id,
