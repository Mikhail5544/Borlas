create or replace view V_ANNULATION_NOTICE as
SELECT
/*
Договоры страхования, с признаком «Групповой договор» равным «0 – нет», 
для которых существует документ вида «Заявление на изменение условий договоров»
с типом «Заявление на аннулирование» в статусе «Готов к обработке»
26.12.2015 Черных М.
*/
 pph.policy_id,
 ...
 WHERE cn.p_pol_change_notice_id = d.document_id
   ...
   AND typ.brief = 'ANNULATE' /*Заявление на аннулирование*/
