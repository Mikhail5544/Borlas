CREATE OR REPLACE FORCE VIEW V_REPORT_PREDIR_DOG_PROD AS
SELECT count(1) over() row_cnt,
agd.AGENT_REPORT_ID, pp.pol_ser || '-' || pp.pol_num pol_num,
pi.contact_name strahov_name,
