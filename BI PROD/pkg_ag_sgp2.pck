CREATE OR REPLACE PACKAGE pkg_ag_sgp2 IS
...
END pkg_ag_sgp2;
/
CREATE OR REPLACE PACKAGE BODY pkg_ag_sgp2 IS
  ...
  BEGIN
    FOR cur_sgp IN (SELECT ch.ag_contract_header_id
                     ...
                     WHERE Pkg_Agent_1.get_status_by_date(ch.ag_contract_header_id
                       ...
                       AND c.category_id IN (SELECT ah.ag_category_agent_id
    ...
    LOOP
      ...
      v_ag_sgp2_id := v_ag_sgp.ag_sgp_id;
      ...
      p_ret := pkg_ag_sgp.UpdateSummSgp(v_ag_sgp2_id);
