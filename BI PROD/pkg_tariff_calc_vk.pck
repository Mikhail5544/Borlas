CREATE OR REPLACE PACKAGE pkg_tariff_calc_vk IS
...
END pkg_tariff_calc_vk;
/
CREATE OR REPLACE PACKAGE BODY Pkg_Tariff_Calc_vk IS
    ...
    BEGIN
      CASE
        ...
        WHEN v_at_brief = 'S_FUNC' THEN
          v_result := calc_fun(v_tariff_id, p_ent_id, p_obj_id, p_rules);
        ELSE
          NULL;
      END CASE;
      -- exception
    ...
    THEN
      ...
      SELECT t.val
        ...
        FROM (SELECT pc.t_prod_coef_id val
               ...
               WHERE pct.t_prod_coef_type_id = p_id
                 AND pc.t_prod_coef_type_id = pct.t_prod_coef_type_id
                 AND ((pct.comparator_1 = 1 AND pc.criteria_1 = TO_NUMBER(p_sc_1)) OR
                     ((pct.comparator_1 = 2 AND
                     pc.criteria_1 <= (SELECT MIN(c.criteria_1)
                                            FROM T_PROD_COEF c
                                           WHERE c.t_prod_coef_type_id = pct.t_prod_coef_type_id
                                             AND c.criteria_1 >= TO_NUMBER(p_sc_1))) AND
                     (pct.comparator_1 = 2 AND pc.criteria_1 >= TO_NUMBER(p_sc_1))))
               ORDER BY pc.criteria_1 DESC) t
       WHERE ROWNUM = 1;
                      ...
                      SELECT *
                       ...
                       WHERE pct2.t_prod_coef_type_id = p_id
                         ...
                         AND ((pct2.comparator_2 = 1 AND pc2.criteria_2 = TO_NUMBER(p_sc_2)) OR
                             (pct2.comparator_2 = 2 AND pc2.criteria_2 >= TO_NUMBER(p_sc_2)))) t
               ORDER BY t.criteria_1
                       ,t.criteria_2) tt
       WHERE ROWNUM = 1;
                      ...
                      SELECT *
                       ...
                       WHERE pct3.t_prod_coef_type_id = p_id
                         ...
                         AND ((pct3.comparator_3 = 1 AND pc3.criteria_3 = TO_NUMBER(p_sc_3)) OR
                             (pct3.comparator_3 = 2 AND pc3.criteria_3 >= TO_NUMBER(p_sc_3)))) t
               ORDER BY t.criteria_1
                       ,t.criteria_2
                       ,t.criteria_3) tt
       WHERE ROWNUM = 1;
                      ...
                      SELECT *
                       ...
                       WHERE pct4.t_prod_coef_type_id = p_id
                         ...
                         AND ((pct4.comparator_4 = 1 AND pc4.criteria_4 = TO_NUMBER(p_sc_4)) OR
                             (pct4.comparator_4 = 2 AND pc4.criteria_4 >= TO_NUMBER(p_sc_4)))) t
               ORDER BY t.criteria_1
                       ,t.criteria_2
                       ,t.criteria_3
                       ,t.criteria_4) tt
                      ...
                      SELECT *
                       ...
                       WHERE pct5.t_prod_coef_type_id = p_id
                         ...
                         AND ((pct5.comparator_5 = 1 AND pc5.criteria_5 = TO_NUMBER(p_sc_5)) OR
                             (pct5.comparator_5 = 2 AND pc5.criteria_5 >= TO_NUMBER(p_sc_5)))) t
               ORDER BY t.criteria_1
                       ,t.criteria_2
                       ,t.criteria_3
                       ,t.criteria_4
                      ...
                      SELECT *
                       ...
                       WHERE pct6.t_prod_coef_type_id = p_id
                         ...
                         AND ((pct6.comparator_6 = 1 AND pc6.criteria_6 = (p_sc_6)) OR
                             (pct6.comparator_6 = 2 AND pc6.criteria_6 >= (p_sc_6)))) t
               ORDER BY t.criteria_1
                       ,t.criteria_2
                       ,t.criteria_3
                       ,t.criteria_4
                      ...
                      SELECT *
                       ...
                       WHERE pct7.t_prod_coef_type_id = p_id
                         ...
                         AND ((pct7.comparator_7 = 1 AND pc7.criteria_7 = TO_NUMBER(p_sc_7)) OR
                             (pct7.comparator_7 = 2 AND pc7.criteria_7 >= TO_NUMBER(p_sc_7)))) t
               ORDER BY t.criteria_1
                       ,t.criteria_2
                       ,t.criteria_3
                       ,t.criteria_4
                      ...
                      SELECT *
                       ...
                       WHERE pct8.t_prod_coef_type_id = p_id
                         ...
                         AND ((pct8.comparator_8 = 1 AND pc8.criteria_8 = TO_NUMBER(p_sc_8)) OR
                             (pct8.comparator_8 = 2 AND pc8.criteria_8 >= TO_NUMBER(p_sc_8)))) t
               ORDER BY t.criteria_1
                       ,t.criteria_2
                       ,t.criteria_3
                       ,t.criteria_4
                      ...
                      SELECT *
                       ...
                       WHERE pct9.t_prod_coef_type_id = p_id
                         ...
                         AND ((pct9.comparator_9 = 1 AND pc9.criteria_9 = TO_NUMBER(p_sc_9)) OR
                             (pct9.comparator_9 = 2 AND pc9.criteria_9 >= TO_NUMBER(p_sc_9)))) t
               ORDER BY t.criteria_1
                       ,t.criteria_2
                       ,t.criteria_3
                       ,t.criteria_4
                      ...
                      SELECT *
                       ...
                       WHERE pct10.t_prod_coef_type_id = p_id
                         ...
                         AND ((pct10.comparator_10 = 1 AND pc10.criteria_10 = TO_NUMBER(p_sc_10)) OR
                             (pct10.comparator_10 = 2 AND pc10.criteria_10 >= TO_NUMBER(p_sc_10)))) t
               ORDER BY t.criteria_1
                       ,t.criteria_2
                       ,t.criteria_3
                       ,t.criteria_4
  ...
  */
  ...
  BEGIN
    ...
    SELECT t.brief
      ...
      INTO v_brief
          ...
          ,f10
          ,f11
      FROM T_PROD_COEF_TYPE_VK t
     WHERE t.t_prod_coef_type_id = p_id;
  
    ---DBMS_OUTPUT.PUT_LINE(4);
  
    at_1 := get_attribut(p_ent_id, p_obj_id, f1, p_rules);
    --dbms_output.put_line ('at_1 '||at_1);
    at_2 := get_attribut(p_ent_id, p_obj_id, f2, p_rules);
    --dbms_output.put_line ('at_2 '||at_2);
    at_3 := get_attribut(p_ent_id, p_obj_id, f3, p_rules);
    --dbms_output.put_line ('at_3 '||at_3);
    at_4 := get_attribut(p_ent_id, p_obj_id, f4, p_rules);
    --dbms_output.put_line ('at_4 '||at_4);
    at_5 := get_attribut(p_ent_id, p_obj_id, f5, p_rules);
    --dbms_output.put_line ('at_5 '||at_5);
    at_6 := get_attribut(p_ent_id, p_obj_id, f6, p_rules);
    --dbms_output.put_line ('at_6 '||at_6);
    at_7 := get_attribut(p_ent_id, p_obj_id, f7, p_rules);
    --dbms_output.put_line ('at_7 '||at_7);
    at_8 := get_attribut(p_ent_id, p_obj_id, f8, p_rules);
    --dbms_output.put_line ('at_8 '||at_8);
    at_9 := get_attribut(p_ent_id, p_obj_id, f9, p_rules);
    --dbms_output.put_line ('at_9 '||at_9);
    at_10 := get_attribut(p_ent_id, p_obj_id, f10, p_rules);
    --dbms_output.put_line ('at_10 '||at_10);
    at_11 := p_rules;
    ...
    THEN
      ...
      ---DBMS_OUTPUT.PUT_LINE('8: '||v_sql_parse);
      ...
      IF k > 0
      THEN
        DBMS_SQL.BIND_VARIABLE(c, 'p11', at_11);
        k := k - 1;
      END IF;
      ...
      EXCEPTION
        WHEN OTHERS THEN
          ...
          RAISE_APPLICATION_ERROR(-20000, 'Ошибка вычисления PL\SQL функции');
      END;
    ...
    THEN
      v_result := calc_fun(v_other, p_ent_id, p_obj_id, p_rules);
    ELSE
      NULL;
    END IF;
  ...
  BEGIN
    ...
    SELECT t.t_prod_coef_type_id INTO v_id FROM T_PROD_COEF_TYPE t WHERE t.brief = p_brief;
    v_result := calc_fun(v_id, p_ent_id, p_obj_id, p_rules);
    RETURN v_result;
  END;
