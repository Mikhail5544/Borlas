...
select pr.description product_name, -- продукт
       ...
       ce.date_declare notice_date, -- дата оповещения
       cc.claim_status_date claim_date, -- дата заявления
       ins.pkg_claim.get_declare_sum(ph.policy_header_id,cc.claim_status_date) prev_loss_amount -- ранее заявленные убытки
