...
from p_policy pp,
        ...
        cn_person per,
        t_profession prof
where ii.policy_id = pp.policy_id and ii.contact_policy_role_id = 6
...
begin
--382489 Григорьев Ю.А. Добавил параметр, зависящий от страховой суммы (СС), для печати подписей администрации компании в зависисимости от СС (см. применение в конце файла отчета)
