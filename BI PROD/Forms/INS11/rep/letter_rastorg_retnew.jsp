...
<report name="letter_rastorg_retnew" DTDVersion="9.0.2.0.10">
  <data>
    <userParameter name="P_PID"/>
      ...
      <![CDATA[select rownum rec_number,
       ...
       f.brief
       from v_letters_payment vlp, ven_p_policy pp, ven_p_pol_header ph, ven_fund f
...
<title>Письмо-уведомление о расторжении в связи с неуплатой очередного взноса (наличие необходимости возврата выкупной суммы и новые условия страхования)</title>
<style>
<!--
 /* Font Definitions */
 @font-face
...
Вас настоящим письмом о том, что в соответствии с п. 12.2.1 Общих условий страхования,
...
Вам в связи с расторжением договора сумма в размере <i><rw:field id="f_summa" src="summa"/> 
<rw:field id="f_fund" src="brief"/></i> будет
перечислена на указанный Вами в Заявлении на страхование расчетный счет. Если
по каким-то причинам Вы не указали в Заявлении необходимые данные или произошло
изменение этих данных, просим Вас направить в адрес нашей Компании письмо с
указанием реквизитов (наименование банка, БИК, ИНН, корр. счет, расчетный счет, лицевой счет),
