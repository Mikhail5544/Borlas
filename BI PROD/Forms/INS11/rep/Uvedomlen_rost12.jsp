...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=638
 ...
 <tr style='mso-yfti-irow:18;height:104.3pt'>
  ...
  уведомляет Вас об одностороннем расторжении Агентского Договора № <rw:field id="" src="NUM"></rw:field> от <rw:field id="" src="date_start_dov" formatMask="DD.MM.YYYY"/>,
  заключенного путем присоединения к Агентскому договору (Присоединения), утвержденного приказом № 83-5/ОД/09
   от 25.09.2009. Датой расторжения Агентского Договора (Присоединения) является <rw:field id="" src="DAT_R" formatMask="DD.MM.YYYY"></rw:field>.
