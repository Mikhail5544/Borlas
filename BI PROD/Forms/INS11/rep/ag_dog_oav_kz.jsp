...
именуемое в дальнейшем Страховщик, в лице Смышляева Юрия Олеговича, действующего на основании Доверенности № <%=PNUM_DOC_DIR%> выданой <%=DATAV_DOC_DIR%>,
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width="100%"
   ...
   <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:71.6pt;page-break-inside:avoid'>
    ...
    mso-line-height-rule:exactly'><span class=SpellE>  Смышляев Ю. О.
...
<p class=MsoTitle style='margin-top:6.0pt;text-align:justify;tab-stops:0in'><span
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'><%=ORGNAME%>,
именуемое в дальнейшем Страховщик, в лице Смышляева Юрия Олеговича, действующего на основании Доверенности № ______________, выданной
