...
<report name="ag_dop_rost" DTDVersion="9.0.2.0.10">
  ...
  <data>
    ...
    <dataSource name="Q_1">
      <select canParse="no">
      <![CDATA[SELECT ach.agent_id
      ,ach.ag_contract_header_id
      ,(SELECT agd.doc_date
          FROM ag_contract_header ach1
              ,ag_documents       agd
              ,ins.ag_doc_type    adt
         WHERE agd.ag_contract_header_id = ach1.ag_contract_header_id
           AND agd.ag_doc_type_id = adt.ag_doc_type_id
           AND adt.brief = 'BREAK_AD'
           AND ach1.is_new = 1
           AND agd.ag_contract_header_id = :p_ch_id
           AND rownum = 1) dat_r
      ...
      ,(CASE
         WHEN ca.street_name IS NOT NULL THEN
          NVL(ca.street_type || '. ', 'ул. ') || ca.street_name
         ELSE
          ''
       END || CASE
      ...
      ,ca.zip
      ,ch.description chn
      ,decode(cat.category_name,'Агент','',
                         'Директор агентства 2 года','Директор',
                         'Директор агентства 1 года','Директор',
  ...
  JOIN contact c
    ON c.contact_id = ach.agent_id
  LEFT OUTER JOIN department dep
    ON (ach.agency_id = dep.department_id)
  LEFT JOIN t_sales_channel ch
    ON (ach.t_sales_channel_id = ch.id)
  LEFT JOIN cn_address ca
    ON (pkg_contact.get_primary_address(ach.agent_id) = ca.id)
  LEFT JOIN ag_category_agent cat
    ON (cat.ag_category_agent_id = ac.category_id)
         
 WHERE ach.ag_contract_header_id = :p_ch_id]]>
      </select>
      <displayInfo x="1.15625" y="0.54163" width="0.69995" height="0.19995"/>
      <group name="G_TITLE">
        <dataItem name="agent_id"/>
      </group>
    </dataSource>
  </data>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=638
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:14.4pt'>
  ...
  style='font-size:8.0pt;font-family:Arial;color:black'>ЗАО "РенЛайф Партнерс" <o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:14.4pt'>
  <td width=302 valign=top style='width:226.5pt;padding:0cm 5.4pt 0cm 5.4pt;
...
<tr style='mso-yfti-irow:5;height:14.4pt'>
  ...
  <p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><a
  name="agent_name"><span style='font-size:11.0pt;font-family:Arial;color:black;
  mso-bidi-font-weight:bold'><rw:field id="" src="fadr"></rw:field></span></a><span style='font-size:11.0pt;
  font-family:Arial;color:black;mso-bidi-font-weight:bold'><o:p></o:p></span></p>
  </td>
</tr>
<tr style='mso-yfti-irow:5;height:14.4pt'>
  ...
  <p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><a
  name="agent_name"><span style='font-size:11.0pt;font-family:Arial;color:black;
  mso-bidi-font-weight:bold'><rw:field id="" src="city_name"></rw:field></span></a><span style='font-size:11.0pt;
  font-family:Arial;color:black;mso-bidi-font-weight:bold'><o:p></o:p></span></p>
  </td>
</tr>
<tr style='mso-yfti-irow:5;height:14.4pt'>
  ...
  <p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><a
  name="agent_name"><span style='font-size:11.0pt;font-family:Arial;color:black;
  mso-bidi-font-weight:bold'><rw:field id="" src="region_name"></rw:field> <rw:field id="" src="province_name"></rw:field> <rw:field id="" src="country_name"></rw:field></span></a><span style='font-size:11.0pt;
  font-family:Arial;color:black;mso-bidi-font-weight:bold'><o:p></o:p></span></p>
  </td>
</tr>
<tr style='mso-yfti-irow:5;height:14.4pt'>
  ...
  <p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><a
  name="agent_name"><span style='font-size:11.0pt;font-family:Arial;color:black;
  mso-bidi-font-weight:bold'><rw:field id="" src="zip"></rw:field></span></a><span style='font-size:11.0pt;
  font-family:Arial;color:black;mso-bidi-font-weight:bold'><o:p></o:p></span></p>
  </td>
</tr>
 ...
 <tr style='mso-yfti-irow:12;height:12.25pt'>
  ...
  <p class=MsoNormal align=center style='text-align:center;mso-layout-grid-align:
  none;text-autospace:none'><span style='font-size:10.0pt;font-family:Arial;
  color:black'>ПИСЬМО - УВЕДОМЛЕНИЕ О РАСТОРЖЕНИИ СУБАГЕНТСКОГО ДОГОВОРА КАТЕГОРИИ <rw:field id="" src="category_name"></rw:field> <rw:field id="" src="chn"></rw:field> <o:p></o:p></span></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:18;height:104.3pt'>
  ...
  text-autospace:none'><span style='font-size:11.0pt;color:black'>
  Закрытое Акционерное Общество "РенЛайф Партнерс", именуемое в дальнейшем АГЕНТ,
  в лице Генерального Директора Смышляева Юрия Олеговича, действующего на основании Устава,
  уведомляет Вас об одностороннем расторжении Субагентского договора (Присоединения) категории
  <rw:field id="" src="category_name"></rw:field> <rw:field id="" src="chn"></rw:field>, утвержденного приказом № 39 от 22.08.2013 года,
  включая все приложения, дополнения и изменения к нему, к которому Вы присоединились
  на основании подписанного Заявления/Соглашения № <rw:field id="" src="NUM"></rw:field> 
  (далее - Субагентский договор). Датой расторжения Субагентского Договора является 
  <rw:field id="" src="DAT_R" formatMask="DD.MM.YYYY"></rw:field>. До даты расторжения 
  Субагентского договора Вы обязаны передать по Акту приема-передачи бланки
  строгой отчетности в Агентство/Филиал ЗАО "РенЛайф Партнерс" в городе <rw:field id="" src="DEPT"/>.<o:p></o:p></span></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:23;height:14.4pt'>
  ...
  height:14.4pt'>
  <p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><span
  style='font-size:11.0pt;color:black'>Смышляев Ю.О.<o:p></o:p></span></p>
  </td>
  <td width=68 valign=top style='width:50.75pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:14.4pt'>
  <p class=MsoNormal align=right style='text-align:right;mso-layout-grid-align:
