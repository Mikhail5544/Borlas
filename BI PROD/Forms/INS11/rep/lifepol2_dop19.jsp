...
decode(vf.brief, 
    ...
    into :BRIEF_PRODUCT,:policy_number,:POL_NUM,:P_NOTICE,:CUR_POLICY,:PROGRAMMA,:P_SYSDATE,:TYPE_CONT,:POL_HOLDER,:PH_BIRTH,:PH_DOC,:POL_ASS,:PA_BIRTH,:PA_DOC, :PA_PERIODICH, :PA_PER, :WAITING_PERIOD_END_DATE, :PA_ROW_PRIL, :PA_KOD_VAL,:PA_KOD_VAL_UP, :Y, :seria
...
for rec in (select decode(rownum,1,'дополнительные программы:' ||t.description,', ' || t.description) val  
           from (select '"' || decode(plo.description,'Дополнительный инвестиционный доход','Инвест',
            ...
            where pp.policy_id = :P_POLICY_ID
             ...
             and tl.t_lob_id = tll.t_lob_id
             and ig.t_insurance_group_id = tll.insurance_group_id
             and (ig.brief <> 'Acc' or plo.id in (22603,32005,44179,22629,27622,27907,27624,28063,28065,28336,32005,43607,43609,44103,44131,44177,57134,57138,57738,57802,57871,57925,58264,28200)) -- согласовано с Д.Ивановым! добавлено 32005,28200 Веселуха
union
...
Директора Киселева О.М., действующего на основании Доверенности № 2009/203 от
12.02.2009 г., с одной стороны, <o:p></o:p></span></p>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=708
 ...
 <tr style='mso-yfti-irow:27'>
  <td width=455 colspan=2 valign=top style='width:341.3pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>ДОПОЛНИТЕЛЬНЫЕ ПРОГРАММЫ (СТРАХОВЫЕ РИСКИ):<o:p></o:p></span></b></p>
  </td>
  <td width=143 colspan=2 valign=top style='width:107.5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;mso-ansi-language:
...
окончания льготного периода".</span></p>
 ...
 <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=right><span style='font-size:7.0pt;mso-ansi-language:RU'>3. В соответствие с изменениями, указанными в п. 1
  настоящего Дополнительного соглашения, у Страхователя возникает обязанность доплатить Страховщику дополнительную 
  страховую преми. (страховой взнос) в размере _______________ в срок до ______________.</span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:38'>
  <td width=264 colspan=3 valign=top style='width:198.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  ...
  <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=right><span style='font-size:7.0pt;mso-ansi-language:RU'>4. Во всем остальном, что не предусмотрено
  настоящим ДОполнительным соглашением Стороны руководствуются положениями Полисных условий к договору страхования жизни. </span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:38'>
  <td width=264 colspan=3 valign=top style='width:198.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  ...
  <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=right><span style='font-size:7.0pt;mso-ansi-language:RU'>5. Настоящее Дополнительное соглашение 
  вступает в силу с момента оплаты дополнительного страхового взноса. </span></p>
  </td>
 </tr>
  </tr>
 <tr style='mso-yfti-irow:38'>
  ...
  <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=right><span style='font-size:7.0pt;mso-ansi-language:RU'>6. Настоящее Дополнительное Соглашение 
