 ...
 beforeReportTrigger="afterpform" unitOfMeasurement="centimeter">
  ...
  <data>
    <userParameter name="P_POLICY_ID" datatype="number" precision="10"
	 ...
	 <userParameter name="maxdue" datatype="character"
     precision="10" defaultWidth="0" defaultHeight="0"/>
...
(SELECT a.amount,
       --a.plan_date,
       to_char(a.plan_date + 45,'dd.mm.yyyy') plan_date,
...
на предоставление «Финансовых каникул». <% if (z.equals("1")) { %><% } else { %> В соответствии с данным дополнительным
соглашением Вы должны оплатить имеющуюся задолженность по договору в размере </span><span
lang=EN-US style='font-size:11.0pt;font-family:Tahoma;mso-ansi-language:EN-US'><rw:field id="" src="amount_z"/> </span><span
style='font-size:11.0pt;font-family:Tahoma'> <span class=GramE><rw:field id="" src="PA_KOD_VAL"/><% } %></span> 
Очередной<span style='mso-spacerun:yes'></span> страховой взнос,
указанный в дополнительном соглашении, необходимо оплатить в размере </span><span lang=EN-US
style='font-size:11.0pt;font-family:Tahoma;mso-ansi-language:EN-US'><rw:field id="" src="amount_let"/></span><span
style='font-size:11.0pt;font-family:Tahoma'> <rw:field id="" src="PA_KOD_VAL"/> в срок до 
