...
--  from dual
  ...
  where :PRINT_8_4 = '1'
  union all
  select 'ЛЬГОТНЫЙ ПЕРИОД: '||upper(ent.obj_name('T_PERIOD', pp.pol_privilege_period_id))||'.' text,
  '*' prog
  from p_policy pp
 where pp.policy_id = :P_POLICY_ID
  union all
...
from
 (select d.*, MONTHS_BETWEEN(d.insurance_year_date,ph.start_date) / 12 as year_num
...
<rw:getValue id="j_has_avtopr" src="P_EXIST_AVTOPR"/>
 ...
 <tr style='mso-yfti-irow:27'>
  <td width=455 colspan=2 valign=top style='width:341.3pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>4.2 ДОПОЛНИТЕЛЬНЫЕ СТРАХОВЫЕ РИСКИ:<o:p></o:p><b>*</b></span></b></p>
  </td>
  <td width=143 colspan=2 valign=top style='width:107.5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;mso-ansi-language:
...
<rw:getValue id="PER" src="PA_PER"/>
 <tr style='mso-yfti-irow:44'>
  ...
  style='mso-bidi-font-style:normal'><span style='font-size:8.0pt;mso-ansi-language:
  RU'>уплачивается <a name="charge_period"><% if (PER.equals("1")) {%> <rw:field id="" src="PA_PERIODICH"/> <%} else {%> ежегодно <%} %></a></span></i></b><b
  style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;mso-ansi-language:
  RU'>):<o:p></o:p></span></b></p>
  </td>
  <td width=110 valign=top style='width:82.2pt;border-top:none;border-left:
