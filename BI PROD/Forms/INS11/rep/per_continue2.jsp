...
<p class=MsoNormal style='margin-top:6.0pt;margin-justify:0cm;margin-bottom:0cm;
margin-left:-1.0cm;margin-bottom:.0001pt;text-align:justify;text-indent:1.0cm'>
<span style='mso-bidi-font-size:12.0pt;font-family:Times New Roman'>Настоящим письмом уведомляем Вас,
 что период оценки страхового риска по Полису страхования № <rw:field id="" src="POL_NUM"/> от <rw:field id="" src="notice_date"/> г.
