...
<report name="letters_30_day" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="LETTERS_30_DAY1" xmlPrologType="text">
...
<p><hr><p>
  ...
  <data>
    ...
    <userParameter name="START_DATE" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
    <userParameter name="END_DATE" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL V_LETTERS_PAYMENT.NUM, V_LETTERS_PAYMENT.PAYMENT_PERIOD, 
V_LETTERS_PAYMENT.CONTACT_NAME, V_LETTERS_PAYMENT.GRACE_DATE
FROM V_LETTERS_PAYMENT 
where GRACE_DATE BETWEEN  :START_DATE  AND   :END_DATE  ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_NUM">
        <displayInfo x="1.23035" y="2.37500" width="1.68616" height="1.11426"
        />
        <dataItem name="NUM" datatype="vchar2" columnOrder="12" width="100"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Num">
          <dataDescriptor expression="V_LETTERS_PAYMENT.NUM"
           descriptiveExpression="NUM" order="1" width="100"/>
        </dataItem>
        <dataItem name="PAYMENT_PERIOD" datatype="vchar2" columnOrder="13"
         width="500" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Payment Period">
          <dataDescriptor expression="V_LETTERS_PAYMENT.PAYMENT_PERIOD"
           descriptiveExpression="PAYMENT_PERIOD" order="2" width="500"/>
        </dataItem>
        <dataItem name="CONTACT_NAME" datatype="vchar2" columnOrder="14"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Contact Name">
          <dataDescriptor expression="V_LETTERS_PAYMENT.CONTACT_NAME"
           descriptiveExpression="CONTACT_NAME" order="3" width="4000"/>
        </dataItem>
        <dataItem name="GRACE_DATE" datatype="date" oracleDatatype="date"
         columnOrder="15" width="9" defaultWidth="90000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Grace Date">
          <dataDescriptor expression="V_LETTERS_PAYMENT.GRACE_DATE"
           descriptiveExpression="GRACE_DATE" order="4" oracleDatatype="date"
           width="9"/>
        </dataItem>
      </group>
    </dataSource>
  ...
  <section name="main">
    <body>
      <repeatingFrame name="R_G_NUM" source="G_NUM" printDirection="down"
       maxRecordsPerPage="1" minWidowRecords="1" columnMode="no">
        <geometryInfo x="0.00000" y="0.00000" width="5.50000" height="3.25000"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="TableCell"/>
        <text name="B_tbp">
          <geometryInfo x="0.31250" y="0.00000" width="5.18750"
           height="3.25000"/>
          <textSegment>
            <font face="Arial" size="10" bold="yes" textColor="TextColor"/>
            <string>
            <![CDATA[Уважаемый(ая)  &<CONTACT_NAME>
]]>
            </string>
          </textSegment>
          <textSegment>
          ...
          <textSegment>
            <font face="Arial" size="10" bold="yes" textColor="TextColor"/>
            <string>
            <![CDATA[   Напоминаем Вам о том, согласно условиям договора № &<NUM>,
]]>
            </string>
          </textSegment>
          <textSegment>
            <font face="Arial" size="10" bold="yes" textColor="TextColor"/>
            <string>
            <![CDATA[Вам необходимо оплатить очередной  &<PAYMENT_PERIOD> страховой взнос к &<GRACE_DATE>.
]]>
            </string>
          </textSegment>
          <textSegment>
          ...
          <textSegment>
            <font face="Arial" size="10" bold="yes" textColor="TextColor"/>
            <string>
            <![CDATA[Для уплаты страховых взносов без дополнительных банковских комиссионныз сборов мы рекомендуем Вам воспользоваться:
]]>
            </string>
          </textSegment>
          <textSegment>
          ...
          <textSegment>
            <font face="Arial" size="10" bold="yes" textColor="TextColor"/>
            <string>
            <![CDATA[1. Платежной системой CONTACT.
]]>
            </string>
          </textSegment>
          <textSegment>
            <font face="Arial" size="10" bold="yes" textColor="TextColor"/>
            <string>
            <![CDATA[2. Отделениями АКБ "РОСБАКН"
]]>
            </string>
          </textSegment>
          <textSegment>
    ...
    <margin>
      <image name="B_1_SEC2" templateSection="main">
        <geometryInfo x="0.50000" y="0.31250" width="1.62500" height="0.37500"
        />
        <visualSettings fillPattern="transparent" fillBackgroundColor="black"
         linePattern="transparent" lineBackgroundColor="black"/>
        <points>
          <point x="0.00000" y="0.00000"/>
          <point x="1.62500" y="0.37500"/>
...
5EBCBDEF AF7FFB00 E00B0870 C406ED60 4000B300 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
...
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000
00000000 00000000 00000000 00003344
        </binaryData>
      </image>
    </margin>
  </section>
  ...
  <reportPrivate templateName="rwblue"/>
</report>
</rw:objects>
-->
