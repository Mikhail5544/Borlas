...
<title>Письмо-уведомление о расторжении по заявлению страхователя (наличие необходимости возврата части премии и новые условия страхования)</title>
<style>
<!--
 /* Font Definitions */
 @font-face
...
прекращает свое действие на основании п. 11.2.2 Общих условий страхования 
...
Вам в связи с прекращением договора сумма
в размере <i><rw:field id="f_summa" src="summa"/> <rw:field id="f_fund" src="brief"/></i> будет перечислена на указанный Вами в
Заявлении на расторжение счет.</span></p>
