...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:1'>
  ...
  <p class=MsoNormal><span style='font-size:9.0pt'><o:p><b><%=dep_gl%></b></o:p></span></p>
  </td>
 </tr>
...
<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:10.0pt'>№ <%=AGDOGNUM%> от <%=REG_DATE%></span></b><span
...
style='mso-spacerun:yes'> </span>«25» сентября <st1:metricconverter
...
«СТРАХОВЩИК») Киселевым О.М.<span style='mso-spacerun:yes'>  </span>«25» сентября 
