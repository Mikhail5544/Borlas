...
<%@ include file="/inc/rep_logger.jsp" %>
...
where f.fund_id=bp.fund_pay_id
...
and f.BRIEF = :fund_brief
      ...
      <group name="G_BORDERO_TYPE">
        ...
        />
        <dataItem name="SUM_RE_PREMIUM" datatype="vchar2" columnOrder="25"
         width="4000" defaultWidth="100000" defaultHeight="10000"
...
select 
rownum rn2,
rrb.RE_BORDERO_ID, trim(pp.pol_ser || ' ' || pp.pol_num) num_pol,
...
AND aa.CONTACT_ID = vc.CONTACT_ID
...
) where rn2 between 1 and 20000]]>
      </select>
      <displayInfo x="4.85425" y="0.13538" width="0.69995" height="0.32983"/>
      <group name="G_BORDERO_LINE1">
        <displayInfo x="4.91016" y="0.73145" width="2.21301" height="1.62695"
        />
        <dataItem name="RN2" oracleDatatype="number" columnOrder="26"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Rn2">
          <dataDescriptor expression="RN2" descriptiveExpression="RN2"
           order="1" oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="RE_BORDERO_ID2" oracleDatatype="number"
         columnOrder="27" width="22" defaultWidth="20000"
         defaultHeight="10000" columnFlags="1" defaultLabel="Re Bordero Id2">
          <dataDescriptor expression="RE_BORDERO_ID"
           descriptiveExpression="RE_BORDERO_ID" order="2"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="NUM_POL1" datatype="vchar2" columnOrder="28"
         width="2049" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Num Pol1">
          <dataDescriptor expression="NUM_POL" descriptiveExpression="NUM_POL"
           order="3" width="2049"/>
        </dataItem>
        <dataItem name="PROGR1" datatype="vchar2" columnOrder="29" width="255"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Progr1">
          <dataDescriptor expression="PROGR" descriptiveExpression="PROGR"
           order="4" width="255"/>
        </dataItem>
        <dataItem name="BRIEF3" datatype="vchar2" columnOrder="30" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Brief3">
          <dataDescriptor expression="BRIEF" descriptiveExpression="BRIEF"
           order="5" width="30"/>
        </dataItem>
        <dataItem name="DESCRIPTION1" datatype="vchar2" columnOrder="31"
        ...
        <dataItem name="FAMIL1" datatype="vchar2" columnOrder="32" width="500"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Famil1">
          <dataDescriptor expression="FAMIL" descriptiveExpression="FAMIL"
           order="7" width="500"/>
        </dataItem>
        <dataItem name="FIRST_NAME1" datatype="vchar2" columnOrder="33"
         width="50" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="First Name1">
          <dataDescriptor expression="FIRST_NAME"
           descriptiveExpression="FIRST_NAME" order="8" width="50"/>
        </dataItem>
        <dataItem name="MIDDLE_NAME1" datatype="vchar2" columnOrder="34"
         width="50" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Middle Name1">
          <dataDescriptor expression="MIDDLE_NAME"
           descriptiveExpression="MIDDLE_NAME" order="9" width="50"/>
        </dataItem>
        <dataItem name="FIO1" datatype="vchar2" columnOrder="35" width="255"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Fio1">
        ...
        <dataItem name="DATE_OF_BIRTH1" datatype="date" oracleDatatype="date"
         ...
         columnFlags="1" defaultLabel="Date Of Birth1">
          <dataDescriptor expression="DATE_OF_BIRTH"
           descriptiveExpression="DATE_OF_BIRTH" order="11"
           oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="POL1" datatype="vchar2" columnOrder="37" width="1"
         defaultWidth="10000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Pol1">
          <dataDescriptor expression="POL" descriptiveExpression="POL"
           order="12" width="1"/>
        </dataItem>
        <dataItem name="POL_D1" datatype="vchar2" columnOrder="38" width="4"
         defaultWidth="40000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Pol D1">
          <dataDescriptor expression="POL_D" descriptiveExpression="POL_D"
           order="13" width="4"/>
        </dataItem>
        <dataItem name="NOTE1" datatype="vchar2" columnOrder="39" width="4000"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Note1">
          <dataDescriptor expression="NOTE" descriptiveExpression="NOTE"
           order="14" width="4000"/>
        </dataItem>
        <dataItem name="INS_AMOUNT1" datatype="vchar2" columnOrder="40"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Ins Amount1">
          <dataDescriptor expression="INS_AMOUNT"
           descriptiveExpression="INS_AMOUNT" order="15" width="4000"/>
        </dataItem>
        <dataItem name="RE_TARIFF1" datatype="vchar2" columnOrder="41"
         width="35" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Re Tariff1">
          <dataDescriptor expression="RE_TARIFF"
           descriptiveExpression="RE_TARIFF" order="16" width="35"/>
        </dataItem>
        <dataItem name="BASE_RATE_REINS1" datatype="vchar2" columnOrder="42"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Base Rate Reins1">
          <dataDescriptor expression="BASE_RATE_REINS"
           descriptiveExpression="BASE_RATE_REINS" order="17" width="4000"/>
        </dataItem>
        <dataItem name="PART_SUM1" datatype="vchar2" columnOrder="43"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Part Sum1">
          <dataDescriptor expression="PART_SUM"
           descriptiveExpression="PART_SUM" order="18" width="4000"/>
        </dataItem>
        <dataItem name="BR_PREM1" datatype="vchar2" columnOrder="44"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Br Prem1">
          <dataDescriptor expression="BR_PREM28"
           descriptiveExpression="BR_PREM28" order="19" width="4000"/>
        </dataItem>
        <dataItem name="BR_PREM2" datatype="vchar2" columnOrder="45"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Br Prem2">
          <dataDescriptor expression="BR_PREM36"
           descriptiveExpression="BR_PREM36" order="20" width="4000"/>
        </dataItem>
        <dataItem name="S_DATE_STRAX1" datatype="date" oracleDatatype="date"
         columnOrder="46" width="9" defaultWidth="90000" defaultHeight="10000"
         columnFlags="1" defaultLabel="S Date Strax1">
          <dataDescriptor expression="S_DATE_STRAX"
           descriptiveExpression="S_DATE_STRAX" order="21"
           oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="E_DATE_STRAX1" datatype="date" oracleDatatype="date"
         columnOrder="47" width="9" defaultWidth="90000" defaultHeight="10000"
         columnFlags="1" defaultLabel="E Date Strax1">
          <dataDescriptor expression="E_DATE_STRAX"
           descriptiveExpression="E_DATE_STRAX" order="22"
           oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="S_DATE_WAITING1" datatype="date" oracleDatatype="date"
         columnOrder="48" width="9" defaultWidth="90000" defaultHeight="10000"
         columnFlags="1" defaultLabel="S Date Waiting1">
          <dataDescriptor expression="S_DATE_WAITING"
           descriptiveExpression="S_DATE_WAITING" order="23"
           oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="DAYS_WAITING1" oracleDatatype="number"
         columnOrder="49" width="22" defaultWidth="20000"
         defaultHeight="10000" columnFlags="1" defaultLabel="Days Waiting1">
          <dataDescriptor expression="DAYS_WAITING"
           descriptiveExpression="DAYS_WAITING" order="24"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="WAITING_PERIOD_END_DATE1" datatype="date"
         oracleDatatype="date" columnOrder="50" width="9" defaultWidth="90000"
         defaultHeight="10000" columnFlags="1"
         defaultLabel="Waiting Period End Date1">
          <dataDescriptor expression="WAITING_PERIOD_END_DATE"
           descriptiveExpression="WAITING_PERIOD_END_DATE" order="25"
           oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="PER_OPL1" datatype="vchar2" columnOrder="51"
         width="500" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Per Opl1">
          <dataDescriptor expression="PER_OPL" descriptiveExpression="PER_OPL"
           order="26" width="500"/>
        </dataItem>
        <dataItem name="OPL_S1" datatype="date" oracleDatatype="date"
         columnOrder="52" width="9" defaultWidth="90000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Opl S1">
          <dataDescriptor expression="OPL_S" descriptiveExpression="OPL_S"
           order="27" oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="OPL_E1" datatype="date" oracleDatatype="date"
         columnOrder="53" width="9" defaultWidth="90000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Opl E1">
          <dataDescriptor expression="OPL_E" descriptiveExpression="OPL_E"
           order="28" oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="IS_IN_WAITING_PERIOD1" oracleDatatype="number"
         columnOrder="54" width="22" defaultWidth="20000"
         defaultHeight="10000" columnFlags="1"
         defaultLabel="Is In Waiting Period1">
          <dataDescriptor expression="IS_IN_WAITING_PERIOD"
           descriptiveExpression="IS_IN_WAITING_PERIOD" order="29"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="DOG_DEST1" oracleDatatype="number" columnOrder="55"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Dog Dest1">
          <dataDescriptor expression="DOG_DEST"
           descriptiveExpression="DOG_DEST" order="30" oracleDatatype="number"
           width="22" scale="-127"/>
        </dataItem>
        <dataItem name="FIRST_INS_GUARANTEE1" datatype="vchar2"
         columnOrder="56" width="4000" defaultWidth="100000"
         defaultHeight="10000" columnFlags="1"
         defaultLabel="First Ins Guarantee1">
          <dataDescriptor expression="FIRST_INS_GUARANTEE"
           descriptiveExpression="FIRST_INS_GUARANTEE" order="31" width="4000"
          />
        </dataItem>
        <dataItem name="PART_PERC1" oracleDatatype="number" columnOrder="57"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Part Perc1">
          <dataDescriptor expression="PART_PERC"
           descriptiveExpression="PART_PERC" order="32"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="REINS_GUARANTEE1" datatype="vchar2" columnOrder="58"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Reins Guarantee1">
          <dataDescriptor expression="REINS_GUARANTEE"
           descriptiveExpression="REINS_GUARANTEE" order="33" width="4000"/>
        </dataItem>
        <dataItem name="INS_GUARANTEE1" datatype="vchar2" columnOrder="59"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Ins Guarantee1">
          <dataDescriptor expression="INS_GUARANTEE"
           descriptiveExpression="INS_GUARANTEE" order="34" width="4000"/>
        </dataItem>
        <dataItem name="K_COEF_M1" oracleDatatype="number" columnOrder="60"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="K Coef M1">
          <dataDescriptor expression="K_COEF_M"
           descriptiveExpression="K_COEF_M" order="35" oracleDatatype="number"
           width="22" scale="-127"/>
        </dataItem>
        <dataItem name="S_COEF_M1" oracleDatatype="number" columnOrder="61"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="S Coef M1">
          <dataDescriptor expression="S_COEF_M"
           descriptiveExpression="S_COEF_M" order="36" oracleDatatype="number"
           width="22" scale="-127"/>
        </dataItem>
        <dataItem name="K_COEF_NM1" oracleDatatype="number" columnOrder="62"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="K Coef Nm1">
          <dataDescriptor expression="K_COEF_NM"
           descriptiveExpression="K_COEF_NM" order="37"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="S_COEF_NM1" oracleDatatype="number" columnOrder="63"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="S Coef Nm1">
          <dataDescriptor expression="S_COEF_NM"
           descriptiveExpression="S_COEF_NM" order="38"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="K_DOWN_PAYMENT1" datatype="vchar2" columnOrder="64"
         width="35" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="K Down Payment1">
          <dataDescriptor expression="K_DOWN_PAYMENT"
           descriptiveExpression="K_DOWN_PAYMENT" order="39" width="35"/>
        </dataItem>
        <dataItem name="RE_PREMIUM1" datatype="vchar2" columnOrder="65"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Re Premium1">
          <dataDescriptor expression="RE_PREMIUM"
           descriptiveExpression="RE_PREMIUM" order="40" width="4000"/>
        </dataItem>
      </group>
    </dataSource>
    <link name="L_2" parentGroup="G_BORDERO_TYPE" parentColumn="RE_BORDERO_ID"
     childQuery="Q_1" childColumn="RE_BORDERO_ID2" condition="eq"
     sqlClause="where"/>
  </data>
...
RepLogger logger = new RepLogger("/u2/BINS11_PROD/ins11/UPLOAD/boedero.log");
int iteration = 0;
...
<rw:foreach id="G_BORDERO_LINE1" src="G_BORDERO_LINE1">

<rw:getValue id="jrownum" src="rn2"/>
<% logger.Log((++iteration) + ": rownum=" + jrownum); %>


<rw:getValue id="IS_IN_WAITING_PERIOD1" src="IS_IN_WAITING_PERIOD1" formatMask="999999990.99"/>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl24 style='height:15.0pt'></td>
  <td class=xl65 width=143 style='width:107pt'>&nbsp;</td>
  <td class=xl66><rw:field id="" src="NUM_POL1"></rw:field></td>
  <td class=xl58><rw:field id="" src="BRIEF3"></rw:field></td>
  <td class=xl59><rw:field id="" src="DESCRIPTION1"></rw:field></td>
  <td class=xl58><rw:field id="" src="PROGR1"></rw:field></td>
  <td class=xl58><rw:field id="" src="FAMIL1"></rw:field></td>
  <td class=xl58><rw:field id="" src="FIRST_NAME1"></rw:field></td>
  <td class=xl58><rw:field id="" src="MIDDLE_NAME1"></rw:field></td>
  <td class=xl58><rw:field id="" src="FIO1"></rw:field></td>
  <td class=xl60><rw:field id="" src="DATE_OF_BIRTH1"></rw:field></td>
  <td class=xl59><rw:field id="" src="POL_D1"></rw:field></td>
  <td class=xl59><rw:field id="" src="POL1"></rw:field></td>
  <td class=xl58><rw:field id="" src="NOTE1"></rw:field></td>
  <td class=xl59>&nbsp;</td>
  <td class=xl61><rw:field id="" src="S_DATE_STRAX1"></rw:field></td>
  <td class=xl61><rw:field id="" src="E_DATE_STRAX1"></rw:field></td>
  <td class=xl59>&nbsp;</td>
  <td class=xl59>&nbsp;</td>
  <td class=xl59><rw:field id="" src="DOG_DEST"></rw:field></td>
  <td class=xl61><%if (Double.valueOf(IS_IN_WAITING_PERIOD1).doubleValue() == 0) {%>&nbsp;
    <%} else {%><rw:field id="" src="S_DATE_WAITING1"></rw:field><%}%> </td>
  <td class=xl61><%if (Double.valueOf(IS_IN_WAITING_PERIOD1).doubleValue() == 0) {%>&nbsp;
    <%} else {%><rw:field id="" src="WAITING_PERIOD_END_DATE1"></rw:field><%}%> </td>
  <td class=xl70><%if (Double.valueOf(IS_IN_WAITING_PERIOD1).doubleValue() == 0) {%>&nbsp;
    <%} else {%><rw:field id="" src="DAYS_WAITING1"></rw:field><%}%> </td>
  <td class=xl71><rw:field id="" src="PER_OPL1"></rw:field></td>
  <td class=xl61><rw:field id="" src="OPL_S1"></rw:field></td>
  <td class=xl61><rw:field id="" src="OPL_E1"></rw:field></td>
  <td class=xl72><rw:field id="" src="FIRST_INS_GUARANTEE1"></rw:field></td>
  <td class=xl73><rw:field id="" src="PART_PERC1"></rw:field></td>
  <td class=xl73><rw:field id="" src="REINS_GUARANTEE1"></rw:field></td>
  <td class=xl73><rw:field id="" src="INS_GUARANTEE1"></rw:field></td>
  <td class=xl73><rw:field id="" src="RE_TARIFF1"></rw:field></td>  
  <td class=xl73><rw:field id="" src="FIRST_INS_GUARANTEE1"></rw:field></td>
  <td class=xl73><rw:field id="" src="PART_PERC1"></rw:field></td>
  <td class=xl73><rw:field id="" src="REINS_GUARANTEE1"></rw:field></td>
  <td class=xl73><rw:field id="" src="INS_GUARANTEE1"></rw:field></td>
  <td class=xl73><rw:field id="" src="RE_TARIFF1"></rw:field></td>  
  <td class=xl84><rw:field id="" src="BR_PREM281"></rw:field></td>
  <td class=xl59><rw:field id="" src="K_COEF_M1"></rw:field></td>
  <td class=xl59><rw:field id="" src="S_COEF_M1"></rw:field></td>
  <td class=xl59>&nbsp;</td>
  <td class=xl59><rw:field id="" src="K_COEF_NM1"></rw:field></td>
  <td class=xl59><rw:field id="" src="S_COEF_NM1"></rw:field></td>
  <td class=xl59>&nbsp;</td>
  <td class=xl75><rw:field id="" src="K_DOWN_PAYMENT1"></rw:field></td>
  <td class=xl84><rw:field id="" src="RE_PREMIUM1"></rw:field></td>
  <td class=xl59>&nbsp;</td>
  <td class=xl64>&nbsp;</td>
  <td colspan=2 class=xl24 style='mso-ignore:colspan'></td>
 </tr>
...
<% logger.Log("/foreach 3"); %>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl79>&nbsp;</td>
  <td class=xl83>&nbsp;</td>
<% logger.Log("SUM_RE_PREMIUM before"); %>
  <td class=xl84><rw:field id="" src="SUM_RE_PREMIUM"></rw:field></td>
<% logger.Log("SUM_RE_PREMIUM after"); %>
  <td class=xl79>&nbsp;</td>
  <td class=xl85>&nbsp;</td>
  <td colspan=2 class=xl24 style='mso-ignore:colspan'></td>
 </tr>
<% logger.Log("/foreach 2 before"); %>
</rw:foreach> 

<% logger.Log("/foreach 2 after"); %>
...
<!--
    <dataSource name="ds11">
      <select canParse="no">
select * from (
  select rownum rn1, t.* from table t order by id
) where rn1 between 1 and 15000
      </select>
      <group name="g11"/>
    </dataSource>

    <dataSource name="ds12">
      <select canParse="no">
select * from (
  select rownum rn2, t.* from table t order by id
) where rn2 between 15001 and 30000
      </select>
      <group name="g12"/>
    </dataSource>

    <dataSource name="ds13">
      <select canParse="no">
select * from (
  select rownum rn3, t.* from table t order by id
) where rn3 between 30001 and 45000
      </select>
      <group name="g13"/>
    </dataSource>
...
затем так же размножим циклы вывода данных:

<rw:foreach id="fi11" src="g11"><rw:field id="" src="fileld"/></rw:foreach>
<rw:foreach id="fi12" src="g12"><rw:field id="" src="fileld"/></rw:foreach>
<rw:foreach id="fi13" src="g13"><rw:field id="" src="fileld"/></rw:foreach>
и т.д.
