...
<report name="bso_act_destroy" DTDVersion="9.0.2.0.10">
  ...
  <data>
    ...
    rownum,
	bd1.num as act_num,
	to_char(bd1.reg_date,'dd.mm.yyyy')|| ' г.' as act_date,
	bd1.note as note,
	bd2.num as discard_act_num,
	to_char(bd2.reg_date,'dd.mm.yyyy')|| ' г.' as discard_act_date
from    
  	ven_bso_document bd1,  -- Документ БСО (CONTACT TO|to, DEPARTMENT TO|to)
  	ven_doc_doc dd,        -- Связь Акта на уничтожение с Актом списания
...
<title>Акт уничтожения бланков строгой отчетности</title>
<!--[if gte mso 9]><xml>
...
normal'><span style='font-size:14.0pt;mso-bidi-font-size:12.0pt'>Акт
уничтожения бланков строгой отчетности<o:p></o:p></span></b></p>
...
style='font-size:14.0pt'>Дата: <rw:field id="f_act_date" src="act_date" /><o:p></o:p></span></b></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
style='font-size:14.0pt'><o:p>&nbsp;</o:p></span></b></p>

<p class=MsoNormal style='text-align:justify;mso-layout-grid-align:none;
punctuation-wrap:simple;text-autospace:none'>Производится уничтожение<span
...
<p class=MsoNormal>Экспертная комиссия в составе:</p>
...
style='color:#3366FF'> </span>председатель комиссии</p>
...
<p class=MsoNormal>Составила настоящий акт о том, что <rw:field id="f_act_date" src="act_date" />,
согласно описи, утвержденной актом на списание бланков строгой отчетности № <span
style='color:black'><rw:field id="f_discard_act_num" src="discard_act_num" /></span> от <span style='color:black'><rw:field id="f_discard_act_date" src="discard_act_date" /></span>, были
уничтожено бланки строгой отчетности. Причина <u><rw:field id="f_note" src="note" /></u> </p>

<p class=MsoNormal>В присутствии членов комиссии указанные документы были уничтожены.</p>
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0 width=643
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
  ...
  <p class=MsoNormal style='tab-stops:248.15pt 419.15pt'>Председатель комиссии:<span
  style='mso-tab-count:1'>                                         </span>___________
  / <span style='mso-tab-count:1'>                                </span>/</p>
  <p class=MsoNormal><o:p>&nbsp;</o:p></p>
  <p class=MsoNormal style='tab-stops:246.2pt 421.35pt'>Сотрудник 1<span
  class=GramE> :</span><span style='mso-tab-count:1'>                                                          </span>___________
  /<span style='mso-tab-count:1'>                                   </span>/</p>
  <p class=MsoNormal style='mso-layout-grid-align:none;punctuation-wrap:simple;
  text-autospace:none'><o:p>&nbsp;</o:p></p>
  <p class=MsoNormal style='tab-stops:243.0pt 419.25pt'>Сотрудник 2<span
