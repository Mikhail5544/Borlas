...
rrb.plan_DATE opl_s,
add_months(rrb.plan_date,12/vtp.NUMBER_OF_PAYMENTS)-1 opl_e,
...
and rbp.re_bordero_package_id = rb.re_bordero_package_id
and f.fund_id = rb.fund_id
and rbt.re_bordero_type_id = rb.re_bordero_type_id
...
and tp.product_line_id = plo.product_line_id
and ( (tp.is_insured = 1 and vc.contact_id = ppc.contact_id) 
   or (nvl(tp.is_insured,0)=0 and vc.contact_id = nvl(aa.assured_contact_id,aa.contact_id)) 
   )
order by f.fund_id, rbt.short_name, pp.pol_num
]]>
      </select>
