...
beforeReportTrigger="beforereport">
  ...
  <data>
    ...
    <userParameter name="p_ag_roll_id" datatype="character" width="40"
     ...
     defaultWidth="0" defaultHeight="0"/>
	 <userParameter name="p_p_ser" datatype="character" width="200"
     defaultWidth="0" defaultHeight="0"/>
	 <userParameter name="p_p_num" datatype="character" width="200"
     defaultWidth="0" defaultHeight="0"/>
	 <userParameter name="p_p_pvidan" datatype="character" width="200"
     defaultWidth="0" defaultHeight="0"/>
	 <userParameter name="p_p_datav" datatype="character" width="200"
     defaultWidth="0" defaultHeight="0"/>
    ...
    <dataSource name="Q_AGENT_REPORT">
      ...
      <![CDATA[SELECT count(1) over() row_cnt, h.ag_contract_header_id,
       ...
       dep.name depart,
       initcap(to_char(rh.date_begin,'MONTH','NLS_DATE_LANGUAGE = RUSSIAN')) month_calc,
       to_char(rh.date_begin,'YYYY') year_calc,
...
ORDER BY NVL (cci.issue_date, TO_DATE ('01.01.1900', 'DD.MM.YYYY')) DESC]]>
    ...
    <dataSource name="Q_DOG">
      <select canParse="no">
      <![CDATA[ select 1 cnt, d.num num_pol,
       cont.obj_name_orig holder,
       prod.description product,
       opt.description risk_name,
       case when av.index_delta_sum > 0 then 'В наличии' else 'Нет' end idx_exist,
       av.pay_period,
       av.ins_period,
       to_char(av.payment_date,'DD.MM.YYYY') payment_date, 
       to_char((nvl(av.trans_sum,0) * nvl(av.nbv_coef,0)),'99999990D99') op1,
       ...
       to_char(nvl(vol.vol_rate,0),'99999990D99') vol_rate,
...
where rl.ag_roll_id = :p_ag_roll_id
 ...
 order by d.num]]>
    ...
    <select canParse="no">
    <![CDATA[select 1 tr, to_char(nvl(sum(nvl(vol.vol_amount,0)),0),'99999990D99') sum_com_pay       
from ins.ag_roll_header rh 
     join ins.ag_roll rl on rh.ag_roll_header_id = rl.ag_roll_header_id
     join ins.ag_roll_type tr on rh.ag_roll_type_id = tr.ag_roll_type_id
     left join ins.ag_perfomed_work_act act on act.ag_roll_id = rl.ag_roll_id
...
where rl.ag_roll_id = :p_ag_roll_id
	...
	<dataSource name="Q_DOG_ZAKL">
     ...
     --npf.policy_num num_pol_npf,
       ...
       case when vol.vol_amount = 500 then 'Качественный' 
			when vol.vol_amount = 100 then 'Не качественный' 
			when vol.vol_amount = 250 then 'Не качественный'
			else '' end type_dog,
	   to_char((nvl(av.trans_sum,0) * nvl(av.nbv_coef,0)),'99999990D99') op2,
       ...
       to_char(nvl(vol.vol_rate,0),'99999990D99') vol_rate_npf,
...
from ins.ag_roll_header rh 
     ...
     join ins.ag_rate_type rt2 on det2.ag_rate_type_id = rt2.ag_rate_type_id and rt2.brief = 'QOPS_0510'
...
order by npf.policy_num
	...
	<dataSource name="Q_DOG_ZAKL_SUM">
      <select>
      <![CDATA[  select 1 re,to_char(nvl(sum(nvl(pf.vol_amount,0) * nvl(pf.vol_rate,0) + (nvl(vol.vol_amount,0) * nvl(vol.vol_rate,0))),0),'99999990D99') sum_com_npf
...
from ins.ag_roll_header rh 
 ...
 where rl.ag_roll_id = :p_ag_roll_id
    ...
    nvl((select sum(nvl(vol.vol_amount,0))    
from ins.ag_roll_header rh 
     join ins.ag_roll rl on rh.ag_roll_header_id = rl.ag_roll_header_id
     join ins.ag_roll_type tr on rh.ag_roll_type_id = tr.ag_roll_type_id
     left join ins.ag_perfomed_work_act act on act.ag_roll_id = rl.ag_roll_id
...
mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Приложение №3 к СУБАГЕНТСКОМУ ДОГОВОРУ (ПРИСОЕДИНЕНИЯ) категории <rw:field id="" src="sales_ch"/> <o:p></o:p></span></p>
...
от 24 июня 2011 г. Приказ № 06 (Далее - СДП).<o:p></o:p></span></p>
<p class=MsoTitle style='margin-top:6.0pt;text-align:justify;tab-stops:0in'><span
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>
2. Настоящее Приложение № 2 устанавливает форму Отчета АГЕНТА к Субагентскому договору (ПРИСОЕДИНЕНИЯ) категории <rw:field id="" src="sales_ch"/>,
...
mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>УТОЧНЕННЫЙ ОТЧЕТ СУБАГЕНТА № <rw:field id="" src="sales_ch"/>-<rw:field id="" src="num_agent"/> <o:p></o:p></span></p>
...
<table width="100%" height="30" border=0 cellpadding=0 cellspacing=0 class=MsoNormalTable
   ...
   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
    ...
    10.0pt;font-family:"Times New Roman";font-weight:normal'><rw:field id="" src="date_begin"/></span></p>
    </td>
   </tr>
  </table>
...
<rw:field id="" src="long_name"/>, действующего на основании <rw:field id="" src="dover"/>,
с одной стороны, и <rw:field id="" src="fio_agent"/>, паспорт серии <rw:getValue id="p_p_ser" src="p_p_ser"/>
 № <rw:getValue id="p_p_num" src="p_p_num"/> <rw:getValue id="p_p_pvidan" src="p_p_pvidan"/> <rw:getValue id="p_p_datav" src="p_p_datav"/>, именуемы<span
class=GramE>й(</span><span class=SpellE>ая</span>) в дальнейшем СУБАГЕНТ, с другой
стороны, составили и утвердили Уточненный отчет субагента № <rw:field id="" src="sales_ch"/>-<rw:field id="" src="num_agent"/> 
к Субагентскому договору (ПРИСОЕДИНЕНИЯ) категории <rw:field id="" src="sales_ch"/>.<o:p></o:p></span></p>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width="100%"
 ...
 <td width="12%" colspan=2 style='width:12.74%;padding:0cm 5.4pt 0cm 5.4pt;
  ...
  <p class=MsoNormal><span style='font-size:8.0pt;font-family:Arial;mso-bidi-font-family:
  "Times New Roman"'>Уровень СУБАГЕНТА<o:p>&nbsp;</o:p></span></p>
  </td>
   <td width="11%" colspan=2 style='width:10.42%;padding:0cm 5.4pt 0cm 5.4pt;
  height:21.2pt'>
  <p class=MsoNormal><span style='font-size:8.0pt;font-family:Arial;mso-bidi-font-family:
  "Times New Roman"'>&nbsp;</span><b style='mso-bidi-font-weight:normal'><span
  style='font-size:10.0pt'><rw:field id="" src="lvl_agent"/></span></b><span style='font-size:8.0pt;
  font-family:Arial;mso-bidi-font-family:"Times New Roman"'><o:p></o:p></span></p>
  </td>
  <td width="12%" colspan=2 style='width:11.44%;padding:0cm 5.4pt 0cm 5.4pt;height:21.2pt'>
  <p class=MsoNormal><span style='font-size:8.0pt;font-family:Arial;mso-bidi-font-family:
...
<rw:foreach id="G_DOG" src="G_DOG">
 ...
 <tr style='mso-yfti-irow:6;height:29.05pt'>
  ...
  <td width="11%" colspan=5 rowspan=2 style='width:11.58%;border-top:none;
  border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:29.05pt'>
  <p class=MsoNormal align=center style='text-align:center'><b><span
  ...
  <td width="21%" style='width:21.74%;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:29.05pt'>
  <p class=MsoNormal align=center style='text-align:center'><b><span
  style='font-size:7.0pt'>Размер дополнительного вознаграждения за Качественные Договора ОПС (Застрахованные лица мужского пола), руб.<o:p></o:p></span></b></p>
  </td>
 ...
 <tr style='mso-yfti-irow:8;height:12.75pt'>
  ...
  <td width="11%" nowrap colspan=5 valign=bottom style='width:11.58%;
  border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;
  border-right:solid windowtext 1.0pt;mso-border-top-alt:solid windowtext .5pt;
  mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:12.75pt'>
...
<rw:foreach id="G_DOG_ZAKL" src="G_DOG_ZAKL">
 ...
 <tr style='mso-yfti-irow:9;height:12.75pt'>
  ...
  <td width="11%" colspan=5 valign=bottom style='width:11.58%;
  border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;
  border-right:solid windowtext 1.0pt;mso-border-top-alt:solid windowtext .5pt;
  mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:12.75pt'>
 ...
 <tr style='mso-yfti-irow:17;height:12.75pt'>
  ...
  <td width="11%" colspan=5 nowrap valign=bottom style='width:11.58%;
  padding:0cm 5.4pt 0cm 5.4pt;height:12.75pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='font-size:8.0pt;font-family:Arial;mso-bidi-font-family:"Times New Roman"'><o:p>&nbsp;</o:p></span></p>
  </td>
...
<tr style='mso-yfti-irow:18;height:12.75pt;mso-row-margin-right:40.44%'>
  ...
  height:12.75pt'>
  <p class=MsoNormal><span style='font-size:8.0pt;font-family:Arial;mso-bidi-font-family:
  "Times New Roman"'>В связи с тем, что АГЕНТ, на основании ОТЧЕТА СУБАГЕНТА № <rw:field id="" src="sales_ch"/>-<rw:field id="" src="num_agent"/>
   от <<____>>_____________20__ г. за период с _____________ по ______________ произвел выплату СУБАГЕНТУ
   субагентского вознаграждения в размере _______________, то размер доплаты субагентского вознаграждения СУБАГЕНТА за 
   <rw:field id="" src="month_calc"/> - <rw:field id="" src="year_calc"/>, в соответствии с условиями УТОЧНЕННОГО ОТЧЕТА 
   составляет ___________ рублей ________ копеек.<o:p></o:p></span></p>
  </td>
 </tr>
