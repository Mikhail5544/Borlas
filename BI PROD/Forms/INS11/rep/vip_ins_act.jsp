...
FROM(    
    ...
    SELECT
			...
			--Чирков заявка 160543
		    --%по таблице выплат   
            ,sum(
                case when not (peril_name like '%оспитализация%'
                           or upper(peril_name) like '%'||upper('Временная нетрудоспособность застрахованного')||'%'
                           or upper(peril_name) like '%'||upper('Временная утрата трудоспособности застрахованным')||'%')
            ...
            , sum(case when (peril_name like '%оспитализация%'
                     ...
                     then      
                            (case when pc_ins_amount > 0 then 
                                       round(nvl(declare_sum,0) * a.rate/ ((pc_ins_amount - nvl(ot_claim,0)) * day_count) * 100, 1)
                             else 0 end)       
                      else 0               
                  end) rate_day 
            --end_Чирков заявка 160543
            ...
            when plo.description like 'Первичное диагностирование смертельно опасного заболевания'
                ...
                , case when exists( 
                  ...
                  where /*cc.c_claim_id = cch.active_claim_id
                   ...
                   ,(d.rec_end_date - d.rec_start_date + 1) day_count  --Чирков заявка 160543 						
...
<p class=MsoBodyText style='margin-top:4.0pt;margin-right:0cm;margin-bottom:
   ...
   <img width=110 height=40 src="<%=g_ImagesRoot%>/letter_remind/logo_new.jpg" alt="logo"></p>
 </p>
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  ...
  <p class=MsoNormal align=center style='text-align:center'><span style='font-size:10.0pt'>Выписка из страхового акта</p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:1'>
  <td width=638 colspan=16 valign=top style='width:478.55pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt'><b>Общество с ограниченной ответственностью</b></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1'>
  <td width=638 colspan=16 valign=top style='width:478.55pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt'><b>"Страховая Компания "Ренессанс Жизнь"</b></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1'>
  <td width=638 colspan=16 valign=top style='width:478.55pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt'><b>(ООО "СК "Ренессанс Жизнь")</b></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1'>
  <td width=638 colspan=16 valign=top style='width:478.55pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt'>Дербеневская наб., д.7,  стр.22, Москва, 115114</span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1'>
  <td width=638 colspan=16 valign=top style='width:478.55pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt'><b>Тел.:</b> (495) 981-2-981; <b>Факс:</b> (495) 589-1-865</span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1'>
  <td width=638 colspan=16 valign=top style='width:478.55pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt'>http://www.renlife.ru; e-mail: info@renlife.ru</span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1'>
  <td width=638 colspan=16 valign=top style='width:478.55pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt'><b>ОКПО</b> 746322299, <b>ОГРН</b> 1047796714404</span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1'>
  <td width=638 colspan=16 valign=top style='width:478.55pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt'><b>ИНН</b> 7725520440, <b>КПП</b> 775001001</span></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:21'>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><span style='font-size:5.0pt'>Сумма задолженности 
  <rw:field id="" src="date_s_z"/>
  <o:p></o:p></span></p>
  </td>
  <td width=75 colspan=2 valign=top style='width:75pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
 ...
 <td width=15 valign=top style='width:15pt;border-top:none;border-left:none;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='font-size:6.0pt'><b><rw:field id="" src="rate_tbl" /></b><o:p></o:p></span></p>
  </td>
  <td width=15 valign=top style='width:15pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='font-size:6.0pt'><b><rw:field id="" src="rate_day"/></b><o:p></o:p></span></p>
  </td>
  <td width=15 valign=top style='width:15pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='font-size:6.0pt'><b><rw:field id="" src="due_date"/></b><o:p></o:p></span></p>
  </td>
  <td width=75 colspan=2 valign=top style='width:75pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 <tr style='mso-yfti-irow:28'>
  ...
  solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-bottom-alt:
  solid windowtext .5pt;background:#99CC00;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><b>Итоговая сумма</b><o:p></o:p></span></p>
  </td>
  <td width=246 colspan=6 valign=top style='width:184.6pt;border-top:none;
  border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-top-alt:solid windowtext .5pt;
  ...
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='font-size:7.0pt'><b><%=p_itogo%></b><o:p></o:p></span></p>
  </td>
 </tr>
...
<p class=MsoNormal><span style='font-size:8.0pt'><o:p>&nbsp;</o:p></span></p>
<p class=MsoNormal><span style='font-size:12.0pt'>Верно</p>
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:1'>
  <td width=638 colspan=16 valign=top style='width:478.55pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:10.0pt'>Генеральный директор</span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1'>
  <td width=240 colspan=6 valign=top style='width:180pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:10.0pt'>ООО "СК "Ренессанс Жизнь"</span></p>
  </td>
  <td width=398 colspan=10 valign=top style='width:298.55pt;border:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:10.0pt'>Е. Никифоров</span></p>
  </td>
 </tr>
 </table>
 </rw:foreach>
