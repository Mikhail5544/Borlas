...
agr.agent_report_id, agch.ag_contract_header_id, agr.num act_num,
       ...
       agr.av_sum - (select dav.comission_sum from agent_report_dav dav where dav.agent_report_id = agr.agent_report_id and dav.prod_coef_type_id in (3520)) - (select dav.comission_sum from agent_report_dav dav where dav.agent_report_id = agr.agent_report_id and dav.prod_coef_type_id in (3517)) av_sum,
 ...
 --inner join agent_report_dav dav on (dav.agent_report_id = agr.agent_report_id and dav.prod_coef_type_id in (3506,3517,3522))       
...
именуемое в дальнейшем Страховщик, в лице <rw:field id="" src="long_name"/>, действующего
на основании <rw:field id="" src="dover"/>, с одной
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  <p class=MsoBodyTextIndent align=center style='margin-left:0cm;text-align:
  center;layout-grid-mode:char'><rw:field id="" src="short_name"/></p>
  </td>
  <td width=328 valign=top style='width:246.35pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoBodyTextIndent align=center style='margin-left:0cm;text-align:
