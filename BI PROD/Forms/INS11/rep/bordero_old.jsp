...
and rcc.ure_id = e.ent_id  ) a 
      ...
      <group name="G_BORDERO_LINE">
        ...
        />
        <dataItem name="RN" oracleDatatype="number" columnOrder="65"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Rn">
          <dataDescriptor expression="a.RN" descriptiveExpression="RN"
           order="1" oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="FIRST_INS_GUARANTEE" datatype="vchar2"
         columnOrder="55" width="4000" defaultWidth="20000"
         defaultHeight="10000" columnFlags="1"
         defaultLabel="First Ins Guarantee">
          <dataDescriptor expression="a.FIRST_INS_GUARANTEE"
           descriptiveExpression="FIRST_INS_GUARANTEE" order="31" width="4000"
          />
        </dataItem>
        <dataItem name="part_perc" oracleDatatype="number" columnOrder="56"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Part Perc">
          <dataDescriptor expression="a.PART_PERC"
           descriptiveExpression="PART_PERC" order="32"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="reins_guarantee" datatype="vchar2" columnOrder="57"
         width="4000" defaultWidth="20000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Reins Guarantee">
          <dataDescriptor expression="a.REINS_GUARANTEE"
           descriptiveExpression="REINS_GUARANTEE" order="33" width="4000"/>
        </dataItem>
        <dataItem name="ins_guarantee" datatype="vchar2" columnOrder="58"
         width="4000" defaultWidth="20000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Ins Guarantee">
          <dataDescriptor expression="a.INS_GUARANTEE"
           descriptiveExpression="INS_GUARANTEE" order="34" width="4000"/>
        </dataItem>
        <dataItem name="k_coef_m" oracleDatatype="number" columnOrder="59"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="K Coef M">
          <dataDescriptor expression="a.K_COEF_M"
           descriptiveExpression="K_COEF_M" order="35" oracleDatatype="number"
           width="22" scale="-127"/>
        </dataItem>
        <dataItem name="s_coef_m" oracleDatatype="number" columnOrder="60"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="S Coef M">
          <dataDescriptor expression="a.S_COEF_M"
           descriptiveExpression="S_COEF_M" order="36" oracleDatatype="number"
           width="22" scale="-127"/>
        </dataItem>
        <dataItem name="k_coef_nm" oracleDatatype="number" columnOrder="61"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="K Coef Nm">
          <dataDescriptor expression="a.K_COEF_NM"
           descriptiveExpression="K_COEF_NM" order="37"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="s_coef_nm" oracleDatatype="number" columnOrder="62"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="S Coef Nm">
          <dataDescriptor expression="a.S_COEF_NM"
           descriptiveExpression="S_COEF_NM" order="38"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="k_down_payment" datatype="vchar2" columnOrder="63"
         width="35" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="K Down Payment">
          <dataDescriptor expression="a.K_DOWN_PAYMENT"
           descriptiveExpression="K_DOWN_PAYMENT" order="39" width="35"/>
        </dataItem>
        <dataItem name="re_premium" datatype="vchar2" columnOrder="64"
         width="4000" defaultWidth="20000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Re Premium">
          <dataDescriptor expression="a.RE_PREMIUM"
           descriptiveExpression="RE_PREMIUM" order="40" width="4000"/>
        </dataItem>
        <dataItem name="ins_amount" datatype="vchar2" columnOrder="52"
         width="4000" defaultWidth="20000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Ins Amount">
          <dataDescriptor expression="a.INS_AMOUNT"
           descriptiveExpression="INS_AMOUNT" order="15" width="4000"/>
        </dataItem>
        <dataItem name="re_tariff" datatype="vchar2" columnOrder="53"
         width="35" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Re Tariff">
          <dataDescriptor expression="a.RE_TARIFF"
           descriptiveExpression="RE_TARIFF" order="16" width="35"/>
        </dataItem>
        <dataItem name="base_rate_reins" datatype="vchar2" columnOrder="54"
         width="4000" defaultWidth="20000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Base Rate Reins">
          <dataDescriptor expression="a.BASE_RATE_REINS"
        ...
        <dataItem name="opl_s" datatype="date" oracleDatatype="date"
         ...
         columnFlags="1" defaultLabel="Opl S">
          <dataDescriptor expression="a.OPL_S" descriptiveExpression="OPL_S"
        ...
        <dataItem name="opl_e" datatype="date" oracleDatatype="date"
         ...
         columnFlags="1" defaultLabel="Opl E">
          <dataDescriptor expression="a.OPL_E" descriptiveExpression="OPL_E"
           order="28" oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="br_prem28" datatype="vchar2" columnOrder="48"
         width="4000" defaultWidth="20000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Br Prem28">
          <dataDescriptor expression="a.BR_PREM28"
           descriptiveExpression="BR_PREM28" order="19" width="4000"/>
        </dataItem>
        <dataItem name="br_prem36" datatype="vchar2" columnOrder="49"
         width="4000" defaultWidth="20000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Br Prem36">
          <dataDescriptor expression="a.BR_PREM36"
           descriptiveExpression="BR_PREM36" order="20" width="4000"/>
        </dataItem>
        <dataItem name="per_opl" datatype="vchar2" columnOrder="47"
         width="500" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Per Opl">
          <dataDescriptor expression="a.PER_OPL"
           descriptiveExpression="PER_OPL" order="26" width="500"/>
        </dataItem>
        <dataItem name="progr" datatype="vchar2" columnOrder="46" width="255"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Progr">
          <dataDescriptor expression="a.PROGR" descriptiveExpression="PROGR"
           order="4" width="255"/>
        </dataItem>
        <dataItem name="RE_BORDERO_ID1" oracleDatatype="number"
         ...
         defaultHeight="10000" columnFlags="1" defaultLabel="Re Bordero Id1">
          <dataDescriptor expression="a.RE_BORDERO_ID"
           descriptiveExpression="RE_BORDERO_ID" order="2"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="num_pol" datatype="vchar2" columnOrder="27"
         width="2049" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Num Pol">
          <dataDescriptor expression="a.NUM_POL"
           descriptiveExpression="NUM_POL" order="3" width="2049"/>
        </dataItem>
        <dataItem name="BRIEF2" datatype="vchar2" columnOrder="28" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Brief2">
          <dataDescriptor expression="a.BRIEF" descriptiveExpression="BRIEF"
           order="5" width="30"/>
        </dataItem>
        <dataItem name="DESCRIPTION" datatype="vchar2" columnOrder="29"
         ...
         columnFlags="1" defaultLabel="Description">
          <dataDescriptor expression="a.DESCRIPTION"
           descriptiveExpression="DESCRIPTION" order="6" width="255"/>
        </dataItem>
        <dataItem name="famil" datatype="vchar2" columnOrder="30" width="500"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Famil">
          <dataDescriptor expression="a.FAMIL" descriptiveExpression="FAMIL"
           order="7" width="500"/>
        </dataItem>
        <dataItem name="FIRST_NAME" datatype="vchar2" columnOrder="31"
         width="50" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="First Name">
          <dataDescriptor expression="a.FIRST_NAME"
           descriptiveExpression="FIRST_NAME" order="8" width="50"/>
        </dataItem>
        <dataItem name="MIDDLE_NAME" datatype="vchar2" columnOrder="32"
         width="50" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Middle Name">
          <dataDescriptor expression="a.MIDDLE_NAME"
           descriptiveExpression="MIDDLE_NAME" order="9" width="50"/>
        </dataItem>
        <dataItem name="fio" datatype="vchar2" columnOrder="33" width="255"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Fio">
          <dataDescriptor expression="a.FIO" descriptiveExpression="FIO"
           order="10" width="255"/>
        </dataItem>
        <dataItem name="DATE_OF_BIRTH" datatype="date" oracleDatatype="date"
         ...
         columnFlags="1" defaultLabel="Date Of Birth">
          <dataDescriptor expression="a.DATE_OF_BIRTH"
           descriptiveExpression="DATE_OF_BIRTH" order="11"
           oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="pol" datatype="vchar2" columnOrder="35" width="1"
         defaultWidth="10000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Pol">
          <dataDescriptor expression="a.POL" descriptiveExpression="POL"
           order="12" width="1"/>
        </dataItem>
        <dataItem name="pol_d" datatype="vchar2" columnOrder="36" width="4"
         defaultWidth="40000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Pol D">
          <dataDescriptor expression="a.POL_D" descriptiveExpression="POL_D"
           order="13" width="4"/>
        </dataItem>
        <dataItem name="NOTE" datatype="vchar2" columnOrder="37" width="4000"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Note">
          <dataDescriptor expression="a.NOTE" descriptiveExpression="NOTE"
           order="14" width="4000"/>
        </dataItem>
        <dataItem name="PART_SUM" datatype="vchar2" columnOrder="38"
         width="4000" defaultWidth="20000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Part Sum">
          <dataDescriptor expression="a.PART_SUM"
        ...
        <dataItem name="s_date_strax" datatype="date" oracleDatatype="date"
         ...
         columnFlags="1" defaultLabel="S Date Strax">
          <dataDescriptor expression="a.S_DATE_STRAX"
        ...
        <dataItem name="e_date_strax" datatype="date" oracleDatatype="date"
         ...
         columnFlags="1" defaultLabel="E Date Strax">
          <dataDescriptor expression="a.E_DATE_STRAX"
        ...
        <dataItem name="s_date_waiting" datatype="date" oracleDatatype="date"
         ...
         columnFlags="1" defaultLabel="S Date Waiting">
          <dataDescriptor expression="a.S_DATE_WAITING"
           descriptiveExpression="S_DATE_WAITING" order="23"
           oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="days_waiting" oracleDatatype="number" columnOrder="42"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Days Waiting">
          <dataDescriptor expression="a.DAYS_WAITING"
           descriptiveExpression="DAYS_WAITING" order="24"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="waiting_period_end_date" datatype="date"
         oracleDatatype="date" columnOrder="43" width="9" defaultWidth="90000"
         defaultHeight="10000" columnFlags="1"
         defaultLabel="Waiting Period End Date">
          <dataDescriptor expression="a.WAITING_PERIOD_END_DATE"
           descriptiveExpression="WAITING_PERIOD_END_DATE" order="25"
           oracleDatatype="date" width="9"/>
        </dataItem>
        <dataItem name="is_in_waiting_period" oracleDatatype="number"
         columnOrder="44" width="22" defaultWidth="90000"
         defaultHeight="10000" columnFlags="1"
         defaultLabel="Is In Waiting Period">
          <dataDescriptor expression="a.IS_IN_WAITING_PERIOD"
           descriptiveExpression="IS_IN_WAITING_PERIOD" order="29"
           oracleDatatype="number" width="22" scale="-127"/>
        </dataItem>
        <dataItem name="dog_dest" oracleDatatype="number" columnOrder="45"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Dog Dest">
          <dataDescriptor expression="a.DOG_DEST"
           descriptiveExpression="DOG_DEST" order="30" oracleDatatype="number"
           width="22" scale="-127"/>
        </dataItem>
      </group>
    </dataSource>
    <link name="L_1" parentGroup="G_BORDERO_TYPE" parentColumn="RE_BORDERO_ID"
...
<rw:getValue id="IS_IN_WAITING_PERIOD" src="IS_IN_WAITING_PERIOD" formatMask="999999990.99"/>
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl60><rw:field id="" src="DATE_OF_BIRTH" formatMask="DD.MM.YYYY"></rw:field></td>
  ...
  <td class=xl59>&nbsp;</td>
  <td class=xl61><rw:field id="" src="S_DATE_STRAX" formatMask="DD.MM.YYYY"></rw:field></td>
  <td class=xl61><rw:field id="" src="E_DATE_STRAX" formatMask="DD.MM.YYYY"></rw:field></td>
  <td class=xl59>&nbsp;</td>
  <td class=xl59>&nbsp;</td>
  <td class=xl59><rw:field id="" src="DOG_DEST"></rw:field></td>
  <td class=xl61><%if (Double.valueOf(IS_IN_WAITING_PERIOD).doubleValue() == 0) {%>&nbsp;
    <%} else {%><rw:field id="" src="S_DATE_WAITING" formatMask="DD.MM.YYYY"></rw:field><%}%> </td>
  <td class=xl61><%if (Double.valueOf(IS_IN_WAITING_PERIOD).doubleValue() == 0) {%>&nbsp;
    <%} else {%><rw:field id="" src="WAITING_PERIOD_END_DATE" formatMask="DD.MM.YYYY"></rw:field><%}%> </td>
