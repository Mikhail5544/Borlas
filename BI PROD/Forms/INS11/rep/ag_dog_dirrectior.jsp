 ...
 WHERE acj.agency_id = dep.department_id(+)
   ...
   AND acj.ag_contract_header_id = :p_ch_id;]]>
      ...
      <group name="G_AGENT">
        ...
        />
        <dataItem name="dir_name" datatype="vchar2" columnOrder="36"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Dir Name">
          <dataDescriptor
           expression="NVL ( ent.obj_name ( ent.id_by_brief ( &apos;CONTACT&apos; ) , dept_exe.contact_id ) , &apos;Смышляев Юрий Олегович&apos; )"
           descriptiveExpression="DIR_NAME" order="7" width="4000"/>
        </dataItem>
        <dataItem name="reg_date" datatype="date" oracleDatatype="date"
         ...
         columnFlags="1" defaultLabel="Reg Date">
          <dataDescriptor expression="d.reg_date"
        ...
        <dataItem name="num" datatype="vchar2" columnOrder="16" width="201"
         ...
         defaultLabel="Num">
          <dataDescriptor
           expression="DECODE ( dep.code , NULL , NULL , dep.code || &apos;-&apos; ) || acj.num"
           descriptiveExpression="NUM" order="4" width="201"/>
        </dataItem>
  ...
  FROM v_company_info org;]]>
      ...
      <group name="G_ORG_CONT">
        ...
        />
        <dataItem name="chief_name" datatype="vchar2" columnOrder="26"
         width="4000" defaultWidth="100000" defaultHeight="10000"
 ...
 WHERE ca.adress_id = a.ID
   ...
   AND (AT.brief = 'CONST' OR AT.brief = 'FACT');
      ...
      <group name="G_AGENT_ADDR">
        ...
        />
        <dataItem name="pref" datatype="vchar2" columnOrder="29"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Pref">
          <dataDescriptor
        ...
        <dataItem name="contact_id" oracleDatatype="number" columnOrder="28"
         width="22" defaultWidth="110000" defaultHeight="10000"
        ...
        <dataItem name="addr1" datatype="vchar2" columnOrder="27" width="4000"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Addr1">
...
ORDER BY NVL (cci.issue_date, TO_DATE ('01.01.1900', 'DD.MM.YYYY')) DESC]]>
      ...
      <group name="G_AG_DOCS">
        ...
        />
        <dataItem name="CONTACT_ID2" oracleDatatype="number" columnOrder="30"
         width="22" defaultWidth="110000" defaultHeight="10000"
        ...
        <dataItem name="doc_desc" datatype="vchar2" columnOrder="31"
         width="30" defaultWidth="100000" defaultHeight="10000"
        ...
        <dataItem name="p_ser" datatype="vchar2" columnOrder="32" width="50"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="P Ser">
          <dataDescriptor
        ...
        <dataItem name="p_num" datatype="vchar2" columnOrder="33" width="50"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="P Num">
          <dataDescriptor
        ...
        <dataItem name="pvidan" datatype="vchar2" columnOrder="34" width="255"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Pvidan">
          <dataDescriptor
        ...
        <dataItem name="data_v" datatype="vchar2" columnOrder="35" width="11"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Data V">
          <dataDescriptor
...
<link rel=File-List href="ag_dog_directior.files/filelist.xml">
...
@page Section1
	...
	mso-even-header:url("<%=g_ImagesRoot%>/ag_dog_dirrector.files/header.htm") eh1;
	mso-even-footer:url("<%=g_ImagesRoot%>/ag_dog_dirrector.files/header.htm") ef1;
	mso-footer:url("<%=g_ImagesRoot%>/ag_dog_dirrector.files/header.htm") f1;		
	mso-paper-source:0;}
div.Section1
	{page:Section1;}
@page Section2
...
<table class="mainTable">
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  действующего на основании доверенности №<span >__________________ дата выдачи _______________,
  с одной стороны, и<span style='mso-spacerun:yes'>   </span>, и </span></span><span ><%=AGNAME%></span><b
  ...
  определенного в «Положении об основном агентском вознаграждении АГЕНТОВ» (<a
  href="#_Приложение_№_1"><span style='font-size:10.0pt;font-family:Arial;
  mso-bidi-font-family:"Times New Roman";color:windowtext;text-decoration:none;
  text-underline:none'>Приложение № 1</span></a> к настоящему Договору) и
  «Положении о дополнительном агентском вознаграждении АГЕНТОВ» (<a
  href="#_Приложение_№_2"><span style='font-size:10.0pt;font-family:Arial;
  mso-bidi-font-family:"Times New Roman";color:windowtext;text-decoration:none;
  text-underline:none'>Приложение № 2</span></a> к настоящему Договору),
  предоставлять СТРАХОВЩИКУ письменные Отчеты о выполнении своих обязанностей
  по настоящему Договору по установленной СТРАХОВЩИКОМ в <a
  href="#_Приложение_№_4"><span style='font-size:10.0pt;font-family:Arial;
  mso-bidi-font-family:"Times New Roman";color:windowtext;text-decoration:none;
  text-underline:none'>Приложениях</span></a> №№ 3, 4, 5 к настоящему Договору
  ...
  указанном в <a href="#_Приложение_№_1">Приложении №1</a> к настоящему
...
<table class="mainTable">
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  лице <%=CHIEF_NAME%>, действующего на основании
  ___________________________, с одной стороны, и <%=AGNAME%>, паспорт серии <%=PS%> № <%=PNUM%>, именуемый(ая) в
