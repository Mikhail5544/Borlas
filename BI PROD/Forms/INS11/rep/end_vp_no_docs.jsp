...
<title>Письмо о расторжении по истечении ВП (по причине непредоставления информации для оценки риска)</title>
<style>
<!--
 /* Font Definitions */
 @font-face
...
<rw:getValue id="j_e_amount" src="summa"/>
<% ret_sum = new String(j_e_amount);%>
<div class=Section1>
...
условиям Договора страхования (Соглашения о временном страховом покрытии) 
№ <rw:field id="f_dog_num" src="dog_num"/>, установленный для оценки степени страхового риска выжидательный период,
равный 60-ти календарным дням, истек <i><rw:field id="f_data_wait" src="data_wait"/></i>. 
К сожалению, к указанной дате Вами так и не была предоставлена необходимая
информация для оценки риска, и Компания вынуждена настоящим письмом уведомить Вас,
что в соответствии с п. 11.2.1 Общих условий страхования по индивидуальному
страхованию жизни и страхованию от несчастных случаев и болезней, являющихся
составной и неотъемлемой частью договора страхования, договор (соглашение о
временном покрытии) № <rw:field id="f_dog_num2" src="dog_num"/> считается расторгнутым с 
<i><rw:field id="f_data_rast" src="data_rast"/></i>, и Компания
не несет ответственности по данному договору.</span></p>

<p class=MsoBodyText style='margin-top:4.0pt;line-height:150%'><span
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'>Причитающаяся
Вам в связи с расторжением договора сумма будет перечислена на указанный Вами в
...
на которые необходимо произвести перечисление средств.</span></p>
<%}%>
<p class=MsoBodyText style='margin-top:4.0pt;line-height:150%'><span
