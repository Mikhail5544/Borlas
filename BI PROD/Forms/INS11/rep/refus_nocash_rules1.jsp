...
select to_char(decode(ss.plan_date,null,ss.due_date,ss.plan_date),'dd.mm.yyyy'),
       to_char(decode(ss.plan_date,null,ss.due_date,ss.plan_date) + 30,'dd.mm.yyyy')
into :date_zad, :date_lgot
from p_policy ph,
...
where ph.policy_id = :P_PID
      ...
      and rownum = 1;
exception
      when no_data_found then :date_zad := '';:date_lgot := '';
...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2008-08-29T07:50:00Z</o:Created>
  <o:LastSaved>2008-08-29T07:50:00Z</o:LastSaved>
  <o:Pages>1</o:Pages>
  <o:Words>244</o:Words>
...
Вашего полиса<span style='mso-spacerun:yes'>  </span>№ <rw:field id="f_dog_num" src="dog_num"/> Вам необходимо
было уплатить очередной страховой взнос к <i><span style='mso-bidi-font-weight:
bold'><rw:field id="" src="date_zad"/></span></i>, в связи с чем в Ваш
адрес было направлено письмо-напоминания с просьбой погасить задолженность до <span
style='mso-bidi-font-weight:bold'><rw:field id="" src="date_lgot"/></span>.
<o:p></o:p></span></p>

<p class=MsoBodyText style='margin-top:12.0pt;line-height:150%'><span
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'>К сожалению,
к окончанию указанного срока сумма задолженности так и не была погашены. <o:p></o:p></span></p>

<p class=MsoBodyText style='margin-top:12.0pt;line-height:150%'><span
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'>Уведомляем
Вас настоящим письмом о том, что в соответствии с п. 12.2.1 Правил страхования жизни / 
Правил страхования от несчастных случаев и болезней (по программе «»Гармония жизни), являющихся составной и
неотъемлемой частью договора, договор № <rw:field id="f_dog_num" src="dog_num"/> считается расторгнутым с<span
style='mso-spacerun:yes'>  </span><i><span style='mso-bidi-font-weight:bold'><rw:field id="f_decline_date" src="decline_date"/>
 </span></i></span><span style='font-size:12.0pt;mso-bidi-font-size:
10.0pt;line-height:150%'>и Страховщик не несет ответственности по данному
договору</span><i><span style='font-size:12.0pt;line-height:150%;mso-fareast-language:
RU;mso-bidi-font-weight:bold'>.</span></i><span style='font-size:12.0pt;
line-height:150%;mso-fareast-language:RU'><o:p></o:p></span></p>

<p class=MsoBodyText style='margin-top:8.0pt;line-height:150%'><span
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'>Причитающаяся
Вам в связи с расторжением договора сумма<span style='mso-spacerun:yes'> 
</span>в размере <rw:field id="f_summa" src="summa"/>будет перечислена на указанный Вами в
Заявлении на страхование расчетный счет. Если по каким-то причинам Вы не
указали в Заявлении необходимые данные или произошло изменение этих данных,
просим Вас направить в адрес нашей Компании письмо с указанием<span
style='mso-spacerun:yes'>  </span>реквизитов (наименование банка, БИК, ИНН,
корр. счет, расчетный счет, лицевой счет),<span style='mso-spacerun:yes'> 
</span>на которые необходимо произвести перечисление средств. <o:p></o:p></span></p>
...
<p class=MsoBodyText style='margin-top:8.0pt;line-height:150%'><span
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'><span
style='mso-spacerun:yes'> </span><b><i>С уважением,<o:p></o:p></i></b></span></p>
