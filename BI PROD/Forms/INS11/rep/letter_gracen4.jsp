...
<report name="letter_grace" DTDVersion="9.0.2.0.10"
    ...
    <dataSource name="Q_2">
      ...
      <![CDATA[select rownum rec_number,
       ...
       pol_ser,
	     type_contact,
	     gender,
       case mb when 0 then to_char(fee-pay_amount_dog,'999999999D99') else to_char(amount-pay_amount_dog,'999999999D99') end fee
from
(select 
       vlp.payment_period,
       vlp.contact_name,
     ...
     vlp.mb,
	   ...
	   vlp.pay_amount_dog,
       vlp.fund,
       decode(vlp.product_id,2267,to_char(vlp.due_date+45,'dd.mm.yyyy'),
                             7680,to_char(vlp.due_date+45,'dd.mm.yyyy'), 
                             7678,to_char(vlp.due_date+45,'dd.mm.yyyy'),
                             7679,to_char(vlp.due_date+45,'dd.mm.yyyy'),
                             20525,to_char(vlp.due_date+30,'dd.mm.yyyy'),
                             20544,to_char(vlp.due_date+30,'dd.mm.yyyy'),
                             28290,to_char(vlp.due_date+30,'dd.mm.yyyy'),
                             to_char(vlp.grace_date,'dd.mm.yyyy')) as grace_period,
...
group by vlp.payment_period,
       ...
       decode(vlp.product_id,2267,to_char(vlp.due_date+45,'dd.mm.yyyy'),
                             ...
                             20544,to_char(vlp.due_date+30,'dd.mm.yyyy'),
                             28290,to_char(vlp.due_date+30,'dd.mm.yyyy'),
                             to_char(vlp.grace_date,'dd.mm.yyyy')),
...
<title>Письмо-напоминание на выжидательном периоде</title>
<style>
<!--
/* Font Definitions */
 @font-face
...
margin-left:-1.0cm;text-align:justify;text-indent:1.0cm'><b><i><span
style='mso-bidi-font-size:10.0pt;font-family:Calibri'>
...
mso-fareast-language:RU'>Компания "Ренессанс Жизнь" благодарит Вас за сотрудничество и напоминает о том,
 что согласно условиям договора страхования № <b><rw:field id="f_dog_num2" src="dog_num"/></b>,
Вам необходимо было оплатить очередной <rw:field id="f_payment_period" src="payment_period"/>
страховой взнос в размере <b><i><rw:field id="f_fee" src="fee"/> 
<rw:field id="f_fund" src="fund"/></i></b> <% if (fund.equals("RUR") ) { %> <% } else { %> (по курсу ЦБ на дату оплаты) <% } %> к <b><i><rw:field id="f_grace_date" src="grace_date"/></i></b>. Однако, к указанной
дате сумма взноса в Компанию "Ренессанс Жизнь" не поступила.</span></p>

<p class=MsoBodyText style='margin-top:4.0pt;margin-right:0cm;margin-bottom:
0cm;margin-left:-1.0cm;text-indent:1.0cm;line-height:
100%'><span style='mso-bidi-font-size:10.0pt;line-height:100%;font-family:Calibri;
mso-fareast-language:RU'>Возможность оплаты
страхового взноса по Вашему договору страхования в соответствии с Общими
условиями страхования / Правилами страхования / Полисными условиями, на основании которых заключен договор страхования,
сохраняется до окончания льготного периода, т.е. до <b><i><rw:field id="f_grace_period" src="grace_period"/></i></b>.
Оплату страхового взноса необходимо произвести не позднее даты окончания льготного
периода, в противном случае договор страхования, обеспечивающий финансовую
защиту для Вас и Ваших близких, Компания "Ренессанс Жизнь" вынуждена будет расторгнуть.</span></p>

<p class=MsoBodyText style='margin-top:4.0pt;margin-right:0cm;margin-bottom:
0cm;margin-left:-1.0cm;text-indent:1.0cm;line-height:
100%'><span style='mso-bidi-font-size:10.0pt;line-height:100%;font-family:Calibri;
mso-fareast-language:RU'>Для продолжения действия Вашего договора страхования,
обращаемся к Вам с просьбой оплатить очередной страховой взнос, по возможности, как можно
скорее.</span></p>

<p class=MsoBodyText style='margin-top:4.0pt;margin-right:0cm;margin-bottom:
0cm;margin-left:-1.0cm;text-indent:1.0cm;line-height:
100%'><span style='mso-bidi-font-size:10.0pt;line-height:100%;font-family:Calibri;
mso-fareast-language:RU'><b>В случае если уплата страхового взноса Вами уже была произведена,
просим не принимать во внимание настоящее письмо.</b></span></p>

<p class=MsoBodyText style='margin-top:4.0pt;margin-right:0cm;margin-bottom:
0cm;margin-left:-1.0cm;text-indent:1.0cm;line-height:
100%'><span style='mso-bidi-font-size:10.0pt;line-height:100%;font-family:Calibri;
mso-fareast-language:RU'>Для уплаты страхового взноса без дополнительных банковских
комиссионных сборов Вы можете воспользоваться:</span></p>


<p class=MsoBodyText style='text-align:justify;text-indent:1.0cm;margin-left:-1.0cm'><span
style='font-size:10.0pt;font-family:Calibri'>1. Платежной системой CONTACT. Со
списком банков, работающих в Вашем регионе по платежной системе CONTACT, можно ознакомиться 
нашем сайте по адресу <a href="http://www.renlife.ru/private/payments.html">http://www.renlife.ru/private/payments.html</a>.</span></p>

<p class=MsoBodyText style='text-indent:27.0pt;line-height:normal'><span style='font-size:9.0pt;
font-family:Calibri'>Реквизиты для оплаты через платежную систему Contact<o:p></o:p></span></p>

<p class=MsoBodyText style='text-indent:27.0pt;line-height:normal'><span style='font-size:9.0pt;
font-family:Calibri'>Получатель платежа: ООО «СК «Ренессанс
Жизнь», ИНН 7725520440, XPEJ<o:p></o:p></span></p>

<p class=MsoBodyText style='text-indent:27.0pt;line-height:normal'><span style='font-size:9.0pt;
font-family:Calibri'>Назначение платежа: Страховая премия по договору № <i
style='mso-bidi-font-style:normal'><rw:field id="f_dog_num" src="dog_num"/></i>. <o:p></o:p></span></p>
...
href="http://www.vtb24.ru/">http://www.vtb24.ru/</a></span></span></p>
...
<p class=MsoNormal style='text-align:justify;text-indent:1.0cm;margin-left:-1.0cm'><span
style='font-size:10.0pt;font-family:Calibri'>3.</span> <span style='font-size:
10.0pt;font-family:Calibri'>Услугами Страхового агента «Ренессанс Жизнь»,
уполномоченного Компанией принимать страховые взносы. Вызвать агента Вы можете,
позвонив по телефону +7 (495) 981-2-981.</span></p>

<p class=MsoBodyText style='margin-top:6.0pt;margin-right:0cm;margin-bottom:
0cm;margin-left:-1.0cm;text-indent:1.0cm;line-height:
100%'><span style='mso-bidi-font-size:10.0pt;line-height:100%;font-family:Calibri;
mso-fareast-language:RU'>Для упрощения процедуры
оплаты, к данному письму приложены квитанции на оплату, с заполненными реквизитами
Компании «Ренессанс Жизнь» и суммой очередного страхового взноса</span></p>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=677
 ...
 <tr style='mso-yfti-irow:9;height:22.95pt'>
  ...
  style='mso-ansi-language:EN-US'><% if (fund.equals("RUR") ) { %><rw:field id="f_fee" src="fee"/><% } else { %><% } %><o:p></o:p></span></b></p>
  </td>
 </tr>
 ...
 <td width=156 valign=bottom style='width:117.0pt;border-top:none;border-left:
  ...
  normal'><span lang=EN-US style='mso-ansi-language:EN-US'><rw:field id="f_pol_ser" src="pol_ser"/> </span></b><span
  ...
  normal'><span lang=EN-US style='mso-ansi-language:EN-US'><rw:field id="f_dog_num" src="dog_num"/> </span></b><span
  lang=EN-US style='mso-ansi-language:EN-US'><o:p></o:p></span></p>
  </td>
 </tr>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:231.45pt'>
  ...
  none'>ИЗВЕЩЕНИЕ</p>
  <p class=MsoNormal style='margin-left:6.6pt;mso-pagination:none;mso-layout-grid-align:
  none'><span style='font-size:6.0pt;mso-bidi-font-size:12.0pt'>Кассир<o:p></o:p></span></p>
  </td>
  ...
  <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
   ...
   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;page-break-inside:avoid;
    ...
    АО «<span class=SpellE>Райффайзенбанк</span>» г. Москва<o:p></o:p></span></p>
  ...
  <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
   ...
   <tr style='mso-yfti-irow:2;page-break-inside:avoid;height:17.75pt'>
    ...
    style='font-size:8.0pt;mso-bidi-font-size:12.0pt'>________________________________________________________________<o:p></o:p></span></p>
    </td>
   </tr>
  ...
  <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
   ...
   <tr style='mso-yfti-irow:1;page-break-inside:avoid;height:16.05pt'>
    ...
    style='mso-spacerun:yes'>   </span>№ <rw:field id="f_dog_num" src="dog_num"/><o:p></o:p></span></b></p>
    </td>
    ...
    mso-ansi-language:EN-US'><% if (fund.equals("RUR") ) { %><rw:field id="f_fee" src="fee"/><% } else { %><% } %><o:p></o:p></span></b></p>
    <p class=MsoNormal align=center style='text-align:center'><span
...
<p class=MsoBodyText style='margin-top:4.0pt;margin-right:0cm;margin-bottom:
   ...
   <tr style='mso-yfti-irow:4;page-break-inside:avoid;height:20.85pt;
    ...
    style='font-size:9.0pt;mso-bidi-font-size:12.0pt'>Страхователь</span></b><span
    style='font-size:9.0pt;mso-bidi-font-size:12.0pt'> </span><span
    style='font-size:8.0pt;mso-bidi-font-size:12.0pt'>______________________________________________________________<o:p></o:p></span></p>
    </td>
    <td style='mso-cell-special:placeholder;border:none;padding:0cm 0cm 0cm 0cm'
    width=256><p class='MsoNormal'>&nbsp;</td>
   </tr>
  ...
  <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
   ...
   <tr style='mso-yfti-irow:1;page-break-inside:avoid;height:3.5pt'>
    ...
    12.0pt'>по полису<span style='mso-spacerun:yes'>  </span>№ <rw:field id="f_dog_num" src="dog_num"/><span
