...
agr.ag_perfomed_work_act_id agent_report_id, agch.ag_contract_header_id, hed.num act_num,
       agr.date_calc report_date, hed.date_begin, hed.date_end, con.contact_id,
  ...
  FROM ag_perfomed_work_act agr
       ...
       JOIN ven_t_sales_channel salchan ON (agch.T_SALES_CHANNEL_ID = salchan.id)        
...
where ar.ag_roll_id = :p_ag_roll_id
 ...
 and pc.policy_id = pp.policy_id and pc.contact_policy_role_id = 6
 ...
 and dp.summ <> 0
 order by decode(pp.pol_ser, null, pp.pol_num, pp.pol_ser || '-' || pp.pol_num)
 ;]]>
      </select>
      ...
      <group name="G_DOG_ZAKL">
        ...
        <dataItem name="PART_AGENT" oracleDatatype="number" columnOrder="55"
         ...
         defaultLabel="Part Agent">
          <dataDescriptor expression="PART_AGENT"
        ...
        <dataItem name="STAVKA" oracleDatatype="number" columnOrder="50"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Stavka">
          <dataDescriptor expression="STAVKA"
      ...
      <group name="G_DOG_ZAKL_TOT">
        ...
        <dataItem name="ROW_CNT_TOT" oracleDatatype="number" columnOrder="81"
         ...
         defaultLabel="Row Cnt Tot">
          <dataDescriptor expression="ROW_CNT_TOT"
...
begin
  PKG_REP_UTILS2.iSetVal('P_AG_REP_ID',1);
