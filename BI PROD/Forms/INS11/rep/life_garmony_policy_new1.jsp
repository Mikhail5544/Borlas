...
<report name="life_garmony_policy" DTDVersion="9.0.2.0.10"
 beforeReportTrigger="afterpform" unitOfMeasurement="centimeter">
  ...
  <data>
    ...
    <userParameter name="PA_DOC" datatype="character" width="200"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    ...
    <userParameter name="ITOGO_PREM" datatype="character" width="200"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="INSURER" datatype="character" width="200"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="POL_NUM" datatype="character" width="200"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="POL_HOLDER" datatype="character" width="200"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="POL_ASS" datatype="character" width="200"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="PH_DOC" datatype="character" width="200"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    ...
    <dataSource name="Q_1">
      <select>
      <![CDATA[select years, start_date, end_date from 
...
where pp.policy_id = :P_POLICY_ID
 ...
 group by pc.start_date,  pc.end_date) t
...
where pp.policy_id = :P_POLICY_ID --782299
 ...
 and (ig.brief <> 'Acc'
  or (ig.brief = 'Acc' and plo.id = 22603)) -- согласовано с Д.Ивановым!
]]>
      </select>
...
--       upper(plo.description) as dop_progr_ns,
       decode(instr(upper(plo.description), 'ТЕЛЕСНЫЕ ПОВРЕЖДЕНИЯ'), 0, upper(plo.description), upper(plo.description) || ' (страховое обеспечение в соответствии с Таблицей выплат по страховому риску "телесные повреждения в результате несчастного случая")') as dop_progr_ns
from 
        ven_p_policy pp, 
        ven_as_asset ass, 
        ven_p_cover pc, 
...
where pp.policy_id = :P_POLICY_ID --782299
 ...
 and upper(trim(plo.description)) <> 'АДМИНИСТРАТИВНЫЕ ИЗДЕРЖКИ'
 and ig.brief = 'Acc'
 and plo.id <> 22603 -- согласовано с Д.Ивановым!
]]>
      </select>
...
exception
  ...
  select  
    ...
    -- Страхователь
    ent.obj_name('CONTACT',pkg_policy.get_policy_holder_id(pp.policy_id)),
    to_char(pkg_contact.get_birth_date(pkg_policy.get_policy_holder_id(pp.policy_id)),'dd.mm.yyyy'),
    replace(replace(pkg_contact.get_primary_doc (pkg_policy.get_policy_holder_id(pp.policy_id)),
    ...
    vf.brief kod_val  
    into :BRIEF_PRODUCT,:POL_NUM,:P_NOTICE,:PROGRAMMA,:P_SYSDATE,:POL_HOLDER,:PH_BIRTH,:PH_DOC,:POL_ASS,:PA_BIRTH,:PA_DOC, :PA_PERIODICH, :WAITING_PERIOD_END_DATE, :PA_ROW_PRIL, :PA_KOD_VAL
    from t_product ak, ven_p_policy pp, ven_p_pol_header ph, ven_as_asset a , ven_as_assured s, VEN_T_PAYMENT_TERMS vt, VEN_FUND vf,
  ...
  (select ds.document_id, ds.start_date from ven_doc_status ds, ven_doc_status_ref dsr 
    where ds.doc_status_ref_id = dsr.doc_status_ref_id(+)
      and dsr.brief = 'ACTIVE' and ds.document_id =:P_POLICY_ID ) ds
    where pp.policy_id = :P_POLICY_ID
...
-- Дата уплаты первого последующих взносов
  begin
    ...
    where pps.policy_id = pp.policy_id 
...
begin   
 ...
 WHERE pc.t_prod_line_option_id = pro.ID(+)
   ...
   and pro.description = 'Телесные повреждения Застрахованного в результате НС';
  exception
...
;
  ...
  if (:P_CNT_POVREZH > 0) then
    if (:PA_ROW_PRIL = 0) then 
      :P_TEL_VRED := '4. Таблица выплат по страховому риску "Телесные повреждения в результате несчастного случая"';
    else 
      :P_TEL_VRED := '5. Таблица выплат по страховому риску "Телесные повреждения в результате несчастного случая"';  
    end if;
  else  :P_TEL_VRED := '';
  end if;   

  if (:BRIEF_PRODUCT in ('CHI', 'END'))   then
    if (:P_CNT_POVREZH > 0) then
      :P_TEL_VRED := '5. Таблица выплат по страховому риску "Телесные повреждения в результате несчастного случая"';       
    end if;      
  end if;   
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=708
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  ...
  RU'>ГАРМОНИЯ ЖИЗНИ</span></b><b><span style='font-size:18.0pt;color:#FF6600;
 ...
 <tr style='mso-yfti-irow:21'>
  <td width=708 colspan=5 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><b><span style='font-size:9.0pt;mso-bidi-font-size:8.0pt;
  color:#FF6600;mso-ansi-language:RU'>4. ТЕлеГРАММЫ СТРАХОВАНИЯ</span></b><b
 ...
 <tr style='mso-yfti-irow:27'>
  <td width=455 colspan=2 valign=top style='width:341.3pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>ДОПОЛНИТЕЛЬНЫЕ ПРОГРАММЫ:<o:p></o:p></span></b></p>
  </td>
  <td width=143 colspan=2 valign=top style='width:107.5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;mso-ansi-language:
 ...
 <tr style='mso-yfti-irow:35;'>
  ...
  <p class=MsoNormal style='margin-left:12.6pt;text-indent:-12.6pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'><span style='mso-spacerun:yes'> 
  </span>* &quot;СТРАХОВАНИЕ ОТ НЕСЧАСТНЫХ СЛУЧАЕВ&quot;<!-- (ПУНКТ 1 ПРИЛОЖЕНИЯ №1
 ...
 <tr style='mso-yfti-irow:42'>
  ...
  name="ns_ins"></a><span style='mso-spacerun:yes'> </span>ПРЕМИЯ:<span
  style='mso-spacerun:yes'>   </span><a name=program>ОСНОВНАЯ<span
  style='mso-spacerun:yes'>  </span>И ДОПОЛНИТЕЛЬНЫЕ ПРОГРАММЫ</a> <i
 ...
 <tr style='mso-yfti-irow:44'>
  ...
  style='mso-bidi-font-style:normal'><span style='font-size:8.0pt;mso-ansi-language:
  RU'>уплачивается <a name="charge_period">раз в год</a></span></i></b><b
  style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;mso-ansi-language:
  RU'>):<o:p></o:p></span></b></p>
  </td>
  <td width=110 valign=top style='width:82.2pt;border-top:none;border-left:
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=708
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:2.0pt;'>
  ...
  height:2.0pt'>
  <p class=MsoNormal><b><span style='font-size:9.0pt;mso-bidi-font-size:8.0pt;
  color:#FF6600;mso-ansi-language:RU'>5. ПЕРИОД СТРАХОВАНИЯ</span></b><b
  style='mso-bidi-font-weight:normal'><span style='font-size:9.0pt;mso-bidi-font-size:
  8.0pt;mso-ansi-language:RU'><o:p></o:p></span></b></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:6;height:3.15pt;'>
  ...
  дополнительным программам <span style='mso-bidi-font-weight:bold'><rw:field id="" src="P_DOP_PROGR"/></span> не выразит желания исключить какую-либо из указанных<span
 ...
 <tr style='mso-yfti-irow:10'>
  <td width=300 colspan=4 valign=top style='width:225.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>ДАТА УПЛАТЫ ПЕРВОГО ВЗНОСА:<o:p></o:p></span></b></p>
  </td>
 ...
 <tr style='mso-yfti-irow:12'>
  ...
  normal'><span style='font-size:8.0pt;mso-ansi-language:RU'>ДАТА УПЛАТЫ ПОСЛЕДУЮЩИХ ВЗНОСОВ:</span></b></a><b
  style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;mso-ansi-language:
  RU'><o:p></o:p></span></b></p>
  </td>
  <td width=408 colspan=8 valign=top style='width:306.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
 ...
 <tr style='mso-yfti-irow:22'>
  ...
  style='font-size:8.0pt;mso-ansi-language:RU'>1. ДОГОВОР СТРАХОВАНИЯ ЗАКЛЮЧЕН
  НА ОСНОВАНИИ "ПРАВИЛ СТРАХОВАНИЯ ЖИЗНИ", УТВЕРЖДЕННЫХ ГЕНЕРАЛЬНЫМ ДИРЕКТОРОМ ООО "СК "РЕНЕССАНС ЖИЗНЬ" 30.06.2007 ГОДА</span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:23;page-break-inside:avoid;height:1.9pt'>
  <td width=708 colspan=12 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:1.9pt'>
  <p class=MsoNormal style='margin-left:5.4pt;text-indent:-5.4pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></p>
 ...
 <tr style='mso-yfti-irow:24;page-break-inside:avoid;height:1.9pt'>
  <td width=708 colspan=12 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:1.9pt'>
  <p class=MsoNormal style='margin-left:5.4pt;text-indent:-5.4pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>2. СТОРОНЫ ПРИЗНАЮТ РАВНУЮ
  ЮРИДИЧЕСКУЮ СИЛУ СОБСТВЕННОРУЧНОЙ ПОДПИСИ И ФАКСИМИЛЕ ПОДПИСИ СТРАХОВЩИКА
  (ВОСПРОИЗВЕДЕНЕННОЕ МЕХАНИЧЕСКИМ ИЛИ ИНЫМ СПОСОБОМ С ИСПОЛЬЗОВАНИЕМ КЛИШЕ) НА
  ПОЛИСЕ, А ТАКЖЕ ПРИЛОЖЕНИЯХ И ДОПОЛНИТЕЛЬНЫХ СОГЛАШЕНИЯХ К НЕМУ.<o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:25;page-break-inside:avoid;height:1.9pt'>
  <td width=708 colspan=12 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:1.9pt'>
  <p class=MsoNormal style='margin-left:5.4pt;text-indent:-5.4pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></p>
 ...
 <tr style='mso-yfti-irow:26;page-break-inside:avoid;height:1.9pt'>
  <td width=708 colspan=12 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:1.9pt'>
  <p class=MsoNormal style='margin-left:5.4pt;text-indent:-5.4pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>3. ПРИ ДОСРОЧНОМ<span
  ...
  </span>(ПРИЛОЖЕНИЕ № 1, ПРИЛОЖЕНИЕ № 2). <o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:27;page-break-inside:avoid;height:1.9pt'>
  <td width=708 colspan=12 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:1.9pt'>
  <p class=MsoNormal style='margin-left:5.4pt;text-indent:-5.4pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></p>
 ...
 <tr style='mso-yfti-irow:28;page-break-inside:avoid;height:1.9pt'>
  <td width=708 colspan=12 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:1.9pt'>
  <p class=MsoNormal style='margin-left:5.4pt;text-indent:-5.4pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>4. ДАТА ДОСРОЧНОГО ПРЕКРАЩЕНИЯ
  ВЫЖИДАТЕЛЬНОГО ПЕРИОДА: <rw:field id="" src="WAITING_PERIOD_END_DATE"/></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:29;page-break-inside:avoid;height:1.9pt'>
  <td width=708 colspan=12 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:1.9pt'>
  <p class=MsoNormal style='margin-left:5.4pt;text-indent:-5.4pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></p>
 ...
 <tr style='mso-yfti-irow:30;height:4.75pt'>
  <td width=708 colspan=12 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:4.75pt'>
  <p class=MsoNormal style='margin-left:5.4pt;text-indent:-5.4pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>5. ЛЬГОТНЫЙ ПЕРИОД: 45 ДНЕЙ.</span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:31;height:4.75pt'>
  <td width=708 colspan=12 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:4.75pt'>
  <p class=MsoNormal style='margin-left:5.4pt;text-indent:-5.4pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></p>
 ...
 <tr style='mso-yfti-irow:32;height:4.75pt'>
  <td width=708 colspan=12 valign=top style='width:531.0pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:4.75pt'>
  <p class=MsoNormal style='margin-left:5.4pt;text-indent:-5.4pt'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>6. ДЛЯ РАСТОРЖЕНИЯ ДОГОВОРА СТРАХОВАНИЯ В СЛУЧАЯХ, ПРЕДУСМОТРЕННЫХ П.П. 5.8, 7.9 ПРАВИЛ, СТРАХОВЩИК ДОЛЖЕН НАПРАВИТЬ СТРАХОВАТЕЛЮ ПИСЬМЕННОЕ ИЗВЕЩЕНИЕ МЕНЕЕ ЧЕМ ЗА 21 (ДВАДЦАТЬ ОДИН) ДЕНЬ ДО  ПРЕДПОЛАГАЕМОЙ ДАТЫ ПРЕКРАЩЕНИЯ ДОГОВОРА, ПРИ ЭТОМ ДОГОВОР СЧИТАЕТСЯ РАСТОРГНУТЫМ С ДАТЫ, УКАЗАННОЙ В ИЗВЕЩЕНИИ.</span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:33'>
 ...
 <!--tr style='mso-yfti-irow:35'>
  ...
  <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><i style='mso-bidi-font-style:normal'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>2. Таблица выкупных сумм по
  программе ИНВЕСТ (Приложение № 2)<o:p></o:p></span></i></p>
  </td>
 </tr-->
 <tr style='mso-yfti-irow:36'>
  <td width=264 colspan=3 valign=top style='width:198.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
 ...
 <tr style='mso-yfti-irow:37'>
  ...
  <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><i style='mso-bidi-font-style:normal'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>3. Соглашение о временном
  страховом покрытии №<span style='mso-spacerun:yes'>  </span><rw:field id="" src="P_NOTICE"/></span></i></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:38'>
  ...
  <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><i style='mso-bidi-font-style:normal'><span
  style='font-size:8.0pt;mso-ansi-language:RU'>4. Правила страхования жизни от 30.06.2007</span></i></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:38'>
  <td width=264 colspan=3 valign=top style='width:198.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  ...
  <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><i style='mso-bidi-font-style:normal'><span
  style='font-size:8.0pt;mso-ansi-language:RU'><rw:field id="" src="P_TEL_VRED"/></i></p>
  </td>
 </tr>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=710
 ...
 <tr style='mso-yfti-irow:3;mso-yfti-lastrow:yes'>
  <td width=264 valign=top style='width:198.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><i><span style='font-size:8.0pt;mso-ansi-language:RU'>Москва, <rw:field id="" src="P_SYSDATE"/></span></i></p>
  </td>
  <td width=446 valign=top style='width:334.3pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><i><span style='font-size:8.0pt;mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></i></p>
  </td>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=626
 ...
 <thead>
  <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
   ...
   name="currency_3">РУБ.</a><o:p></o:p></span></b></span></p>
   </td>
   <span style='mso-bookmark:table_sum'></span>
  </tr>
 </thead>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=626
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
  page-break-inside:avoid'>
  <td width=626 valign=top style='width:469.2pt;padding:0cm 5.4pt 0cm 5.4pt'><a
  name="table_inv_sum"><br clear=all style='mso-special-character:line-break;
  page-break-before:always'>
  </a>
  <p class=MsoNormal><span style='mso-bookmark:table_inv_sum'><span
  style='mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></span></p>
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><b style='mso-bidi-font-weight:normal'><span
  style='mso-ansi-language:RU'>ПРИЛОЖЕНИЕ № 2<o:p></o:p></span></b></span></p>
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><i style='mso-bidi-font-style:normal'><span
  style='font-size:9.0pt;mso-ansi-language:RU'>Является составной и
  неотъемлемой частью полиса<span style='mso-spacerun:yes'>  </span>№ 011489<o:p></o:p></span></i></span></p>
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><span style='mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></span></p>
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><span style='mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></span></p>
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><b style='mso-bidi-font-weight:normal'><span
  style='mso-ansi-language:RU'>ТАБЛИЦА ВЫКУПНЫХ СУММ ПО ДОПОЛНИТЕЛЬНОЙ
  ПРОГРАММЕ "ИНВЕСТ"<o:p></o:p></span></b></span></p>
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><span style='mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></span></p>
  <span style='mso-bookmark:table_inv_sum'></span>
  <p class=MsoNormal style='margin-right:4.55pt'><span style='mso-bookmark:
  table_inv_sum'><b style='mso-bidi-font-weight:normal'><span style='font-size:
  8.0pt;mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></b></span></p>
  </td>
  <span style='mso-bookmark:table_inv_sum'></span>
 </tr>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=626
 ...
 <thead>
  <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
   ...
   style='mso-bookmark:table_inv_sum'><b style='mso-bidi-font-weight:normal'><span
   style='font-size:8.0pt;mso-ansi-language:RU'>ВЫКУПНАЯ СУММА, <a
   name="currency_4">РУБ.</a><o:p></o:p></span></b></span></p>
   </td>
   <span style='mso-bookmark:table_inv_sum'></span>
  </tr>
 </thead>
 <tr style='mso-yfti-irow:1;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><span style='font-size:10.0pt;mso-bidi-font-size:
  12.0pt;mso-ansi-language:RU'>1<o:p></o:p></span></span></p>
  </td>
  <span style='mso-bookmark:table_inv_sum'></span>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:dashed windowtext 1.0pt;border-right:dashed windowtext 1.0pt;
  ...
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><span style='font-size:10.0pt;mso-bidi-font-size:
  12.0pt;mso-ansi-language:RU'>26.07.2007<o:p></o:p></span></span></p>
  </td>
  <span style='mso-bookmark:table_inv_sum'></span>
  <td width=114 style='width:85.65pt;border-top:none;border-left:none;
  border-bottom:dashed windowtext 1.0pt;border-right:dashed windowtext 1.0pt;
  ...
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><span style='font-size:10.0pt;mso-bidi-font-size:
  12.0pt;mso-ansi-language:RU'>25.10.2007<o:p></o:p></span></span></p>
  </td>
  <span style='mso-bookmark:table_inv_sum'></span>
  <td width=170 style='width:127.2pt;border-top:none;border-left:none;
  border-bottom:dashed windowtext 1.0pt;border-right:dashed windowtext 1.0pt;
  ...
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><span style='font-size:10.0pt;mso-bidi-font-size:
  12.0pt;mso-ansi-language:RU'>0,00<o:p></o:p></span></span></p>
  </td>
  <span style='mso-bookmark:table_inv_sum'></span>
 </tr>
 <tr style='mso-yfti-irow:2;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><span style='font-size:10.0pt;mso-bidi-font-size:
  12.0pt;mso-ansi-language:RU'>2<o:p></o:p></span></span></p>
  </td>
  <span style='mso-bookmark:table_inv_sum'></span>
  <td width=90 style='width:67.35pt;border-top:none;border-left:none;
  border-bottom:dashed windowtext 1.0pt;border-right:dashed windowtext 1.0pt;
  ...
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><span style='font-size:10.0pt;mso-bidi-font-size:
  12.0pt;mso-ansi-language:RU'>26.10.2007<o:p></o:p></span></span></p>
  </td>
  <span style='mso-bookmark:table_inv_sum'></span>
  <td width=114 style='width:85.65pt;border-top:none;border-left:none;
  border-bottom:dashed windowtext 1.0pt;border-right:dashed windowtext 1.0pt;
  ...
  <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><span
  style='mso-bookmark:table_inv_sum'><span style='font-size:10.0pt;mso-bidi-font-size:
  12.0pt;mso-ansi-language:RU'>25.01.2008<o:p></o:p></span></span></p>
  </td>
  <span style='mso-bookmark:table_inv_sum'></span>
  <td width=170 style='width:127.2pt;border-top:none;border-left:none;
  border-bottom:dashed windowtext 1.0pt;border-right:dashed windowtext 1.0pt;
