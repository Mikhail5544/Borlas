...
<report name="rastorg_insurer_retold" DTDVersion="9.0.2.0.10">
  <data>
...
<title>Письмо-уведомление о расторжении по заявлению страхователя (наличие необходимости возврата части премии и старые условия страхования)</title>
<style>
<!--
 /* Font Definitions */
 @font-face
