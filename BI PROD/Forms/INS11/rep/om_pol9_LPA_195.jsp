...
<rw:getValue id="t_flg" src="flg"/> 
 ...
 <tr style='mso-yfti-irow:38'>
  ...
  <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=right><span style='font-size:7.0pt;mso-ansi-language:RU'>
  <% if (t_flg.equals("0")) { %>3.<% } else { %>4.<% } %> Настоящее Дополнительное соглашение 
  вступает в силу с момента оплаты дополнительного страхового взноса в сумме и в сроки, указанные в п. 2 настоящего Дополнительного соглашения. </span></p>
  </td>
 </tr>
  </tr>
  <tr style='mso-yfti-irow:38'>
