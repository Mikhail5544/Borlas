...
<userParameter name="DEPT" datatype="character" width="400"
    ...
    <dataSource name="Q_AGENT">
      ...
      <![CDATA[ SELECT ach.agent_id, ach.ag_contract_header_id,
       ...
       nvl((select genitive from contact where contact_id = ach.agent_id),
       ...
       decode(nvl(dept_exe.contact_id,0),0,'Директору департамента продаж через агентскую сеть ООО «СК «Ренессанс Жизнь»','Директору Филиала/Агентства ООО «СК «Ренессанс Жизнь»') dep_gl,
       decode(nvl(lower(vtt.description),'г-жа'),'г-н','г-на','г-жа','г-жи',lower(vtt.description)) g_n,
 ...
 WHERE ac.ag_contract_id = ach.last_ver_id
   ...
   AND ach.ag_contract_header_id = :p_ch_id;]]>
      ...
      <group name="G_AGENT">
		...
		<dataItem name="dep_gl" datatype="vchar2" columnOrder="22"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="dep gl">
          <dataDescriptor expression="dep_gl"
           descriptiveExpression="dep_gl" order="13" width="4000"/>
        </dataItem>
...
<rw:getValue id="dep_gl" src="dep_gl"/>
...
<p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none;text-align:left'><b><span
  style='font-size:10.0pt;font-family:Arial;color:black'><img width=125 height=50 src="<%=g_ImagesRoot%>/letter_remind/logo_new.jpg" alt="logo">
 </span></b><span
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  ...
  <p class=MsoNormal><%=G_N%> в городе</p>
  </td>
 ...
 <tr style='mso-yfti-irow:1'>
  ...
  <p class=MsoNormal><span style='font-size:9.0pt'><o:p><b><rw:field id="" src="DEPT"/></b></o:p></span></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:3'>
  ...
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:9.0pt'><o:p><b><%=AGENT_NAME_INS%></b></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:4'>
  ...
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal>Заявление/Соглашение №:</p>
  </td>
  <td width=166 valign=top style='width:124.7pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><o:p><%=AGDOGNUM%></o:p></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:5'>
  ...
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:9.0pt'><o:p><b>&nbsp;</b></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:6'>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><o:p><%=REG_DATE%></o:p></p>
  </td>
 </tr>
</table>
...
<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:10.0pt'>№ <%=AGDOGNUM%></span></b><span
...
<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:10.0pt'>утвержденному Приказом Управляющего директора ООО
«СК «Ренессанс Жизнь» Киселевым О.М. <span
style='mso-spacerun:yes'> </span>«01» апреля <st1:metricconverter
ProductID="2009 г" w:st="on">2009 г.</st1:metricconverter><o:p></o:p></span></b></p>

<p class=MsoNormal style='text-align:justify'><span style='font-size:10.0pt'>1.
<span class=GramE>Я, _<%=AGNAME%>_, именуемый (-<span
class=SpellE>ая</span>) в дальнейшем «АГЕНТ», настоящим безусловно присоединяюсь к<span
style='mso-spacerun:yes'>  </span>АГЕТСКОМУ ДОГОВОРУ (ПРИСОЕДИНЕНИЕ), 
утвержденным Управляющим директором ООО «СК «Ренессанс Жизнь» (далее
«СТРАХОВЩИК») Киселевым О.М. Приказом №_27/ОД/09 от 01.04.2009 г.<span style='mso-spacerun:yes'>  </span>
(Далее «АГЕНТСКИЙ ДОГОВОР (ПРИСОЕДИНЕНИЕ)») в редакции со всеми изменениями и дополнениями к нему.
<o:p></o:p></span></p>

<p class=MsoNormal style='text-align:justify'><span style='font-size:10.0pt'>2.
<span class=GramE>Настоящим я подтверждаю, что я ознакомился (лась) с текстом АГЕНТСКОГО ДОГОВОРА 
(ПРИСОЕДИНЕНИЕ) в редакции со всеми изменениями и дополнениями и для меня понятны все его условия, я 
согласен (-на) со всеми этими условиями, имею все права для заключения вышеуказанного АГЕНТСКОГО ДОГОВОРА 
(ПРИСОЕДИНЕНИЕ), а также обязуюсь за вознаграждение осуществлять от имени и по поручению СТРАХОВЩИКА посредническую 
деятельность в области страхования с целью заключения СТРАХОВЩИКОМ с физическими и юридическими лицами договоров 
страхования по следующим видам страхования:
<o:p></o:p></span></p>
...
Настоящим я также подтверждаю, что ознакомлен (-а) со ставками  АГЕНТСКОГО вознаграждения.<o:p></o:p></span></p>

<p class=MsoNormal style='text-align:justify'><span style='font-size:10.0pt'>5.
Я согласен (-на), что АГЕНТСКИЙ ДОГОВОРОМ (ПРИСОЕДИНЕНИЕ) считается заключенным с момента получения СТРАХОВЩИКОМ / 
представителем СТРАХОВЩИКА настоящего ЗАЯВЛЕНИЯ/СОГЛАШЕНИЯ.<o:p></o:p></span></p>

<p class=MsoNormal style='text-align:justify'><span style='font-size:10.0pt'>6.
...
Директор Филиала/Агентства <o:p></o:p></span></p>
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes'>
  ...
  _______________________ <st1:metricconverter ProductID="2009 г" w:st="on">2009
  ...
  <p class=MsoNormal style='text-align:justify'><span style='font-size:10.0pt'>«______»
  ___________________ <st1:metricconverter ProductID="2009 г" w:st="on">2009 г</st1:metricconverter>.<o:p></o:p></span></p>
  </td>
 </tr>
</table>
