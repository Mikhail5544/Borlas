...
<title>Письмо об отказе в страховании (без мед. обследования)</title>
<style>
<!--
 /* Font Definitions */
 @font-face
...
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'>К сожалению, вынуждены сообщить 
Вам, что, основываясь на проведенной нами процедуре оценки степени страхового риска 
(изучения предоставленной Вами в Заявлении на страхование информации), мы вынуждены 
были принять решение об отказе от дальнейшего страхования по Вашему договору. 
О возможности принятия компанией отрицательного решения и отказе от дальнейшего 
страхования  по результатам оценки степени страхового риска Вы были предупреждены 
в заполненном Вами Заявлении на страхование. Настоящим письмом уведомляем Вас, что 
договор страхования, заключенный на основании Вашего Заявления на страхование 
№ <rw:field id="f_num" src="num"/>, прекращает свое действие с 
<i><rw:field id="f_decline_date" src="decline_date"/></i>.</span></p>

<p class=MsoBodyText style='margin-top:4.0pt;line-height:150%'><span
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'>Компания приносит
Вам свои извинения, и если Вы заинтересованы в получении информации о других
видах страхования, которые предлагает наша Компания, просим Вас связаться с
нами либо, с Вашим страховым консультантом.</span></p>

<%if (!ret_sum.equals("0"))
{%>
<p class=MsoBodyText style='margin-top:4.0pt;line-height:150%'><span
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'>Сумма 
уплаченной Вами страховой премии будет возвращена
на указанный Вами в Заявлении на страхование расчетный счет. Если по
каким-то причинам Вы не указали в Заявлении необходимые данные или произошло
изменение этих данных, просим Вас
направить в адрес нашей Компании письмо с указанием реквизитов (наименование банка, БИК, ИНН,
корр. счет, расчетный счет, лицевой счет), 
на которые необходимо произвести перечисление средств. Ваши реквизиты Вы
можете передать в Компанию через своего страхового консультанта.</span></p>
<%}%>
