    ...
    <dataSource name="Q_2">
      ...
      <![CDATA[select rownum rec_number,
       ...
       pol_ser,
	     type_contact,
	     gender,
       to_char(fee - pay_amount_dog,'999999999D99') fee
from
(select vlp.payment_period,
       vlp.contact_name,
       vlp.address_name,
  	   vlp.code,
       vlp.init_name,
       ...
       case when length(pp.pol_num)>6 then substr(pp.pol_num,1,3) else pp.pol_ser end pol_ser,
	     vlp.type_contact,
	     vlp.gender,
       case when min(vlp.mb) > 0 then vlp.sum_fee
       else
...
Вам необходимо оплатить очередной страховой взнос до <b><i><rw:field id="f_due_date" src="due_date"/></i></b>.</span></p>
...
0cm;margin-left:-1.0cm;margin-bottom:.0001pt;text-indent:1.0cm;line-height:
100%'><span style='mso-bidi-font-size:10.0pt;line-height:100%;font-family:Calibri;
mso-fareast-language:RU'>По итогам 2008 года Компания объявила индексацию по накопительным
программам в размере 12,00% .</span></p>

<p class=MsoBodyText style='margin-top:6.0pt;margin-right:0cm;margin-bottom:
0cm;margin-left:-1.0cm;margin-bottom:.0001pt;text-indent:1.0cm;line-height:
100%'><span style='mso-bidi-font-size:10.0pt;line-height:100%;font-family:Calibri;
mso-fareast-language:RU'>Таким образом индексированный страховой взнос по Вашему договору № <rw:field id="f_pol_num" src="pol_num"/>
составит <b><i><rw:field id="f_fee" src="fee"/> <rw:field id="f_fund" src="fund"/></i></b>
<% if (fund.equals("RUR") ) { %> <% } else { %> (по курсу ЦБ на дату оплаты) <% } %>. При оплате указанного страхового
взноса вступает в силу приложенное дополнительное соглашение.</span></p>
...
<p class=MsoBodyText style='text-indent:27.0pt;line-height:normal'><span style='font-size:8.0pt;
...
<p class=MsoBodyText style='margin-top:6.0pt'><span style='font-size:8.0pt;
font-family:Calibri'>Реквизиты для оплаты через прочие банки:<o:p></o:p></span></p>
<p class=MsoNormal style='text-indent:27.0pt;line-height:normal'><span style='font-size:8.0pt;
font-family:Calibri'>Получатель платежа: ООО «СК «Ренессанс
Жизнь», ИНН 7725520440, КПП 775001001, <o:p></o:p></span></p>

<p class=MsoBodyText style='text-indent:27.0pt;line-height:normal'><span style='font-size:8.0pt;
font-family:Calibri'>р/с
40701810800001410925 в АО «Райффайзенбанк» г. Москва, БИК 044525700, к/с
<o:p></o:p></span></p>
...
<p class=MsoBodyText style='text-indent:27.0pt;line-height:normal'><span style='font-size:8.0pt;
font-family:Calibri'>Получатель платежа: ООО «СК «Ренессанс
Жизнь», ИНН 7725520440, </span><span lang=EN-US style='font-size:8.0pt;
font-family:Calibri;mso-ansi-language:EN-US;font-weight:normal'>XPEJ</span><span
style='font-size:8.0pt;font-family:Calibri;font-weight:normal'> <o:p></o:p></span></p>
...
style='font-size:8.0pt;font-family:Calibri'>1. Платежной системой CONTACT. Со
...
<p class=MsoBodyText style='margin-top:6.0pt;text-align:justify;text-indent:1.0cm'><span
style='font-size:8.0pt;font-family:Calibri'>2. Отделениями банка «ВТБ24». Со
...
<p class=MsoBodyText style='margin-top:6.0pt;text-align:justify;text-indent:1.0cm'><span
style='font-size:8.0pt;font-family:Calibri'>3. Услугами
