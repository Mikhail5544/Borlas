...
beforeReportTrigger="beforereport">
  ...
  <data>
    ...
    <dataSource name="Q_CLAIM">
      <select>
      <![CDATA[ select brief from fund where brief = 'RUR']]>
      </select>
...
begin
  ...
  begin
    select start_date,
        ...
        prep,
        status_claim
into :start_date,:num,:pol,:amount,:brief,:flag,:amount_in_words,:bank,:bank_adr,:bic,:account_corr,:beneficiary,:beneficiary_adr,:inn,:account_nr,:cpp,:note,:prod,:region_code,:prep,:status_claim
from
(select start_date,
        NUM,
        pol,
 ...
 from (
   SELECT rownum rn, to_char(ph.start_date,'dd.mm.yyyy') start_date,
       ...
       prod.brief prod,
       '' region_code,
       decode(us.name,'Панферова Валерия Олеговна','Панферова В.О.',us.name) prep,
	   decode(doc.get_last_doc_status_name(ch.active_claim_id),'Урегулируется', to_char(clm.claim_status_date,'dd.mm.yyyy'),'') status_claim
...
exception
    when no_data_found then :start_date:='';:num:='';:pol:='';:amount:=0;
							:brief:='';:flag:=0;:amount_in_words:='';:bank:='';:bank_adr:='';:bic:='';
							:account_corr:='';:beneficiary:='';:beneficiary_adr:='';:inn:='';
							:account_nr:='';:cpp:='';:note:='';:prod:='';:region_code:='';:prep:='';:status_claim:='';
  end;
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:6'>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span lang=EN-US style='font-size:9.0pt;mso-ansi-language:
  EN-US'><rw:field id="" src="amount"/><o:p></o:p></span></p>
  </td>
  <td width=174 colspan=2 valign=top style='width:130.25pt;border:none;
  border-right:solid windowtext 1.0pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-left-alt:solid windowtext .5pt;mso-border-right-alt:solid windowtext .5pt;
 ...
 <tr style='mso-yfti-irow:30'>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:9.0pt'>___<o:p></o:p></span></p>
  </td>
 </tr>
