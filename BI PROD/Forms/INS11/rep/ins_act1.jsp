 ...
 beforeReportTrigger="beforereport">
  ...
  <data>
	...
	<userParameter name="POL_ID" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
	<userParameter name="POL_HEAD" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
	<userParameter name="t_asset" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
	 <userParameter name="CLAIM_ID" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
	<userParameter name="p_cover_id" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
	<userParameter name="prod_line" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
	...
	<userParameter name="pol" datatype="character" width="200"
     ...
     <dataSource name="Q_TABLE">
      ...
      <![CDATA[select peril_name,
					  ...
					  flag,
					  rate_tbl,
					  round(case when flag = 1 then (viplata / ins_amount / rec_days) * 100 else rate_day end,4) rate_day,
      ...
      <group name="G_TABLE">
		...
		<dataItem name="peril_id" oracleDatatype="number" columnOrder="41"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="peril id">
          <dataDescriptor expression="peril_id" descriptiveExpression="flag"
           order="15" oracleDatatype="number" width="22" precision="38"/>
        </dataItem>
		<dataItem name="peril_d" datatype="vchar2" columnOrder="42"
         width="4000" defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="peril d">
          <dataDescriptor expression="peril_d"
         descriptiveExpression="peril_d" order="16" width="4000"/>
		</dataItem>
	...
	<dataSource name="Q_DAM">
      <select canParse="no">
      <![CDATA[select case when tp.description like 'Телесные%' then 'п. '||c.code||' '||'-'||' '||to_char(c.limit_val)||'%'
            when tp.description like 'Хирург%' then 'п. '||c.code||' '||'-'||' '||to_char(c.limit_val)||'%'
            else to_char(d.declare_sum / (pc.ins_amount - pkg_claim.get_payed_cover_sum(d.c_claim_id,pc.p_cover_id)) * 100)||'%' end dam_code,
       c.peril,
       c.id,
       row_number() over (partition by c.peril order by pc.p_cover_id) nm
...
where ch.p_policy_id = p.policy_id
      ...
      <group name="G_DAM">
        <displayInfo x="0.04041" y="0.60620" width="1.68176" height="1.62695"/>
		<dataItem name="dam_code" datatype="vchar2" columnOrder="1"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="dam code">
          <dataDescriptor expression="dam_code"
           descriptiveExpression="dam_code" order="1" width="4000"/>
        </dataItem>
		<dataItem name="peril" oracleDatatype="number" columnOrder="2"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="peril">
          <dataDescriptor expression="peril" descriptiveExpression="peril"
           order="2" oracleDatatype="number" width="22" precision="38"/>
        </dataItem>
		<dataItem name="id" oracleDatatype="number" columnOrder="3"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="id">
          <dataDescriptor expression="id" descriptiveExpression="id"
           order="3" oracleDatatype="number" width="22" precision="38"/>
        </dataItem>
		<dataItem name="nm" oracleDatatype="number" columnOrder="4"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="nm">
          <dataDescriptor expression="nm" descriptiveExpression="nm"
	...
	<dataSource name="Q_TEST">
      <select canParse="no">
      <![CDATA[select to_char(pol.pol_header_id) val
             from p_policy pol
      ...
      <group name="G_TEST">
	  <displayInfo x="0.04041" y="0.60620" width="1.68176" height="1.62695"/>
	  <dataItem name="val" datatype="vchar2" columnOrder="1"
         width="4000" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="val">
          <dataDescriptor expression="val"
           descriptiveExpression="val" order="1" width="4000"/>
      </dataItem>
	  <formula name="CF_DATE_LIST" source="cf_date"
         datatype="character" width="5000" precision="10" defaultWidth="1000000"
         defaultHeight="100000" columnFlags="16" defaultLabel="CF DATE LIST"
         breakOrder="none">
          <displayInfo x="0.00000" y="0.00000" width="0.00000"
           height="0.00000"/>
       </formula>
	...
	<link name="L_1" parentGroup="G_TABLE" parentColumn="peril_id"
     childQuery="Q_DAM" childColumn="peril" condition="eq"
     sqlClause="where"/>
  </data>
  <programUnits>
...
declare
  ...
  begin
    ...
    select v.as_asset_id,v.p_cover_id
	into :t_asset, :p_cover_id
	...
	into :prod_line
	from p_cover pc
	where pc.p_cover_id = :p_cover_id;
	  
    select a.p_policy_id
	into :POL_ID
    from as_asset a
    where a.as_asset_id = :t_asset
		  and rownum = 1;

    select h.p_policy_id
	into :POL_ID
	from c_claim_header h 
	where h.c_event_id = :EVENT_ID 
		  and rownum = 1;
	...
	select to_char(pc.end_date,'DD.MM.YYYY')
	into :end_date
	from p_pol_header ph,
     	 as_asset a,
     	 p_cover pc
	where ph.policy_header_id = :POL_HEAD
      	  and ph.policy_id = a.p_policy_id
      	  and a.as_asset_id = pc.as_asset_id
      	  and pc.t_prod_line_option_id = :prod_line
		  and rownum = 1;
  ...
  begin
	select num,pol,prod,case brief when 'RUR' then 'рубль РФ' else brief end brief,
		   start_date,beneficiary,holder,vigod,agent,event_date,status_claim, pol_vipl
	into :num, :pol,:prod,:brief,:start_date,:beneficiary,:holder,:vigod,:agent,:event_date,:status_claim,:pol_vipl
	from temp_tmptable_event
	where peril <> 1;
	exception
      when no_data_found then :num:=''; :pol:='';:prod:='';:brief:='';
	  						  :start_date:='';:beneficiary:='';:holder:='';
  ...
  return (TRUE);
	...
	<function name="cf_date" returnType="character">
      <textSource>
      <![CDATA[function CF_DATE return Char is
buf varchar2(1000);
begin

for rec in (select to_char(pay.due_date,'dd.mm.yyyy') val
        from doc_doc dd,
             document doc,
             ac_payment pay,
             doc_status st,
        ...
        where dd.parent_id = pol.policy_id
              --and pol.policy_id = :POL_ID
			  and pol.pol_header_id = :POL_HEAD
              ...
              and st.start_date = (SELECT MAX(dss.start_date)
                                  FROM DOC_STATUS dss
                                  WHERE dss.document_id = doc.document_id)) 
    LOOP
        buf:= buf ||' '|| rec.val;
    END LOOP;
    buf := rtrim(buf,', ');
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:6'>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt'><b><% if (fl.equals("1")) {%> <rw:field id="" src="vigod"/> <%} else {%> <%} %>
  </b><o:p></o:p></span></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:18'>
  ...
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt'><b><rw:field id="" src="peril_d"/></b>
  <rw:field id="" src="DIAGNOSE"/> <b><rw:field id="" src="CF_end_date"/></b><o:p></o:p></span></p>
  </td>
 </tr>
 </rw:foreach>
 ...
 <tr style='mso-yfti-irow:20'>
  <td width=600 colspan=16 valign=top style='width:600pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#99CC00;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
 ...
 <tr style='mso-yfti-irow:21'>
  <td width=30 valign=top style='width:30pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt'>
  ...
  <td width=75 colspan=2 valign=top style='width:75pt;border-top:none;border-left:
  ...
  <td width=30 valign=top style='width:30pt;border-top:none;border-left:none;
  ...
  <td width=75 colspan=2 valign=top style='width:75pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  ...
  <td width=15 valign=top style='width:15pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  ...
  <td width=15 valign=top style='width:15pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><span style='font-size:5.0pt'>Количество дней<o:p></o:p></span></p>
  </td>
  <td width=85 colspan=2 valign=top style='width:85pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center'><span style='font-size:5.0pt'>Сумма задолженности за
  <rw:foreach id="tbl9" src="G_TEST"><rw:field id="" src="CF_DATE_LIST"/></rw:foreach>
  <o:p></o:p></span></p>
  </td>
  <td width=75 colspan=2 valign=top style='width:75pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
