...
<userParameter name="NOTICE_NUM" datatype="character" width="100"
    ...
    <userParameter name="PA_KOD_VAL_OLD" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
    <userParameter name="UNDER_NOTE" datatype="character" width="1000"
...
<p class=MsoNormal style='text-align:justify'><%=format.format(NUM_PP++)%>. Стороны договорились п. 4
Договора изложить в следующей редакции:</p>
...
Договора, Правилами страхования.<o:p></o:p></span></p>
