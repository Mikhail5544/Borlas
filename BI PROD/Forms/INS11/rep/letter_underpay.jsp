...
<title>Письмо о недоплате</title>
<style>
<!--
 /* Font Definitions */
 @font-face
...
(ая) <rw:field id="f_contact_name" src="contact_name"/>!</i></b></p>
...
Вас, что на счет ООО «СК «Ренессанс Жизнь» в качестве оплаты очередного страхового
взноса по договору № <rw:field id="f_pol_num" src="pol_num"/>
поступили денежные средства в сумме <i><rw:field id="f_pay_amount" src="pay_amount"/></i> рублей,
в то время как сумма страхового взноса,
которая должна была быть Вами оплачена, составляет <i><rw:field id="f_amount" src="amount"/></i> рублей.</span></p>

<p class=MsoBodyText style='margin-top:4.0pt;line-height:150%'><span
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'>Просим Вас для продолжения действия Вашего
договора страхования в соответствии с Общими условиями страхования, на
основании которых заключен договор страхования и которые Вы получили, в течение
действия льготного периода оплатить имеющуюся задолженность в размере <i><rw:field id="f_underpay" src="underpay"/></i>
рублей. Оплата должна поступить на наш расчетный счет не позднее даты окончания
льготного периода. Действие льготного периода истекает <i><rw:field id="f_grace_period" src="grace_period"/></i>.</span></p>

<p class=MsoBodyText style='margin-top:4.0pt;line-height:150%'><span
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'>Напоминаем
Вам о том, что погашение задолженности по оплате страхового взноса необходимо
произвести не позднее окончания льготного периода, в противном случае договор
страхования, обеспечивающий финансовую защиту для Вас и Ваших близких, будет
расторгнут.</span></p>
...
<p class=MsoBodyText style='margin-top:4.0pt;line-height:150%'><span
style='font-size:12.0pt;line-height:150%;mso-fareast-language:RU'>В случае, если
доплата по Вашему страховому взносу была произведена, мы благодарим Вас за
сотрудничество и просим не принимать во внимание настоящее письмо.</span></p>
