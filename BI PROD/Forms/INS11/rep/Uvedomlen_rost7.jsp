...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=638
 ...
 <tr style='mso-yfti-irow:4;height:42.15pt'>
  ...
  height:42.15pt'>
  <p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><b><span
  style='font-size:11.0pt;font-family:Arial;color:black'>Адрес по прописке</span></b><b><span
  lang=EN-US style='font-size:11.0pt;font-family:Arial;color:black;mso-ansi-language:
  EN-US'>: <rw:field id="" src="ADDR"></rw:field> </span></b><a name="addr_person"></a><span lang=EN-US
 ...
 <tr style='mso-yfti-irow:18;height:104.3pt'>
  ...
  ограниченной ответственностью &quot;СК &quot;Ренессанс Жизнь&quot;, именуемое
  в дальнейшем СТРАХОВЩИК, в лице г-на Смышляева Юрия Олеговича, действующего
  на основании Доверенности № 2005/02/17, выданной 15 ноября 2005 года,
  уведомляет Вас о том, что, в соответствии с п.12 Агентского Договора № <a
  name=treaty><rw:field id="" src="NUM"></rw:field></a>, Агентский Договор № <a name=treaty1><rw:field id="" src="NUM"></rw:field></a>,
  заключенный между ООО &quot;СК &quot;Ренессанс Жизнь&quot; и <a
  name="agent_name1"><b style='mso-bidi-font-weight:normal'><rw:field id="" src="AGENT_NAME"></rw:field></b></a>,
  считается расторгнутым с <a name="date_end"><b style='mso-bidi-font-weight:
  normal'><rw:field id="" src="DAT_R" formatMask="DD.MM.YYYY"></rw:field></b></a>. Обязательства Сторон по настоящему
  Договору прекращаются с <a name="date_end1"><b style='mso-bidi-font-weight:
  normal'><rw:field id="" src="DAT_R" formatMask="DD.MM.YYYY"></rw:field></b></a>.<o:p></o:p></span></p>
  </td>
 </tr>
