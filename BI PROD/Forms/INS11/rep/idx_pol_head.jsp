...
<report name="idx_pol_head" DTDVersion="9.0.2.0.10"
 beforeReportTrigger="beforereport">
  <xmlSettings xmlTag="Idx_Pol_Head" xmlPrologType="text">
  <![CDATA[<?xml version="1.0" encoding="&Encoding"?>]]>
  </xmlSettings>
  <data>
	<userParameter name="POL_HEADER_ID" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
	<userParameter name="PV_CNT" datatype="number" precision="10"
     defaultWidth="0" defaultHeight="0"/>
	<userParameter name="PVI_CNT" datatype="number" precision="10"
     defaultWidth="0" defaultHeight="0"/>
	<userParameter name="POL_ID" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
    <dataSource name="Q_1">
      <select>
      <![CDATA[select t2_1, t2_2, t2_3, t2_4, t2_5, policy_header_id
from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t2_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t2_2, -- годовщина
...
where pp.pol_header_id = ph.policy_header_id
  ...
  and ph.policy_header_id = :POL_HEADER_ID
...
and t2_1 < 44]]>
	...
	<dataSource name="QU_1">
      <select>
      <![CDATA[select t22_1, t22_2, t22_3, t22_4, t22_5
from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t22_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t22_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t22_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t22_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t22_5 -- выкупная сумма
, ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t22_1 >= 44 and t22_1 < 87]]>
      </select>
      <displayInfo x="3.93750" y="0.42725" width="0.69995" height="0.32983"/>
      <group name="GU_2">
        <dataItem name="t22_1" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T22 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T22_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t22_2" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T22 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T22_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t22_3" datatype="vchar2" columnOrder="15"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T22 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T22_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t22_4" datatype="vchar2" columnOrder="16"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T22 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T22_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t22_5" datatype="vchar2" columnOrder="17" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T22 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T22_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
	<dataSource name="QU_2">
      <select>
      <![CDATA[select t23_1, t23_2, t23_3, t23_4, t23_5
from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t23_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t23_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t23_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t23_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t23_5 -- выкупная сумма
, ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t23_1 >= 87 and t23_1 < 130]]>
      </select>
      <displayInfo x="3.93750" y="0.42725" width="0.69995" height="0.32983"/>
      <group name="GU_3">
        <dataItem name="t23_1" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T23 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T23_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t23_2" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T23 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T23_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t23_3" datatype="vchar2" columnOrder="15"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T23 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T23_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t23_4" datatype="vchar2" columnOrder="16"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T23 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T23_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t23_5" datatype="vchar2" columnOrder="17" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T23 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T23_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
		<dataSource name="QU_3">
      <select>
      <![CDATA[select t24_1, t24_2, t24_3, t24_4, t24_5
from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t24_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t24_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t24_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t24_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t24_5 -- выкупная сумма
, ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t24_1 >= 130 and t24_1 < 173]]>
      </select>
      <displayInfo x="3.93750" y="0.42725" width="0.69995" height="0.32983"/>
      <group name="GU_4">
        <dataItem name="t24_1" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T24 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T24_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t24_2" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T24 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T24_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t24_3" datatype="vchar2" columnOrder="15"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T24 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T24_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t24_4" datatype="vchar2" columnOrder="16"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T24 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T24_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t24_5" datatype="vchar2" columnOrder="17" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T24 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T24_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
<dataSource name="QU_4">
      <select>
      <![CDATA[select t25_1, t25_2, t25_3, t25_4, t25_5
from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t25_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t25_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t25_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t25_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t25_5 -- выкупная сумма
, ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t25_1 >= 173 and t25_1 < 216]]>
      </select>
      <displayInfo x="3.93750" y="0.42725" width="0.69995" height="0.32983"/>
      <group name="GU_5">
        <dataItem name="t25_1" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T25 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T25_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t25_2" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T25 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T25_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t25_3" datatype="vchar2" columnOrder="15"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T25 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T25_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t25_4" datatype="vchar2" columnOrder="16"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T25 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T25_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t25_5" datatype="vchar2" columnOrder="17" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T25 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T25_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
<dataSource name="QU_5">
      <select>
      <![CDATA[select t26_1, t26_2, t26_3, t26_4, t26_5
from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t26_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t26_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t26_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t26_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t26_5 -- выкупная сумма
, ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t26_1 >= 216 and t26_1 < 259]]>
      </select>
      <displayInfo x="3.93750" y="0.42725" width="0.69995" height="0.32983"/>
      <group name="GU_6">
        <dataItem name="t26_1" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T26 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T26_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t26_2" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T26 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T26_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t26_3" datatype="vchar2" columnOrder="15"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T26 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T26_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t26_4" datatype="vchar2" columnOrder="16"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T26 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T26_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t26_5" datatype="vchar2" columnOrder="17" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T26 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T26_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
<dataSource name="QU_6">
      <select>
      <![CDATA[select t27_1, t27_2, t27_3, t27_4, t27_5
from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t27_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t27_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t27_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t27_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t27_5 -- выкупная сумма
, ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t27_1 >= 259 and t27_1 < 302]]>
      </select>
      <displayInfo x="3.93750" y="0.42725" width="0.69995" height="0.32983"/>
      <group name="GU_7">
        <dataItem name="t27_1" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T27 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T27_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t27_2" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T27 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T27_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t27_3" datatype="vchar2" columnOrder="15"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T27 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T27_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t27_4" datatype="vchar2" columnOrder="16"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T27 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T27_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t27_5" datatype="vchar2" columnOrder="17" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T27 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T27_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
<dataSource name="QU_7">
      <select>
      <![CDATA[select t28_1, t28_2, t28_3, t28_4, t28_5
from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t28_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t28_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t28_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t28_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t28_5 -- выкупная сумма
, ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t28_1 >= 302 and t28_1 < 345]]>
      </select>
      <displayInfo x="3.93750" y="0.42725" width="0.69995" height="0.32983"/>
      <group name="GU_8">
        <dataItem name="t28_1" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T28 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T28_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t28_2" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T28 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T28_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t28_3" datatype="vchar2" columnOrder="15"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T28 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T28_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t28_4" datatype="vchar2" columnOrder="16"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T28 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T28_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t28_5" datatype="vchar2" columnOrder="17" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T28 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T28_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
...
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t3_2, -- годовщина
...
and t3_1 < 44]]>
	...
	<dataSource name="QI_3">
      <select>
      <![CDATA[select t13_1, t13_2, t13_3, t13_4, t13_5 from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t13_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t13_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t13_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t13_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t13_5 -- выкупная сумма
,ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t13_1 >= 44 and t13_1 < 87 ]]>
      </select>
      <displayInfo x="5.70825" y="0.38538" width="0.69995" height="0.32983"/>
      <group name="GI_4">
        <displayInfo x="5.74805" y="1.30420" width="1.09998" height="1.11426"
        />
        <dataItem name="t13_1" oracleDatatype="number" columnOrder="19"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T13 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T13_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t13_2" oracleDatatype="number" columnOrder="20"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T13 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T13_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t13_3" datatype="vchar2" columnOrder="21"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T13 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T13_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t13_4" datatype="vchar2" columnOrder="22"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T13 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T13_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t13_5" datatype="vchar2" columnOrder="23" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T13 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T13_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
	<dataSource name="QI_4">
      <select>
      <![CDATA[select t123_1, t123_2, t123_3, t123_4, t123_5 from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t123_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t123_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t123_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t123_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t123_5 -- выкупная сумма
,ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t123_1 >= 87 and t123_1 < 130 ]]>
      </select>
      <displayInfo x="5.70825" y="0.38538" width="0.69995" height="0.32983"/>
      <group name="GI_5">
        <displayInfo x="5.74805" y="1.30420" width="1.09998" height="1.11426"
        />
        <dataItem name="t123_1" oracleDatatype="number" columnOrder="19"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T123 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T123_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t123_2" oracleDatatype="number" columnOrder="20"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T123 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T123_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t123_3" datatype="vchar2" columnOrder="21"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T123 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T123_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t123_4" datatype="vchar2" columnOrder="22"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T123 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T123_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t123_5" datatype="vchar2" columnOrder="23" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T123 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T123_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
<dataSource name="QI_5">
      <select>
      <![CDATA[select t133_1, t133_2, t133_3, t133_4, t133_5 from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t133_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t133_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t133_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t133_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t133_5 -- выкупная сумма
,ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t133_1 >= 130 and t133_1 < 173 ]]>
      </select>
      <displayInfo x="5.70825" y="0.38538" width="0.69995" height="0.32983"/>
      <group name="GI_6">
        <displayInfo x="5.74805" y="1.30420" width="1.09998" height="1.11426"
        />
        <dataItem name="t133_1" oracleDatatype="number" columnOrder="19"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T133 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T133_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t133_2" oracleDatatype="number" columnOrder="20"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T133 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T133_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t133_3" datatype="vchar2" columnOrder="21"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T133 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T133_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t133_4" datatype="vchar2" columnOrder="22"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T133 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T133_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t133_5" datatype="vchar2" columnOrder="23" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T133 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T133_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
<dataSource name="QI_6">
      <select>
      <![CDATA[select t134_1, t134_2, t134_3, t134_4, t134_5 from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t134_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t134_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t134_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t134_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t134_5 -- выкупная сумма
,ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t134_1 >= 173 and t134_1 < 216 ]]>
      </select>
      <displayInfo x="5.70825" y="0.38538" width="0.69995" height="0.32983"/>
      <group name="GI_7">
        <displayInfo x="5.74805" y="1.30420" width="1.09998" height="1.11426"
        />
        <dataItem name="t134_1" oracleDatatype="number" columnOrder="19"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T134 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T134_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t134_2" oracleDatatype="number" columnOrder="20"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T134 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T134_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t134_3" datatype="vchar2" columnOrder="21"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T134 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T134_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t134_4" datatype="vchar2" columnOrder="22"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T134 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T134_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t134_5" datatype="vchar2" columnOrder="23" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T134 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T134_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
<dataSource name="QI_7">
      <select>
      <![CDATA[select t135_1, t135_2, t135_3, t135_4, t135_5 from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t135_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t135_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t135_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t135_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t135_5 -- выкупная сумма
,ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t135_1 >= 216 and t135_1 < 259 ]]>
      </select>
      <displayInfo x="5.70825" y="0.38538" width="0.69995" height="0.32983"/>
      <group name="GI_8">
        <displayInfo x="5.74805" y="1.30420" width="1.09998" height="1.11426"
        />
        <dataItem name="t135_1" oracleDatatype="number" columnOrder="19"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T135 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T135_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t135_2" oracleDatatype="number" columnOrder="20"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T135 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T135_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t135_3" datatype="vchar2" columnOrder="21"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T135 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T135_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t135_4" datatype="vchar2" columnOrder="22"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T135 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T135_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t135_5" datatype="vchar2" columnOrder="23" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T135 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T135_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
<dataSource name="QI_8">
      <select>
      <![CDATA[select t136_1, t136_2, t136_3, t136_4, t136_5 from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t136_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t136_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t136_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t136_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t136_5 -- выкупная сумма
,ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t136_1 >= 259 and t136_1 < 302 ]]>
      </select>
      <displayInfo x="5.70825" y="0.38538" width="0.69995" height="0.32983"/>
      <group name="GI_9">
        <displayInfo x="5.74805" y="1.30420" width="1.09998" height="1.11426"
        />
        <dataItem name="t136_1" oracleDatatype="number" columnOrder="19"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T136 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T136_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t136_2" oracleDatatype="number" columnOrder="20"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T136 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T136_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t136_3" datatype="vchar2" columnOrder="21"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T136 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T136_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t136_4" datatype="vchar2" columnOrder="22"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T136 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T136_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t136_5" datatype="vchar2" columnOrder="23" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T136 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T136_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
<dataSource name="QI_9">
      <select>
      <![CDATA[select t137_1, t137_2, t137_3, t137_4, t137_5 from (select
row_number() over (partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE) t137_1, -- номер периода
MONTHS_BETWEEN(cs.insurance_year_date,ph.start_date) / 12 + 1/*cs.INSURANCE_YEAR_NUMBER*/ t137_2, -- годовщина
to_char(cs.START_CASH_SURR_DATE,'dd.mm.yyyy') t137_3, -- начало периода
to_char(cs.END_CASH_SURR_DATE,'dd.mm.yyyy') t137_4, -- окончание
to_char(cs.VALUE, 'FM999G999G990D00','NLS_NUMERIC_CHARACTERS = '', ''') t137_5 -- выкупная сумма
,ph.policy_header_id, cs.START_CASH_SURR_DATE, pp.START_DATE 
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
...
order by cs.INSURANCE_YEAR_NUMBER, cs.START_CASH_SURR_DATE) temp
where temp.START_CASH_SURR_DATE >= temp.START_DATE
and t137_1 >= 302 and t137_1 < 345 ]]>
      </select>
      <displayInfo x="5.70825" y="0.38538" width="0.69995" height="0.32983"/>
      <group name="GI_10">
        <displayInfo x="5.74805" y="1.30420" width="1.09998" height="1.11426"
        />
        <dataItem name="t137_1" oracleDatatype="number" columnOrder="19"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T137 1">
          <dataDescriptor
           expression="row_number ( ) over ( partition by cs.POLICY_CASH_SURR_ID order by START_CASH_SURR_DATE )"
           descriptiveExpression="T137_1" order="1" oracleDatatype="number"
           width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t137_2" oracleDatatype="number" columnOrder="20"
         width="22" defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T137 2">
          <dataDescriptor expression="cs.INSURANCE_YEAR_NUMBER"
           descriptiveExpression="T137_2" order="2" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t137_3" datatype="vchar2" columnOrder="21"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T137 3">
          <dataDescriptor
           expression="to_char ( cs.START_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T137_3" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t137_4" datatype="vchar2" columnOrder="22"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T137 4">
          <dataDescriptor
           expression="to_char ( cs.END_CASH_SURR_DATE , &apos;dd.mm.yyyy&apos; )"
           descriptiveExpression="T137_4" order="4" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="t137_5" datatype="vchar2" columnOrder="23" width="15"
         defaultWidth="20000" defaultHeight="10000" columnFlags="1"
         defaultLabel="T137 5">
          <dataDescriptor
           expression="to_char ( cs.VALUE , &apos;FM999G999G990D00&apos; , &apos;NLS_NUMERIC_CHARACTERS = &apos;&apos;, &apos;&apos;&apos; )"
           descriptiveExpression="T137_5" order="5" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    ...
    <dataSource name="Q_0">
      <select>
      <![CDATA[    select ph.policy_header_id ID, decode(nvl(max(pp.MAILING),0),0,'B',1,'B') FLAG,
    ...
    where pp.pol_header_id = ph.policy_header_id
	  ...
	  and doc.get_doc_status_name(i.policy_index_item_id) = 'Индексация'
...
select pp.num P_2,
       ...
       decode(tc.description,'Физическое лицо',PKG_CONTACT.GET_FIO_FMT(PKG_CONTACT.GET_FIO_CASE(PKG_POLICY.GET_POLICY_HOLDER_ID(pp.policy_id), 'И'),4),
	   			PKG_CONTACT.GET_FIO_CASE(PKG_POLICY.GET_POLICY_HOLDER_ID(pp.policy_id), 'И') ) P_6,
...
where pp.pol_header_id = ph.policy_header_id
  ...
  and cpol.contact_id = PKG_POLICY.GET_POLICY_HOLDER_ID(pp.policy_id)
...
select CASE WHEN fld_cnt < 44 THEN 0
			WHEN fld_cnt >= 44 AND fld_cnt < 87 THEN 1
			WHEN fld_cnt >= 87 AND fld_cnt < 130 THEN 2
			WHEN fld_cnt >= 130 AND fld_cnt < 173 THEN 3
			WHEN fld_cnt >= 173 AND fld_cnt < 216 THEN 4
			WHEN fld_cnt >= 216 AND fld_cnt < 259 THEN 5
			WHEN fld_cnt >= 259 AND fld_cnt < 302 THEN 6
			WHEN fld_cnt >= 302 AND fld_cnt < 345 THEN 7
	   ELSE 0
	   END
into :PV_CNT
from
(
select count(*) fld_cnt
from VEN_P_POL_HEADER ph,
     VEN_P_POLICY pp,
     VEN_POLICY_CASH_SURR pcs, 
     VEN_POLICY_CASH_SURR_D cs,
...
style='font-size:16.0pt'>Дополнительное соглашение
<rw:field id="" src="P_01">P_01</rw:field>
</span></p>

<p class=MsoNormal align=center style='text-align:center'><span
style='font-size:16.0pt'>(об условиях индексации)</span></p>
...
основании Доверенности № 2011/01 от 01.01.2011 г., с одной стороны, и
...
1.&nbsp;&nbsp;&nbsp;Стороны договорились дополнить п. 8 Договора
«Дополнительные условия» «Положением об индексации» следующего содержания:</p>
...
tab-stops:list 18.0pt'>1)&nbsp;&nbsp;Настоящее Положение регулирует порядок проведения
Страховщиком индексации по Договорам индивидуального страхования, то есть
порядок увеличения размера страховых взносов и, соответственно, страховых сумм,
...
<p class=MsoBodyText style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:18.0pt;margin-bottom:.0001pt;text-align:justify;text-indent:-18.0pt;tab-stops:list 18.0pt'>
2)&nbsp;&nbsp;В целях проведения индексации, Страховщик ежегодно
...
</span>коэффициента индексации Страховщик производит расчет увеличенного
страхового взноса путем умножения коэффициента индексации на размер
действующего страхового взноса по основной программе.<span
style='mso-spacerun:yes'>  </span>Размер увеличенной страховой суммы по
основной программе рассчитывается исходя из размера проиндексированного
страхового взноса по основной программе и оставшегося срока действия договора.
Страховые суммы по дополнительным программам увеличиваются в соотношении,
аналогичном увеличению страховой суммы по основной программе. При проведении
первой индексации коэффициент индексации применяется к страховому взносу по
основной программе, указанному в договоре страхования. При проведении каждой
последующей индексации коэффициент индексации применяется к предыдущим
проиндексированным величинам (страховому взносу и страховой сумме).</p>
...
<p class=MsoBodyText style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:18.0pt;margin-bottom:.0001pt;text-align:justify;text-indent:-18.0pt;
tab-stops:list 18.0pt'>3)&nbsp;&nbsp;Страховщик предлагает Страхователю проиндексировать
...
<p class=MsoBodyText style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:18.0pt;margin-bottom:.0001pt;text-align:justify;text-indent:-18.0pt;
tab-stops:list 18.0pt'>4)&nbsp;&nbsp;О возможности проиндексировать страховые суммы и
...
изменения в договор страхования в части страховых сумм и страховых взносов.
...
взноса в дату<span style='mso-spacerun:yes'>  </span>оплаты очередного страхового
взноса, приходящуюся на страховую годовщину, следующую за датой проведения
индексации. </p>
...
<p class=MsoBodyText style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:18.0pt;margin-bottom:.0001pt;text-align:justify;text-indent:-18.0pt;
tab-stops:list 18.0pt'>5)&nbsp;&nbsp;Страхователь вправе отказаться от проведения индексации
...
<p class=MsoBodyText style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:18.0pt;margin-bottom:.0001pt;text-align:justify;text-indent:-18.0pt;
tab-stops:list 18.0pt'>6)&nbsp;&nbsp;В случае отказа Страхователя от проведения индексации в
...
<p class=MsoBodyText style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:18.0pt;margin-bottom:.0001pt;text-align:justify;text-indent:-18.0pt;
tab-stops:list 18.0pt'>7)&nbsp;&nbsp;Право на индексацию может быть восстановлено по просьбе
Страхователя и с согласия Страховщика.<span style='mso-spacerun:yes'>  </span>Решение
о возможности восстановлении права на индексацию принимается Страховщиком на
основе проведения дополнительной оценки страхового риска. Для оценки страхового
риска Страховщик имеет право запросить у Страхователя/Застрахованного всю
необходимую ему информацию, в том числе сведения о состоянии здоровья, опасных
видах деятельности (работа, хобби), доходах и финансовых обязательствах
Застрахованного, а также потребовать прохождения Застрахованным медицинского
обследования в необходимом для Страховщика объеме и в указанном Страховщиком
лечебном учреждении.</p>
...
<p class=MsoBodyText style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:18.0pt;margin-bottom:.0001pt;text-align:justify;text-indent:-18.0pt;
tab-stops:list 18.0pt'>8)&nbsp;&nbsp;При наступлении страховых случаев по дополнительным
...
0cm;margin-left:17.85pt;margin-bottom:.0001pt;text-indent:0cm;tab-stops:35.4pt list 78.55pt'><span
style='font-size:12.0pt;color:windowtext;mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></p>

<p class=MsoBodyText style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;
margin-left:18.0pt;margin-bottom:.0001pt;text-align:justify;text-indent:-18.0pt;
tab-stops:list 18.0pt'>9)&nbsp;&nbsp;Если по договору страхования, по
которому Страхователю направлено предложение об индексации, но до даты оплаты
очередного страхового взноса, приходящегося на страховую годовщину,<span
style='mso-spacerun:yes'>  </span>или в течение льготного периода для оплаты
указанного взноса наступит событие, обладающее признаками страхового случая, то
дополнительное соглашение об изменении условий договора не вступает в силу и
Страховщик при признании наступившего события страховым случаем производит
страховую выплату исходя</span></span><span style='font-size:12.0pt;color:windowtext;
mso-ansi-language:RU'> из условий действующего договора страхования.<o:p></o:p></span></p>
...
2.</span>&nbsp;&nbsp;&nbsp;Стороны договорились п. 4 Договора изложить в следующей редакции: </p>
...
соглашение
<rw:field id="" src="P_01">P_01</rw:field><o:p></o:p></span></em></p>
...
Доверенности № 2011/01 от 01.01.2011 г., с одной стороны, и
...
style='font-style:normal;mso-bidi-font-style:italic'>договорились</span></em>
п. 3 Договора изложить в следующей редакции:</p>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=657
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  ...
  <td width=281 colspan=4 valign=top style='width:210.45pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal style='margin-right:-.25pt;text-align:justify'><o:p>&nbsp;</o:p></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1;height:6.95pt'>
 <td width=376 colspan=8 valign=top style='width:282.3pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal style='margin-right:-.25pt'><rw:field id="" src="P_6">P_6</rw:field></p>
  </td>
  <td width=281 colspan=4 valign=top style='width:210.45pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal style='margin-right:-.25pt;text-align:justify'><o:p>_______________ /</o:p></p>
  </td>
 </tr>
 <![if !supportMisalignedColumns]>
 <tr height=0>
...
<p class=MsoNormal>3.&nbsp;&nbsp;&nbsp;Стороны договорились Приложение № 1<span
style='color:blue'> </span>Договора изложить в следующей редакции:</p>
...
/*****************************************************/
-->
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 style='width:234.6pt;border-collapse:collapse;border:none;mso-border-alt:solid windowtext .5pt;
 mso-yfti-tbllook:480;mso-padding-alt:0cm 5.4pt 0cm 5.4pt;mso-border-insideh:
 .5pt solid windowtext;mso-border-insidev:.5pt solid windowtext'>
 <thead>
  <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
   ...
   mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
   <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><b
   style='mso-bidi-font-weight:normal'><span style='font-size:7.0pt'>НОМЕР
   ПЕРИОДА</span></b><b style='mso-bidi-font-weight:normal'><span
   style='font-size:7.0pt;mso-fareast-language:EN-US'><o:p></o:p></span></b></p>
   </td>
   <td width=132 valign=top style='width:99.0pt;border:solid windowtext 1.0pt;
   border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
   solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
   <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><b
   style='mso-bidi-font-weight:normal'><span style='font-size:7.0pt'>ГОД
   ДЕЙСТВИЯ ДОГОВОРА</span></b><b style='mso-bidi-font-weight:normal'><span
   style='font-size:7.0pt;mso-fareast-language:EN-US'><o:p></o:p></span></b></p>
   </td>
   <td width=100 valign=top style='width:70.35pt;border:solid windowtext 1.0pt;
   border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
   solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
   <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><b
   style='mso-bidi-font-weight:normal'><span style='font-size:7.0pt'>НАЧАЛО</span></b><b
   style='mso-bidi-font-weight:normal'><span style='font-size:7.0pt;mso-fareast-language:
   EN-US'><o:p></o:p></span></b></p>
   </td>
   <td width=100 valign=top style='width:70.35pt;border:solid windowtext 1.0pt;
   border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
   solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
   <p class=MsoNormal align=center style='margin-right:4.55pt;text-align:center'><b
   style='mso-bidi-font-weight:normal'><span style='font-size:7.0pt'>ОКОНЧАНИЕ</span></b><b
   style='mso-bidi-font-weight:normal'><span style='font-size:7.0pt;mso-fareast-language:
   EN-US'><o:p></o:p></span></b></p>
   </td>
   <td width=150 valign=top style='width:110.0pt;border:solid windowtext 1.0pt;
   border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
   solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
   ...
   style='font-size:7.0pt'>ВЫКУПНАЯ СУММА, РУБ.</span></b></a><span
   style='mso-bookmark:currency_3'><b style='mso-bidi-font-weight:normal'><span
   style='font-size:7.0pt;mso-fareast-language:EN-US'><o:p></o:p></span></b></span></p>
   </td>
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  ...
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  ...
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
...
<rw:getValue id="j_cnt" src="PV_CNT"/>
<%if ( (j_cnt.equals("1")) || (j_cnt.equals("2")) || (j_cnt.equals("3")) || (j_cnt.equals("4")) || (j_cnt.equals("5")) || (j_cnt.equals("6")) || (j_cnt.equals("7")) )  {%>
<td VALIGN=TOP>
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 style='width:234.6pt;border-collapse:collapse;border:none;mso-border-alt:solid windowtext .5pt;
 mso-yfti-tbllook:480;mso-padding-alt:0cm 5.4pt 0cm 5.4pt;mso-border-insideh:
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T22_1">T22_1</rw:field>
  </o:p></span></p>
  </td>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T22_2">T22_2</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T22_3">T22_3</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T22_4">T22_4</rw:field>
  </o:p></span></p>
  </td>
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal><span style='mso-bookmark:currency_3'><span
  style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T22_5">T22_5</rw:field>
  </o:p></span></span></p>
  </td>
  <span style='mso-bookmark:currency_3'></span>
 </tr>
...
<rw:getValue id="j_tbl_2" src="PV_CNT"/>
<%if ( (j_tbl_2.equals("2")) || (j_tbl_2.equals("3")) || (j_tbl_2.equals("4")) || (j_tbl_2.equals("5")) || (j_tbl_2.equals("6")) || (j_tbl_2.equals("7")) )  {%>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T23_1">T23_1</rw:field>
  </o:p></span></p>
  </td>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T23_2">T23_2</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T23_3">T23_3</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T23_4">T23_4</rw:field>
  </o:p></span></p>
  </td>
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal><span style='mso-bookmark:currency_3'><span
  style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T23_5">T23_5</rw:field>
  </o:p></span></span></p>
  </td>
  <span style='mso-bookmark:currency_3'></span>
 </tr>
...
<rw:getValue id="j_cnt_1" src="PV_CNT"/>
<%if ( (j_cnt_1.equals("3")) || (j_cnt_1.equals("4")) || (j_cnt_1.equals("5")) || (j_cnt_1.equals("6")) || (j_cnt_1.equals("7")) )  {%>
<td VALIGN=TOP>
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 style='width:234.6pt;border-collapse:collapse;border:none;mso-border-alt:solid windowtext .5pt;
 mso-yfti-tbllook:480;mso-padding-alt:0cm 5.4pt 0cm 5.4pt;mso-border-insideh:
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T24_1">T24_1</rw:field>
  </o:p></span></p>
  </td>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T24_2">T24_2</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T24_3">T24_3</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T24_4">T24_4</rw:field>
  </o:p></span></p>
  </td>
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal><span style='mso-bookmark:currency_3'><span
  style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T24_5">T24_5</rw:field>
  </o:p></span></span></p>
  </td>
  <span style='mso-bookmark:currency_3'></span>
 </tr>
...
<rw:getValue id="j_tbl_3" src="PV_CNT"/>
<%if ( (j_tbl_3.equals("4")) || (j_tbl_3.equals("5")) || (j_tbl_3.equals("6")) || (j_tbl_3.equals("7")) )  {%>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T25_1">T25_1</rw:field>
  </o:p></span></p>
  </td>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T25_2">T25_2</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T25_3">T25_3</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T25_4">T25_4</rw:field>
  </o:p></span></p>
  </td>
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal><span style='mso-bookmark:currency_3'><span
  style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T25_5">T25_5</rw:field>
  </o:p></span></span></p>
  </td>
  <span style='mso-bookmark:currency_3'></span>
 </tr>
...
<rw:getValue id="j_cnt_3" src="PV_CNT"/>
<%if ( (j_cnt_3.equals("5")) || (j_cnt_3.equals("6")) || (j_cnt_3.equals("7")) )  {%>
<td VALIGN=TOP>
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 style='width:234.6pt;border-collapse:collapse;border:none;mso-border-alt:solid windowtext .5pt;
 mso-yfti-tbllook:480;mso-padding-alt:0cm 5.4pt 0cm 5.4pt;mso-border-insideh:
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T26_1">T26_1</rw:field>
  </o:p></span></p>
  </td>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T26_2">T26_2</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T26_3">T26_3</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T26_4">T26_4</rw:field>
  </o:p></span></p>
  </td>
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal><span style='mso-bookmark:currency_3'><span
  style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T26_5">T26_5</rw:field>
  </o:p></span></span></p>
  </td>
  <span style='mso-bookmark:currency_3'></span>
 </tr>
...
<rw:getValue id="j_tbl_4" src="PV_CNT"/>
<%if ( (j_tbl_4.equals("6")) || (j_tbl_4.equals("7")) )  {%>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T27_1">T27_1</rw:field>
  </o:p></span></p>
  </td>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T27_2">T27_2</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T27_3">T27_3</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T27_4">T27_4</rw:field>
  </o:p></span></p>
  </td>
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal><span style='mso-bookmark:currency_3'><span
  style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T27_5">T27_5</rw:field>
  </o:p></span></span></p>
  </td>
  <span style='mso-bookmark:currency_3'></span>
 </tr>
...
<rw:getValue id="j_cnt_5" src="PV_CNT"/>
<%if ( (j_cnt_5.equals("7")) )  {%>
<td VALIGN=TOP>
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 style='width:234.6pt;border-collapse:collapse;border:none;mso-border-alt:solid windowtext .5pt;
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T28_1">T28_1</rw:field>
  </o:p></span></p>
  </td>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T28_2">T28_2</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T28_3">T28_3</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T28_4">T28_4</rw:field>
  </o:p></span></p>
  </td>
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal><span style='mso-bookmark:currency_3'><span
  style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T28_5">T28_5</rw:field>
  </o:p></span></span></p>
  </td>
  <span style='mso-bookmark:currency_3'></span>
 </tr>
...
<p class=MsoNormal><span style='mso-bookmark:currency_3'>4.&nbsp;&nbsp;&nbsp;Стороны
договорились Приложение № 2<span style='color:blue'> </span>Договора изложить в
следующей редакции:</span></p>
...
<rw:getValue id="j_ci1" src="PVI_CNT"/>
<%if ( (j_ci1.equals("1")) || (j_ci1.equals("2")) || (j_ci1.equals("3")) || (j_ci1.equals("4")) || (j_ci1.equals("5")) || (j_ci1.equals("6")) || (j_ci1.equals("7")) )  {%>
<td VALIGN=TOP>
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 style='width:234.6pt;border-collapse:collapse;border:none;mso-border-alt:solid windowtext .5pt;
 mso-yfti-tbllook:480;mso-padding-alt:0cm 5.4pt 0cm 5.4pt;mso-border-insideh:
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T13_1">T13_1</rw:field>
  </o:p></span></p>
  </td>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T13_2">T13_2</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T13_3">T13_3</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T13_4">T13_4</rw:field>
  </o:p></span></p>
  </td>
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal><span style='mso-bookmark:currency_3'><span
  style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T13_5">T13_5</rw:field>
  </o:p></span></span></p>
  </td>
  <span style='mso-bookmark:currency_3'></span>
 </tr>
...
<rw:getValue id="j_ci2" src="PVI_CNT"/>
<%if ( (j_ci2.equals("2")) || (j_ci2.equals("3")) || (j_ci2.equals("4")) || (j_ci2.equals("5")) || (j_ci2.equals("6")) || (j_ci2.equals("7")) )  {%>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T123_1">T123_1</rw:field>
  </o:p></span></p>
  </td>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T123_2">T123_2</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T123_3">T123_3</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T123_4">T123_4</rw:field>
  </o:p></span></p>
  </td>
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal><span style='mso-bookmark:currency_3'><span
  style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T123_5">T123_5</rw:field>
  </o:p></span></span></p>
  </td>
  <span style='mso-bookmark:currency_3'></span>
 </tr>
...
<rw:getValue id="j_ci3" src="PVI_CNT"/>
<%if ( (j_ci3.equals("3")) || (j_ci3.equals("4")) || (j_ci3.equals("5")) || (j_ci3.equals("6")) || (j_ci3.equals("7")) )  {%>
<td VALIGN=TOP>
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=232
 style='width:234.6pt;border-collapse:collapse;border:none;mso-border-alt:solid windowtext .5pt;
 mso-yfti-tbllook:480;mso-padding-alt:0cm 5.4pt 0cm 5.4pt;mso-border-insideh:
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:11.35pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T133_1">T133_1</rw:field>
  </o:p></span></p>
  </td>
  <td width=132 style='width:99.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p align="left" class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T133_2">T133_2</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T133_3">T133_3</rw:field>
  </o:p></span></p>
  </td>
  <td nowrap width=100 style='width:70.35pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:11.35pt'>
  <p class=MsoNormal><span style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T133_4">T133_4</rw:field>
  </o:p></span></p>
  </td>
  <td width=150 style='width:110.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal><span style='mso-bookmark:currency_3'><span
  style='font-size:7.0pt'><o:p>
  <rw:field id="" src="T133_5">T133_5</rw:field>
  </o:p></span></span></p>
  </td>
  <span style='mso-bookmark:currency_3'></span>
 </tr>
...
<p class=MsoNormal style='margin-right:-.25pt;text-align:justify'><span
style='letter-spacing:-.1pt'><% if (F_2.equals("Y")) {%>5<%} else {%>4<%}%>. Во всем остальном, что не предусмотрено настоящим
Дополнительным Соглашением Стороны руководствуются положениями Договора. <o:p></o:p></span></p>

<p class=MsoNormal style='margin-right:-.25pt;text-align:justify;line-height:
12.0pt'><% if (F_2.equals("Y")) {%>6<%} else {%>5<%}%>. Настоящее Дополнительное соглашение вступает в силу с даты
...
<p class=MsoNormal><span style='letter-spacing:-.1pt'><% if (F_2.equals("Y")) {%>7<%} else {%>6<%}%>. Настоящее
...
ZH-CN'><% if (F_2.equals("Y")) {%>8<%} else {%>7<%}%>. Настоящее Дополнительное Соглашение</span> подписано в двух
