...
<report name="ag_dops_director" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="AG_DOPS_DIRECTOR" xmlPrologType="text">
 ...
 WHERE ach.ag_contract_header_id = :p_ch_id;]]>
      ...
      <group name="G_AGENT">
        <displayInfo x="1.51404" y="2.27283" width="1.81714" height="2.48145"
        />
        ...
        <dataItem name="dog_date" datatype="date" oracleDatatype="date"
         ...
         columnFlags="1" defaultLabel="Dog Date">
          <dataDescriptor expression="DOG_DATE"
           descriptiveExpression="DOG_DATE" order="7" oracleDatatype="date"
           width="9"/>
        </dataItem>
...
ORDER BY NVL (cci.issue_date, TO_DATE ('01.01.1900', 'DD.MM.YYYY')) DESC]]>
      ...
      <group name="G_AG_DOCS">
        <displayInfo x="4.03503" y="2.45007" width="1.37964" height="1.28516"
        />
   ...
   WHERE c.AG_CONTRACT_ID = :P_CONTRACT_ID
      ...
      <displayInfo x="6.20825" y="2.67712" width="0.69995" height="0.32983"/>
      <group name="G_DOPS">
        <displayInfo x="5.97778" y="3.26245" width="1.20251" height="0.77246"
        />
   ...
   WHERE vcp.contact_id = cci.contact_id
     ...
     AND UPPER (tit.brief) IN ('TRUST')   
      ...
      <displayInfo x="4.72913" y="4.38538" width="1.26245" height="0.32983"/>
      <group name="G_DIR_DOCS">
        <displayInfo x="4.95190" y="5.11658" width="1.37964" height="1.28516"
        />
...
<link rel=File-List href="<%=g_ImagesRoot%>/ag_dops_director.files/filelist.xml">
...
p.1, li.1, div.1
 ...
 /* Page Definitions */
 @page
	{mso-footnote-separator:url("<%=g_ImagesRoot%>/ag_dops_director.files/header.htm") fs;
	mso-footnote-continuation-separator:url("<%=g_ImagesRoot%>/ag_dops_director.files/header.htm") fcs;
	mso-endnote-separator:url("<%=g_ImagesRoot%>/ag_dops_director.files/header.htm") es;
	mso-endnote-continuation-separator:url("<%=g_ImagesRoot%>/ag_dops_director.files/header.htm") ecs;}
@page Section1
	{size:595.3pt 841.9pt;
	margin:.25in 56.9pt 56.9pt 56.9pt;
	mso-header-margin:0in;
	mso-footer-margin:0in;
	mso-page-numbers:1;
	mso-even-footer:url("<%=g_ImagesRoot%>/ag_dops_director.files/header.htm") ef1;
	mso-footer:url("<%=g_ImagesRoot%>/ag_dops_director.files/header.htm") f1;
	mso-paper-source:0;}
div.Section1
	{page:Section1;}
@page Section2
...
@page Section4
	{size:595.3pt 841.9pt;
	margin:56.7pt 42.5pt 56.7pt .75in;
...
RU'>ДОПОЛНИТЕЛЬНОЕ СОГЛАШЕНИЕ № <%=AGDOPSNUM%></span><span
style='mso-bookmark:alt_number'></span><o:p></o:p></b></p>
...
<p class=MsoNormal align=center style='text-align:center;tab-stops:421.65pt'><b
style='mso-bidi-font-weight:normal'><span lang=RU style='mso-ansi-language:
RU'>К АГЕНТСКОМУ ДОГОВОРУ № <%=AGDOGNUM%><span style='mso-spacerun:yes'>  </span></span><o:p></o:p></b></p>

<p class=MsoNormal align=center style='text-align:center;tab-stops:421.65pt'><b
style='mso-bidi-font-weight:normal'><span style='mso-fareast-font-family:"Arial Unicode MS"'><o:p>&nbsp;</o:p></span></b></p>
...
в дальнейшем СТРАХОВЩИК, в лице <%=G_N_OBR%> <%=CHIEF_NAME%>, действующего на основании Доверенности
№  <%=PNUM_DOC_DIR%> выданой <%=DATAV_DOC_DIR%>, с одной стороны, и<span
...
mso-ansi-language:RU'>С <%=DATE_BEGIN%> в Агентский
Договор № <%=AGDOGNUM%> вносятся следующие изменения.<o:p></o:p></span></p>
...
<p class=MsoBodyTextIndent2 align=left style='margin-left:0in;text-align:left;
text-indent:9.0pt;line-height:11.0pt;mso-line-height-rule:exactly;mso-list:
l9 level1 lfo2;tab-stops:list .25in left 42.55pt'><![if !supportLists]><span
...
Договору АГЕНТ обязуется за вознаграждение осуществлять от имени и по поручению
СТРАХОВЩИКА посредническую деятельность в области страхования с целью
заключения СТРАХОВЩИКОМ с </span><span lang=RU style='font-size:11.0pt;
...
line-height:11.0pt;mso-line-height-rule:exactly;mso-list:l3 level1 lfo3;
tab-stops:list .5in'><![if !supportLists]><span lang=RU style='font-size:11.0pt;
...
mso-line-height-rule:exactly'><span lang=RU style='font-size:11.0pt;mso-bidi-font-size:
...
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Обязанности
АГЕНТА:<o:p></o:p></span></b></p>

<p class=MsoBodyTextIndent2 style='margin-left:19.5pt;text-indent:-19.5pt;
line-height:11.0pt;mso-line-height-rule:exactly;mso-list:l8 level2 lfo1;
...
поиск клиентов для заключения со СТРАХОВЩИКОМ договоров страхования;<o:p></o:p></span></p>
...
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Оказывать
помощь страхователям в заключении договоров страхования.<o:p></o:p></span></p>
...
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Консультировать
...
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Совершать
иные действия, необходимые для заключения договоров страхования в пределах
...
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Осуществлять
расчет страховых премий по договорам страхования (полисам) в соответствии с
тарифным сборником, действующим у СТРАХОВЩИКА на момент заключения договора
...
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Выполнять
функции, обусловленные настоящим Договором, в строгом соответствии с
законодательством РФ, условиями настоящего Договора, условиями страхования и
требованиями, установленными СТРАХОВЩИКОМ.<o:p></o:p></span></p>
...
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Оформлять
документы, необходимые для заключения договоров страхования, в строгом
соответствии с документами, утвержденными СТРАХОВЩИКОМ. Соблюдать правильность
и аккуратность при заполнении бланков документов строгой отчетности (квитанций
...
СТРАХОВЩИКУ максимально полную информацию, необходимую для заключения договоров
...
бланков заявлений, полисов, переданных СТРАХОВЩИКОМ, денежных сумм, полученных
в качестве страховой премии (взносов) по заключенным АГЕНТОМ договорам
страхования, АГЕНТ обязан в течение 1 (одного) рабочего дня известить об этом
СТРАХОВЩИКА. При утрате документов строгой отчетности, номерных бланков
заявлений, полисов и денежных средств по вине АГЕНТА, СТРАХОВЩИК имеет право
потребовать от АГЕНТА возмещения СТРАХОВЩИКУ возникших вследствие такой утраты
убытков. АГЕНТ освобождается от ответственности, если докажет, что утрата
документов и денежных средств явилась следствием действия обстоятельств
непреодолимой силы либо противоправных действий третьих лиц. В случае порчи
документов строгой отчетности, номерных бланков заявлений и полисов испорченные
экземпляры должны передаваться СТРАХОВЩИКУ в течение 3 (трех) рабочих дней.<o:p></o:p></span></p>
...
mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Осуществлять передачу
страхователям оформленных СТРАХОВЩИКОМ договоров страхования (полисов) и
возврат подписанных экземпляров СТРАХОВЩИКУ не позднее 3 (трех) рабочих дней с
момента их подписания. При утрате подлежащих передаче Страхователю/подписанных
Страхователем номерных бланков полисов по вине АГЕНТА, СТРАХОВЩИК имеет право
потребовать от АГЕНТА возмещения СТРАХОВЩИКУ возникших вследствие такой утраты
убытков. АГЕНТ освобождается от ответственности, если докажет, что утрата
документов и денежных средств явилась следствием действия обстоятельств
непреодолимой силы либо противоправных действий третьих лиц.<o:p></o:p></span></p>

<p class=MsoNormal style='margin-left:19.5pt;text-align:justify;text-indent:
-19.5pt;line-height:11.0pt;mso-line-height-rule:exactly;mso-list:l8 level2 lfo1;
tab-stops:list 19.5pt'><![if !supportLists]><span lang=RU style='mso-ansi-language:
RU'><span style='mso-list:Ignore'>2.14.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span lang=RU style='mso-ansi-language:RU'>Перечислять
на расчетный счет СТРАХОВЩИКА суммы страховых премий/взносов по договорам
страхования, заключенным СТРАХОВЩИКОМ в результате исполнения АГЕНТОМ
обязанностей по настоящему договору, в течение 3 (трех) рабочих дней со дня их
получения от страхователей – физических лиц и индивидуальных предпринимателей.
Оплата страховых премий Страхователями - юридическими лицами производится в
...
сообщать СТРАХОВЩИКУ о решениях страхователей в отношении изменений и
дополнений к заключенным договорам страхования и консультировать страхователей
по заполнению соответствующих заявлений.<o:p></o:p></span></p>
...
mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Сообщать СТРАХОВЩИКУ о
любом изменении степени страхового риска или обо всех обстоятельствах, ведущих
к такому изменению, о которых стало известно АГЕНТУ.<o:p></o:p></span></p>
...
страхователя о необходимости уплаты страхового взноса в порядке, установленном
договором страхования, не позднее 30 дней до даты очередного платежа, указанной
в страховом полисе.<o:p></o:p></span></p>
...
рабочего дня месяца, следующего за окончанием отчетного периода, определенного
в «Положении об основном агентском вознаграждении АГЕНТОВ» (<a
href="../Новые%20формы%20АД/Приложение%20№6%20к%20Приказу%20№05%20ОД%2007%20Агентский%20договор%20с%20директором%20с%2001.02.07.doc#_Приложение_№_1#_Приложение_№_1"><span
style='font-size:10.0pt;font-family:Arial;mso-bidi-font-family:"Times New Roman";
color:windowtext;text-decoration:none;text-underline:none'>Приложение № 1</span></a>
к настоящему Договору) и «Положении о дополнительном агентском вознаграждении
АГЕНТОВ» (<a
href="../Новые%20формы%20АД/Приложение%20№6%20к%20Приказу%20№05%20ОД%2007%20Агентский%20договор%20с%20директором%20с%2001.02.07.doc#_Приложение_№_2#_Приложение_№_2"><span
style='font-size:10.0pt;font-family:Arial;mso-bidi-font-family:"Times New Roman";
color:windowtext;text-decoration:none;text-underline:none'>Приложение № 2</span></a>
к настоящему Договору), предоставлять СТРАХОВЩИКУ письменные Отчеты о
выполнении своих обязанностей по настоящему Договору по установленной
СТРАХОВЩИКОМ в <a
href="../Новые%20формы%20АД/Приложение%20№6%20к%20Приказу%20№05%20ОД%2007%20Агентский%20договор%20с%20директором%20с%2001.02.07.doc#_Приложение_№_4#_Приложение_№_4"><span
style='font-size:10.0pt;font-family:Arial;mso-bidi-font-family:"Times New Roman";
color:windowtext;text-decoration:none;text-underline:none'>Приложениях</span></a>
...
mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Выдать Доверенность на
подписание Отчетов к настоящему Договору, указанных в п. 2.21., лицам,
...
mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Присутствовать на всех
...
права и обязанности по настоящему Договору или его части третьим лицам, в том числе
не заключать субагентские договоры.<o:p></o:p></span></p>
...
mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>Не заключать договоры
о посреднической деятельности с целью заключения договоров страхования по видам
страхования, перечисленным в п.1.1. настоящего Договора, с другими страховыми
компаниями, брокерами, страховыми агентствами.<o:p></o:p></span></p>
...
СТРАХОВЩИКА, и любую другую информацию о деятельности СТРАХОВЩИКА, его деловых
операциях или методах их осуществления, не определенную СТРАХОВЩИКОМ для
разглашения, в течение срока действия данного Договора или после того, как срок
его действия истечет.<o:p></o:p></span></p>
...
рабочего дня сообщать Страховщику о регистрации и постановке на налоговый учет
в качестве индивидуального предпринимателя или о снятии с учета в качестве
такового. <o:p></o:p></span></p>
...
возмещения убытков в порядке, предусмотренном действующим законодательством РФ.<o:p></o:p></span></p>
...
tab-stops:list .25in'><![if !supportLists]><span lang=RU style='font-size:11.0pt;
...
указанных в п. 1., 2. настоящего Договора функций, включая правила страхования,
бланки заявлений-анкет, бланки строгой отчетности и т.д. Объем и характер
данной информации и документации определяет СТРАХОВЩИК.<o:p></o:p></span></p>
...
от имени и по поручению СТРАХОВЩИКА переговоры со страхователями по согласованию
условий страхования по видам, указанным в п. 2. настоящего Договора.<o:p></o:p></span></p>
...
указанном в <a
href="../Новые%20формы%20АД/Приложение%20№6%20к%20Приказу%20№05%20ОД%2007%20Агентский%20договор%20с%20директором%20с%2001.02.07.doc#_Приложение_№_1#_Приложение_№_1">Приложении
№1</a> к настоящему Договору.<o:p></o:p></span></p>

<p class=MsoBodyTextIndent2 style='margin-left:0in;line-height:11.0pt;
mso-line-height-rule:exactly;tab-stops:42.55pt'><span lang=RU style='font-size:
...
с клиентом АГЕНТА напрямую, информируя АГЕНТА о любых такого рода контактах, в
случае возникновения необходимости согласовать условия страхового возмещения,
по вопросам оплаты премии или уточнения информации, содержащейся в заявлении на
страхование.<o:p></o:p></span></p>
...
<p class=MsoBodyTextIndent2 style='margin-left:.5in;text-indent:-.25in;
line-height:11.0pt;mso-line-height-rule:exactly;mso-list:l5 level1 lfo4;
tab-stops:list .5in'><![if !supportLists]><span lang=RU style='font-size:11.0pt;
mso-bidi-font-size:10.0pt;font-family:Symbol;mso-fareast-font-family:Symbol;
mso-bidi-font-family:Symbol'><span style='mso-list:Ignore'>·<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
заключаемым договорам страхования (полисам) путем письменного уведомления АГЕНТА.
В случае несогласия АГЕНТА с новыми ставками агентского вознаграждения АГЕНТ
...
style='mso-spacerun:yes'>  </span>определяемыми СТРАХОВЩИКОМ и необходимыми для
осуществления деятельности, предусмотренной настоящим Договором.<o:p></o:p></span></p>
...
страховые тарифы, порядок заключения договоров страхования и другие внутренние
документы СТРАХОВЩИКА. <o:p></o:p></span></p>
...
вознаграждение. Размер и порядок выплаты вознаграждения указаны в «Положении об
основном агентском вознаграждении АГЕНТОВ» (Приложении № 1 к настоящему
...
понесенные АГЕНТОМ в связи с исполнением настоящего Договора, компенсируются за
счет агентского вознаграждения и дополнительно не оплачиваются, если соглашением
Сторон не будет предусмотрено иное.<o:p></o:p></span></p>
...
Страхователю выплачивается сумма в размере внесенного первого или единовременного
взноса в полном объеме или за вычетом расходов <span style='text-transform:
uppercase'>Страховщика</span> по медицинскому обследованию, <span
style='text-transform:uppercase'>Страховщик</span> имеет право потребовать от
Агента возврата полученного по данному договору основного агентского
вознаграждения в полном объеме.<o:p></o:p></span></p>
...
страховой премии в полном объеме, Страховщик имеет право потребовать от Агента
возврата полученного по данному договору основного агентского вознаграждения в
полном объеме.<o:p></o:p></span></p>
...
style='mso-spacerun:yes'>  </span>ненадлежащее исполнение своих обязанностей по
настоящему Договору, если это явилось следствием действий обстоятельств
...
возникновении и прекращении таких обстоятельств стороны должны уведомлять друг
друга любым доступным<span style='mso-spacerun:yes'>  </span>им способом в
течение 5 (пяти) дней с момента их возникновения.<o:p></o:p></span></p>
...
как во время, так и после прекращения действия настоящего Договора обязуются не
передавать третьим лицам без заранее полученного в каждом конкретном случае от
другой стороны письменного согласия, прямо или косвенно, никакой информации о
клиентах, физических и юридических лицах, контактах, способах установления
контактов, источниках информации, способах выхода и доступа к источникам
информации, источниках происхождения, способах приобретения услуг, свойствах
услуг, информацию, содержащую в себе информационные и организационные ноу-хау,
ноу-хау в области юридических формулировок, позиций и приемов при ведении
переговоров и другие ноу-хау, которые могут быть известны сторонам, как с
ведома, так и без ведома другой стороны настоящего Договора.<o:p></o:p></span></p>
...
возмещения вреда, нанесенного вследствие нарушения условий конфиденциальности в
порядке и размере, предусмотренных законодательством. <o:p></o:p></span></p>
...
line'>Срок действия договора. </span></b><b style='mso-bidi-font-weight:normal'><span
...
mso-line-height-rule:exactly;mso-list:l9 level1 lfo2;tab-stops:14.2pt list .25in'><![if !supportLists]><b
style='mso-bidi-font-weight:normal'><span lang=RU style='font-size:11.0pt;
mso-bidi-font-size:10.0pt'><span style='mso-list:Ignore'>10.<span
...
normal'>Порядок</b></span><b style='mso-bidi-font-weight:normal'><span lang=RU
style='font-size:11.0pt;mso-bidi-font-size:10.0pt'> расторжения договора.<o:p></o:p></span></b></p>
...
уведомлением другой стороны за 20 (двадцать) календарных дней до даты
предполагаемого расторжения Договора. Уведомление (письмо) о расторжении
Агентского Договора может быть передано каждой из Сторон (ее законному или
уполномоченному представителю) лично под расписку или направляется по почте
заказным письмом. <o:p></o:p></span></p>
...
даты прекращении настоящего Договора Стороны обязаны произвести между собой все
взаиморасчеты, в том числе АГЕНТ обязан вернуть СТРАХОВЩИКУ все полученные от
последнего для исполнения обязательств по настоящему договору документы и
материалы и доверенность, а также предоставить отчет и отчитаться за
использованные бланки строгой отчетности, а также выполнить все обязательства,
...
<p class=MsoNormal style='text-align:justify;line-height:11.0pt;mso-line-height-rule:
exactly'><b style='mso-bidi-font-weight:normal'><span lang=RU style='mso-ansi-language:
RU'><o:p>&nbsp;</o:p></span></b></p>
...
будут всячески содействовать сохранению и выполнению принятых на себя намерений
и обязательств.<o:p></o:p></span></p>

<p class=MsoNormal style='margin-left:17.0pt;text-align:justify;text-indent:
-17.0pt;line-height:11.0pt;mso-line-height-rule:exactly;mso-list:l9 level2 lfo2;
tab-stops:list .25in'><![if !supportLists]><span lang=RU style='mso-ansi-language:
RU'><span style='mso-list:Ignore'>11.2.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span lang=RU style='mso-ansi-language:RU'>Все споры
и разногласия, которые могут возникнуть из настоящего Договора, будут по
возможности решаться путем двусторонних переговоров.<o:p></o:p></span></p>
...
притворной сделкой, что данная сделка не противоречит чьим-либо интересам, что
представители Сторон находятся в обычном для них состоянии здоровья, что
...
дополнения, приложения и изменения к настоящему Договору будут действительными
и иметь юридическую силу, если они будут выполнены в письменной форме и
подписаны обеими Сторонами.<o:p></o:p></span></p>
...
<h2 align=right style='text-align:right;line-height:11.0pt;mso-line-height-rule:
exactly'><span lang=RU>Приложение № 1 к Агентскому Договору № <%=AGDOGNUM%></span></h2>
...
<p class=1 style='text-indent:-28.5pt;line-height:11.0pt;mso-line-height-rule:
exactly;mso-list:l8 level1 lfo5'><![if !supportLists]><b style='mso-bidi-font-weight:
normal'><span lang=RU style='font-size:11.0pt'><span style='mso-list:Ignore'>1.<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b
style='mso-bidi-font-weight:normal'><span lang=RU style='font-size:11.0pt'>Общие
положения<o:p></o:p></span></b></p>

<p class=1 style='margin-left:9.0pt;text-indent:0in;line-height:11.0pt;
mso-line-height-rule:exactly;mso-list:none;tab-stops:9.0pt'><span lang=RU
style='font-size:11.0pt'>1.1 Настоящее положение является неотъемлемой частью
Агентского договора № <%=AGDOGNUM%>.<o:p></o:p></span></p>

<p class=1 style='margin-left:9.0pt;text-indent:0in;line-height:11.0pt;
mso-line-height-rule:exactly;mso-list:none;tab-stops:9.0pt'><span lang=RU
style='font-size:11.0pt'>1.2 Настоящее положение регламентирует условия выплаты
основного агентского вознаграждения (ОАВ) страховым АГЕНТАМ (далее – АГЕНТ).<o:p></o:p></span></p>
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b
style='mso-bidi-font-weight:normal'><span lang=RU style='font-size:11.0pt'>Порядок
выплаты агентского вознаграждения.<o:p></o:p></span></b></p>
...
Symbol;mso-bidi-font-family:Symbol'><span style='mso-list:Ignore'>·<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp; </span></span></span><![endif]><span
lang=RU style='font-size:11.0pt'>порядка уплаты страховой премии (единовременно
или в рассрочку);<o:p></o:p></span></p>
...
line-height:11.0pt;mso-line-height-rule:exactly;mso-list:l4 level1 lfo8;
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span lang=RU style='mso-fareast-language:RU'>первых
...
Symbol;mso-fareast-language:RU'><span style='mso-list:Ignore'>·<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span lang=RU style='mso-fareast-language:RU'>очередных
...
Symbol;mso-fareast-language:RU'><span style='mso-list:Ignore'>·<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span lang=RU style='mso-fareast-language:RU'>оплаченных
...
mso-line-height-rule:exactly;tab-stops:0in'><span lang=RU>2.4. По договорам
страхования, страховая премия в которых указана в валютном эквиваленте,
страховая премия считается оплаченной полностью в случае, если оплачено не
менее 99,99% от суммы премии. При страховании с валютным эквивалентом страховая
премия уплачивается в рублях по курсу Центрального банка РФ, установленному для
иностранной валюты на дату уплаты (перечисления).&nbsp; Датой уплаты страховой
премии (взноса) считается:</span></p>

<p class=MsoBodyTextIndent style='margin-top:6.0pt;margin-right:0in;margin-bottom:
0in;margin-left:0in;margin-bottom:.0001pt;text-align:justify;line-height:11.0pt;
mso-line-height-rule:exactly;tab-stops:0in'><span lang=RU>- В случае
...
<p class=MsoBodyTextIndent style='margin-top:6.0pt;margin-right:0in;margin-bottom:
0in;margin-left:0in;margin-bottom:.0001pt;text-align:justify;line-height:11.0pt;
mso-line-height-rule:exactly;tab-stops:0in'><span lang=RU>- В случае приема <span
style='text-transform:uppercase'>Агентом</span> у Страхователя страховой премии
с использованием бланка строгой отчетности квитанции формы А7 – дата, указанная
в квитанции формы А7.</span></p>

<p class=MsoBodyTextIndent style='margin-top:6.0pt;margin-right:0in;margin-bottom:
0in;margin-left:0in;margin-bottom:.0001pt;text-align:justify;line-height:11.0pt;
mso-line-height-rule:exactly;tab-stops:0in'><span lang=RU>- В случае оплаты
страховой премии Страхователем через банк – дата, указанная в приходном
кассовом&nbsp; ордере банка (форме ПД4)</span></p>

<p class=1 style='margin-left:19.5pt;line-height:11.0pt;mso-line-height-rule:
exactly;mso-list:l8 level2 lfo9;tab-stops:14.2pt list 19.5pt'><![if !supportLists]><span
lang=RU style='font-size:11.0pt;mso-fareast-language:EN-US;layout-grid-mode:
line'><span style='mso-list:Ignore'>2.5.<span style='font:7.0pt "Times New Roman"'>&nbsp;
</span></span></span><![endif]><span lang=RU style='font-size:11.0pt;
mso-fareast-language:EN-US;layout-grid-mode:line'>Отчетным периодом считается
период с 1-го по 30 (31-е) число каждого месяца. <o:p></o:p></span></p>

<p class=MsoBodyTextIndent style='margin-top:6.0pt;margin-right:0in;margin-bottom:
0in;margin-left:0in;margin-bottom:.0001pt;text-align:justify;line-height:11.0pt;
mso-line-height-rule:exactly;tab-stops:0in'><span lang=RU>2.6. Выплата
...
<p class=MsoBodyTextIndent style='margin-top:6.0pt;margin-right:0in;margin-bottom:
0in;margin-left:0in;margin-bottom:.0001pt;text-align:justify;line-height:11.0pt;
mso-line-height-rule:exactly;tab-stops:0in'><span lang=RU>2.7. СТРАХОВЩИК
выплачивает основное агентское вознаграждение <span style='text-transform:uppercase'>агенту</span>
в течение 5 (пяти) рабочих дней с момента подписания Отчета к Агентскому
Договору обеими сторонами.</span></p>

<p class=MsoBodyTextIndent style='margin-top:6.0pt;margin-right:0in;margin-bottom:
0in;margin-left:0in;margin-bottom:.0001pt;text-align:justify;line-height:11.0pt;
mso-line-height-rule:exactly;tab-stops:0in'><span lang=RU>2.8. Стороны могут
согласовать в Отчете к Агентскому договору сумму подлежащего к выплате
основного агентского вознаграждения, рассчитанного на основании размера ставки
основного агентского вознаграждения, отличного от указанного в настоящем
Положении.</span></p>

<p class=MsoBodyTextIndent style='margin-top:6.0pt;margin-right:0in;margin-bottom:
0in;margin-left:0in;margin-bottom:.0001pt;text-align:justify;line-height:11.0pt;
mso-line-height-rule:exactly;tab-stops:-.25in'><span lang=RU>2.9. В случае если
сумма подлежащего к выплате за отчетный месяц агентского вознаграждения
составляет менее 300 рублей, то агентское вознаграждение в месяце следующим за
отчетным не выплачивается.</span></p>

<p class=MsoNormal style='text-align:justify;mso-outline-level:1;tab-stops:
-.25in'><span lang=RU style='mso-bidi-font-size:11.0pt;mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></p>

<p class=MsoNormal style='text-align:justify;mso-outline-level:1;tab-stops:
-.25in'><span lang=RU style='mso-bidi-font-size:11.0pt;mso-ansi-language:RU'>2.10.
Агентское вознаграждение, составляющее сумму менее указанной в пункте 2.9.,
может накапливаться не более 3-х месяцев и по истечении указанного срока
СТРАХОВЩИК обязан выплатить накопленную сумму агентского вознаграждения<o:p></o:p></span></p>
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b
style='mso-bidi-font-weight:normal'><span lang=RU style='font-size:11.0pt'>Ставки
агентского вознаграждения<o:p></o:p></span></b></p>

<p class=MsoBodyTextIndent style='margin-left:0in;text-align:justify;
line-height:11.0pt;mso-line-height-rule:exactly'><span lang=RU>3.3. При расчете
основного агентского вознаграждения по договору страхования в течение всего
срока действия договора страхования применяется САВ, действовавшая на момент
...
изменения базовых ставок ПМ по решению Компании.</span></p>
...
style='text-transform:uppercase'>Агентом</span> до даты вступления новых ставок
в силу, рассчитывается по старым ставкам.</span></p>

<p class=MsoBodyTextIndent style='margin-left:0in;text-align:justify;
line-height:11.0pt;mso-line-height-rule:exactly'><span lang=RU>3.5. Ставки ОАВ
...
<p class=MsoNormal style='text-align:justify;line-height:11.0pt;mso-line-height-rule:
exactly'><span lang=RU style='mso-bidi-font-size:11.0pt;mso-ansi-language:RU'>3.6.
АГЕНТ имеет право на получение ОАВ по переданному ему на дальнейшее
обслуживание договору страхования, заключенному при посредничестве другого
агента, с которым СТРАХОВЩИКОМ был расторгнут агентский договор. В этом случае
АГЕНТ получает ОАВ от поступивших по таким договорам очередных страховых
взносов за первый год действия такого договора страхования по ставке агентского
вознаграждения за второй год действия договора страхования при условии
включения указанного договора страхования в отчет АГЕНТА.. <o:p></o:p></span></p>

<p class=1 style='margin-left:0in;text-indent:0in;line-height:11.0pt;
mso-line-height-rule:exactly;mso-list:none;tab-stops:14.2pt'><span lang=RU
style='font-size:11.0pt;mso-fareast-language:EN-US;layout-grid-mode:line'>3.7.
При расчете ОАВ по отдельным договорам страхования СТРАХОВЩИК имеет право при
условии согласования с АГЕНТОМ применить САВ в порядке ином, чем определено в
настоящем Приложении, в частности применять САВ второго года действия договора
...
<p class=1 style='margin-left:9.0pt;text-indent:0in;mso-list:none;tab-stops:
14.2pt'><span lang=RU style='font-size:11.0pt'>4.<b style='mso-bidi-font-weight:
normal'> Базовые размеры ставок агентского вознаграждения:</b></span><b
style='mso-bidi-font-weight:normal'><span lang=RU><o:p></o:p></span></b></p>
</td>
</tr>
</table>
</div>

<b style='mso-bidi-font-weight:normal'><span lang=RU style='font-size:11.0pt;
...
<div class=Section3>
<table class="mainTableLandscape">
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  <td class="mainTdLandscape">
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;page-break-inside:avoid;
  ...
  style='font-size:8.0pt'>Период страхования, лет</span><span style='font-size:
  ...
  взносов, страхования жизни на срок, дожития с возвратом взносов (страхование
  детей)</span><span lang=RU style='font-size:8.0pt;mso-fareast-font-family:
  ...
  случаев&quot; к программам смешанного страхования жизни, дожития с возвратом
  взносов, страхования жизни на срок, дожития с возвратом взносов (страхование
  детей).</span><span lang=RU style='font-size:8.0pt;mso-fareast-font-family:
  "Arial Unicode MS";mso-ansi-language:RU'><o:p></o:p></span></p>
  </td>
 ...
 <tr style='mso-yfti-irow:1;page-break-inside:avoid;height:12.0pt'>
  <td width=113 colspan=2 style='width:85.1pt;border-top:none;border-left:none;
  ...
  <td width=113 colspan=2 style='width:85.1pt;border-top:none;border-left:solid windowtext 1.0pt;
  border-bottom:solid windowtext 1.0pt;border-right:solid black 1.0pt;
  ...
  mso-border-right-alt:black .5pt;mso-border-style-alt:solid;padding:.75pt .75pt 0in .75pt;
  height:12.0pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='font-size:8.0pt'>периодическая уплата взносов</span><span
  style='font-size:8.0pt;mso-fareast-font-family:"Arial Unicode MS"'><o:p></o:p></span></p>
  ...
  <td width=113 colspan=2 style='width:85.0pt;border-top:none;border-left:solid windowtext 1.0pt;
  border-bottom:solid windowtext 1.0pt;border-right:solid black 1.0pt;
  mso-border-top-alt:solid windowtext 1.0pt;mso-border-top-alt:windowtext 1.0pt;
  mso-border-left-alt:windowtext 1.0pt;mso-border-bottom-alt:windowtext .5pt;
  mso-border-right-alt:black .5pt;mso-border-style-alt:solid;padding:.75pt .75pt 0in .75pt;
 ...
 <tr style='mso-yfti-irow:2;page-break-inside:avoid;height:36.75pt'>
  ...
  .75pt .75pt 0in .75pt;height:36.75pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
  style='font-size:8.0pt'>последующие годы</span><span style='font-size:8.0pt;
  mso-fareast-font-family:"Arial Unicode MS"'><o:p></o:p></span></p>
  </td>
 ...
 <tr style='mso-yfti-irow:3;height:12.0pt'>
  ...
  .75pt .75pt 0in .75pt;height:12.0pt'>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:2;height:3.0pt'>
  ...
  solid windowtext 1.0pt;mso-border-right-alt:solid windowtext .5pt;padding:
  0in 5.4pt 0in 5.4pt;height:3.0pt'>
  <p class=MsoNormal align=center style='text-align:center'><span
 ...
 <tr style='mso-yfti-irow:3;height:3.0pt'>
  ...
  0in 5.4pt 0in 5.4pt;height:3.0pt'>
  <p class=MsoNormal align=center style='text-align:center'><span lang=RU
  style='font-size:9.0pt;mso-ansi-language:RU'>Договоры группового страхования
  жизни и НС<o:p></o:p></span></p>
  </td>
  <td width=364 nowrap valign=bottom style='width:272.7pt;border-top:none;
  border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-left-alt:solid windowtext 1.0pt;padding:0in 5.4pt 0in 5.4pt;
 ...
 <tr style='mso-yfti-irow:6;mso-yfti-lastrow:yes;height:11.45pt'>
  ...
  border-top:none;mso-border-top-alt:solid windowtext 1.0pt;mso-border-alt:
  solid windowtext 1.0pt;mso-border-right-alt:solid windowtext .5pt;padding:
  0in 5.4pt 0in 5.4pt;height:11.45pt'>
  <p class=MsoNormal align=center style='text-align:center'><span lang=RU
...
lang=RU>Приложение № 2 к Агентскому Договору № <%=AGDOPSNUM%> </span><span
style='mso-bookmark:agent_id_2'></span><i style='mso-bidi-font-style:normal'><span
lang=RU style='font-weight:normal;mso-bidi-font-weight:bold'><o:p></o:p></span></i></h2>

<p class=1 style='margin-left:.5in;text-indent:-.25in;mso-list:l1 level1 lfo10;
tab-stops:14.2pt list .5in'><![if !supportLists]><span lang=RU
style='font-size:11.0pt;mso-bidi-font-size:10.0pt'><span style='mso-list:Ignore'>1.<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><![endif]><span
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt'>Настоящее Приложение
является неотъемлемой частью Агентского договора № <%=AGDOGNUM%>.<o:p></o:p></span></p>

<p class=1 style='margin-left:.5in;text-indent:-.25in;mso-list:l1 level1 lfo10;
tab-stops:14.2pt list .5in'><![if !supportLists]><span lang=RU
style='font-size:11.0pt;mso-bidi-font-size:10.0pt'><span style='mso-list:Ignore'>2.<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><![endif]><span
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt'>Настоящее Приложение
устанавливает форму Отчета Агента к Агентскому договору, на основании которого
выплачивается основное агентское вознаграждение. <o:p></o:p></span></p>

<p class=MsoTitle style='margin-top:6.0pt'><span lang=RU style='font-size:11.0pt;
mso-bidi-font-size:10.0pt;font-family:"Times New Roman"'>ОТЧЕТ АГЕНТА № ОАВ-__<o:p></o:p></span></p>
...
лице <%=CHIEF_NAME%>,
действующего на основании доверенности №_______________ выданной ______________,
с одной стороны, и <%=AGNAME%>, паспорт серии <%=PS%> № <%=PNUM%>, именуемый(ая) в
...
mso-ansi-language:RU'>1. За период с &lt;ДАТА&gt; по &lt;ДАТА&gt; при
посредничестве Агента были заключены следующие договоры страхования, по которым
на расчетный счет страховщика поступила страховая премия в полном объеме:<o:p></o:p></span></p>
...
<p class=MsoNormal style='mso-layout-grid-align:none;text-autospace:none'><span
lang=RU style='font-family:"Times New Roman CYR";mso-bidi-font-family:"Times New Roman";
mso-ansi-language:RU'>2. Основное агентское вознаграждение за отчетный период
составляет: ________. Расчет агентского вознаграждения прилагается к настоящему
отчету.<o:p></o:p></span></p>
...
style='mso-spacerun:yes'>  </span>к Агентскому Договору № <AGDAGNUM></span></h2>

<p class=MsoNormal><span lang=RU style='mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></p>

<p class=1 style='margin-left:.5in;text-indent:-.25in;mso-list:l7 level1 lfo11;
tab-stops:14.2pt list .5in'><![if !supportLists]><span lang=RU
style='font-size:11.0pt;mso-bidi-font-size:10.0pt'><span style='mso-list:Ignore'>1.<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><![endif]><span
lang=RU style='font-size:11.0pt;mso-bidi-font-size:10.0pt'>Настоящее Приложение
...
<ol style='margin-top:0in' start=2 type=1>
 <li class=MsoNormal style='text-align:justify;mso-list:l7 level1 lfo11;
...
<p class=MsoNormal style='text-align:justify;mso-layout-grid-align:none;
text-autospace:none'><span lang=RU style='font-family:"Times New Roman CYR";
mso-bidi-font-family:"Times New Roman";mso-ansi-language:RU'>Расчет основного
...
<p class=MsoNormal style='text-align:justify;mso-layout-grid-align:none;
text-autospace:none'><span lang=RU style='font-family:"Times New Roman CYR";
mso-bidi-font-family:"Times New Roman";mso-ansi-language:RU'>Основное агентское
вознаграждение выплачивается в соответствии с условиями агентского договора № <%=AGDOGNUM%>.<o:p></o:p></span></p>

<p class=MsoNormal style='margin-left:0in;text-align:justify;text-indent:.25in;
mso-list:l6 level1 lfo12;tab-stops:list 0in .5in;mso-layout-grid-align:none;
...
__________________________________, получает основное агентское вознаграждение
за следующие договоры страхования, заключенные в результате выполнения АГЕНТОМ
обязанностей по агентскому договору:<o:p></o:p></span></p>
...
соответствии с таблицей, приведенной ниже.<o:p></o:p></span></p>
...
<ol style='margin-top:0in' start=3 type=1>
 <li class=MsoNormal style='mso-list:l6 level1 lfo12;tab-stops:list .5in;
     mso-layout-grid-align:none;text-autospace:none'><span lang=RU
     style='font-family:"Times New Roman CYR";mso-bidi-font-family:"Times New Roman";
     mso-ansi-language:RU'>Итого размер агентского вознаграждения за период с
 ...
 <li class=MsoNormal style='mso-list:l6 level1 lfo12;tab-stops:list .5in;
     mso-layout-grid-align:none;text-autospace:none'><span lang=RU
     style='font-family:"Times New Roman CYR";mso-bidi-font-family:"Times New Roman";
     mso-ansi-language:RU'>Сумма агентского вознаграждения, указанная в п. 3.,
     определена правильно.<o:p></o:p></span></li>
</ol>
...
mso-ansi-language:RU'>Настоящее Дополнительное Соглашение вступает в силу с
момента его подписания обеими сторонами и является<span
style='mso-spacerun:yes'>  </span>неотъемлемой частью Агентского договора
№<span style='mso-spacerun:yes'>  </span> <%=AGDOGNUM%>
от<span style='mso-spacerun:yes'>   </span><%=DOG_DATE%>,
заключенного между <%=ORGNAME%> и <span style='mso-spacerun:yes'> 
</span><%=AGENT_NAME_INSTRUMENTAL%>.<o:p></o:p></span></p>
