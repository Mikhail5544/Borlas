...
%>
<rw:report id="report" parameters="server=tongaRS2&userid=ins/ii@ren&p_ch_id=137626&P_AG_DOVER_ID=145188">
...
ORDER BY NVL (cci.issue_date, TO_DATE ('01.01.1900', 'DD.MM.YYYY')) DESC;]]>
    ...
    <dataSource name="Q_DOVER">
      <select>
      <![CDATA[select DOV.AG_CONTRACT_HEADER_ID,  decode(nvl(dov.NUM,'0'),'0',' ',dov.NUM) num , dov.date_start,
...
12.0pt;font-family:"Times New Roman CYR";mso-bidi-font-family:"Times New Roman"'><%=dovNum%> rrrrrrrrr</span></b></a><span
...
style='mso-ansi-language:RU'>Я, </span><%=AGNAME%><span lang=RU style='mso-ansi-language:
...
RU;mso-no-proof:yes'>Филиппенкову Оксану Евгеньевну, </span></b><span lang=RU
style='mso-ansi-language:RU;mso-no-proof:yes'>паспорт серии 45 01 № 597530, выданный
ОВД «Северное Бутово», дата выдачи: <span style='mso-spacerun:yes'> </span>09.11.2001,
зарегистрирована по адресу: г. Москва, ул. Старокачаловская, д.1, стр.2, кв.111,<o:p></o:p></span></p>
