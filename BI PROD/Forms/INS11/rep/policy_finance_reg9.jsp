 ...
 beforeReportTrigger="afterpform" unitOfMeasurement="centimeter">
  ...
  <data>
    ...
    <userParameter name="TYPE_CONT" datatype="number" precision="10"
     defaultWidth="0" defaultHeight="0"/>
	<userParameter name="fee_term" datatype="number" precision="10"
     defaultWidth="0" defaultHeight="0"/>
...
(
  select
  'ДОГОВОР СТРАХОВАНИЯ ЗАКЛЮЧЕН НА ОСНОВАНИИ "УСЛОВИИ СТРАХОВАНИЯ ПО ПРОГРАММЕ "СОФИНАНСИРОВАНИЕ ПЛЮС С РЕГУЛЯРНОЙ ФОРМОЙ ОПЛАТЫ".' text,
  '*' prog
  from dual
  union all
  select
...
decode(vf.brief, 
           ...
           vf.brief) kod_val_up,
		   pp.fee_payment_term
    into :BRIEF_PRODUCT,:POL_NUM,:P_NOTICE,:CUR_POLICY,:PROGRAMMA,:P_SYSDATE,:TYPE_CONT,:POL_HOLDER,:PH_BIRTH,:PH_DOC,:POL_ASS,:PA_BIRTH,:PA_DOC, :PA_PERIODICH, :PA_PER, :WAITING_PERIOD_END_DATE, :PA_ROW_PRIL, :PA_KOD_VAL,:PA_KOD_VAL_UP, :fee_term
...
select nvl(trunc(min(start_date)),trunc(sysdate))
into v_print_date
from (select ds.document_id, ds.start_date  
      from ven_doc_status ds, ven_doc_status_ref dsr 
      where ds.doc_status_ref_id = dsr.doc_status_ref_id(+)
            and dsr.brief = 'PRINTED' and ds.document_id =:P_POLICY_ID
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=708
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  ...
  RU'>СОФИНАНСИРОВАНИЕ ПЛЮС</span></b><b><span style='font-size:18.0pt;color:#FF6600;
  ...
  margin-bottom:12.0pt;margin-left:0cm;text-align:center'><b><span
  style='font-size:14.0pt;color:#FF6600;mso-ansi-language:RU'>(с регулярной формой оплаты)</span></b></p>
  <p class=MsoNormal align=center style='margin-top:12.0pt;margin-right:0cm;
  ...
  <p class=MsoNormal align=center style='margin-top:12.0pt;margin-right:0cm;
  margin-bottom:12.0pt;margin-left:0cm;text-align:center'><b><span
  style='font-size:18.0pt;color:#FF6600;mso-ansi-language:RU'>Полис страхования № <rw:field id="" src="POL_NUM"/></span></b></p>
  <p class=MsoNormal align=center style='margin-top:12.0pt;margin-right:0cm;
  margin-bottom:12.0pt;margin-left:0cm;text-align:center'><span
  style='font-size:4.0pt;mso-bidi-font-size:8.0pt;mso-ansi-language:RU'><o:p>&nbsp;</o:p></span></p>
  </td>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=708
 ...
 <tr style='mso-yfti-irow:23;height:4.0pt'>
  ...
  <p class=MsoNormal align=center style='text-align:center;'><i
  style='mso-bidi-font-style:normal'><span style='font-size:8.0pt;mso-ansi-language:
  RU'>Страховой взнос, <rw:field id="" src="PA_KOD_VAL"/></span></i></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:42'>
  ...
  name="ns_ins"></a><span style='mso-spacerun:yes'> </span>СТРАХОВОЙ ВЗНОС:<span
...
<rw:getValue id="PER" src="PA_PER"/>
 ...
 для соответствующей валюты на дату уплаты. Все банковские расходы, связанные с оплатой страхового
  ...
  взноса, оплачиваются Страхователем. <% } %></span></i><b style='mso-bidi-font-weight:
...
<br></br>
 ...
 <tr style='mso-yfti-irow:8;'>
  ...
  <p class=MsoNormal><b><span style='font-size:9.0pt;mso-bidi-font-size:8.0pt;
  color:#FF6600;mso-ansi-language:RU'>6. УСЛОВИЯ И СРОКИ УПЛАТЫ СТРАХОВОГО<span
  style='mso-spacerun:yes'>  </span>ВЗНОСА</span></b><b style='mso-bidi-font-weight:
 ...
 <tr style='mso-yfti-irow:12'>
  <td width=300 colspan=4 valign=top style='width:225.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><a name="payment_rule_row"><b style='mso-bidi-font-weight:
  normal'><span style='font-size:8.0pt;mso-ansi-language:RU'>СРОК УПЛАТЫ СТРАХОВЫХ ВЗНОСОВ:</span></b></a><b
  style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;mso-ansi-language:
  RU'><o:p></o:p></span></b></p>
  </td>
  <td width=408 colspan=8 valign=top style='width:306.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span style='font-size:8.0pt;mso-ansi-language:RU'><rw:field id="" src="fee_term"/> лет <b
  style='mso-bidi-font-weight:normal'><o:p></o:p></b></span></p>
  </td>
 </tr>
...
<rw:getValue id="j_inv" src="dop_inv"/>
 ...
 <tr style='mso-yfti-irow:36'>
  ...
  <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><i style='mso-bidi-font-style:normal'><span
  style='font-size:8.0pt;mso-ansi-language:RU'><%=format.format(NN++)%>. Заявление на заключение договора
 ...
 <tr style='mso-yfti-irow:38'>
  ...
  <td width=444 colspan=9 valign=top style='width:333.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><i style='mso-bidi-font-style:normal'><span
  style='font-size:8.0pt;mso-ansi-language:RU'><%=format.format(NN++)%>. Условия страхования по программе "Софинансирование Плюс с регулярной формой оплаты".</span></i></p>
  </td>
 </tr>
