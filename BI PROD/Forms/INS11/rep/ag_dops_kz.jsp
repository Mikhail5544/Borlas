...
<report name="ag_dop_kz_model" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="AG_DOP_KZ_MODEL" xmlPrologType="text">
  ...
  <data>
    ...
    <dataSource name="Q_AGENT">
      ...
      <![CDATA[   SELECT ach.agent_id, ach.ag_contract_header_id,
       ent.obj_name (ent.id_by_brief ('CONTACT'), ach.agent_id) agent_name,
...
ORDER BY NVL (cci.issue_date, TO_DATE ('01.01.1900', 'DD.MM.YYYY')) DESC]]>
      ...
      <group name="G_AG_DOCS">
        ...
        />
        <dataItem name="data_v" datatype="vchar2" columnOrder="37"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
   ...
   WHERE c.AG_CONTRACT_ID = :P_CONTRACT_ID
      ...
      <group name="G_DOPS">
        ...
        <dataItem name="vn" datatype="vchar2" columnOrder="38" width="100"
   ...
   WHERE vcp.contact_id = cci.contact_id
     ...
     AND UPPER (tit.brief) IN ('TRUST')   
      ...
      <displayInfo x="1.96875" y="5.19788" width="0.69995" height="0.32983"/>
      <group name="G_DIR_DOCS">
        <displayInfo x="1.62891" y="5.89783" width="1.37964" height="1.28516"
        />
...
<link rel=File-List href="<%=g_ImagesRoot%>/ag_dops_kz.files/filelist.xml">
...
@page Section1
	...
	mso-even-header:url("<%=g_ImagesRoot%>/ag_dops_kz.files/header.htm") eh1;
	mso-even-footer:url("<%=g_ImagesRoot%>/ag_dops_kz.files/header.htm") ef1;
	mso-footer:url("<%=g_ImagesRoot%>/ag_dops_kz.files/header.htm") f1;	
	mso-paper-source:0;}
div.Section1
	{page:Section1;}
@page Section2
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=662
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  </span></span></span></b><span lang=RU style='color:#333333'><b
  style='mso-bidi-font-weight:normal'><o:p></o:p><%=AGDOGNUM%></b></span></p>
  ...
  <%=G_N_OBR%> </span><span style='font-size:11.0pt;font-family:"Times New Roman";
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=662
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  mso-ansi-language:EN-US'><%=DATE_BEGIN%></span><span lang=RU style='font-size:11.0pt;
