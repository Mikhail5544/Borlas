...
<% if (ex_inv.equals("0")) {%> <%} else {%> В связи с расторжением Договора в отношении программы "Инвест" исключить 
...
<% if (z.equals("1")) {%> <%} else {%> Страхователь обязан оплатить задолженность перед Страховщиком в размере просроченных страховых взносов, 
