	...
	<userParameter name="REP_DATE" datatype="character" width="150"
     defaultWidth="0" defaultHeight="0"/>
      ...
      <![CDATA[select count(*) OVER (order by dep.name) rn, 
       nvl(director.dch,director1.dch) dch,
       nvl(director.ddep,director1.ddep) ddep,
       nvl(director.dnum,director1.dnum) dnum,
       nvl(director.dname,director1.dname) dname,
       nvl(director.dcat,director1.dcat) dcat,
       nvl(director.dfnum,director1.dfnum) dfnum,
       nvl(director.dfname,director1.dfname) dfname,
       nvl(director.dfcat,director1.dfcat) dfcat,
       nvl(director.drnum,director1.drnum) drnum,
       nvl(director.drname,director1.drname) drname,
       nvl(director.drcat,director1.drcat) drcat,
       mch,
       mdep,
       mnum,
       mname,
...
where tr.ag_contract_header_id = agh.ag_contract_header_id
      ...
      and manag.mpid = director.did(+)
      and tr.ag_parent_header_id = director1.did(+)
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=741 style='border-collapse:
 ...
 <col width=105 style='mso-width-source:userset;mso-width-alt:3840;width:79pt'>
  ...
  <td colspan=26 height=62 class=xl73 width=741 style='height:46.5pt;width:557pt'>
...
<tr height=40 style='height:30.0pt'>
  ...
  <td class=xl65 width=50 colspan=8 style='border-top:none;border-left:none;width:50pt'>Территориальный Директор</td>
  <td class=xl65 width=50 colspan=8 style='border-top:none;border-left:none;width:50pt'>Директор</td>
  <td class=xl65 width=50 colspan=8 style='border-top:none;border-left:none;width:50pt'>Менеджер</td>
...
<tr height=40 style='height:30.0pt'>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl69 style='border-top:none;border-left:none'><rw:field id="" src="dfnum"></rw:field></td>
  <td class=xl69 style='border-top:none;border-left:none'><rw:field id="" src="dfname"></rw:field></td>
  <td class=xl69 style='border-top:none;border-left:none'><rw:field id="" src="dfcat"></rw:field></td>
