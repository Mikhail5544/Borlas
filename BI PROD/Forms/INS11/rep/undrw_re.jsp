 ...
 beforeReportTrigger="beforereport">
  ...
  <data>
    ...
    <userParameter name="AS_ASSURED_ID_OLD" datatype="character" width="40"
     ...
     defaultWidth="0" defaultHeight="0"/>
	 <userParameter name="date_print" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
...
from ASSURED_MEDICAL_EXAM asme, 
     as_assured_docum assd
...
where rownum = 1;
	...
	<dataSource name="Q_List">
      <select canParse="no">
      <![CDATA[   select a.rnm,
	  					 a.ins_amount_old_cel1,
	  					 a.ins_am_cel1,
						 a.ins_amount1,
						 a.DESCRIPTION1,
						 a.years1,
						 ...
						 a.K_COEF_M1,
						 a.K_COEF_NM1,
						 l_list.val_list,l_list.date_val,
						 a.brief_desc, a.PRESENTATION_DESC
   from
  
    (select 1 gr, 'Items' val_list, 'Date' date_val from dual
         union
         select 2 gr,'Application form with health declaration', null from dual
         union 
         select 3 gr,'FQ', null from dual
         union
         select 4 gr,'ME', null from dual
         union
         select 5 gr,'Urinalysis', null from dual
         union
         select 6 gr,'FBS', null from dual
         union
         select 7 gr,'Biochemistry', null from dual
         union
         select 8 gr,'Serology', null from dual
         union
         select 9 gr,'HIV', null from dual
         union
         select 10 gr,'ECG at rest', null from dual
         union
         select 11 gr,'Stress ECG', null from dual
         union
         select 12 gr,'EchoCG', null from dual
         union
         select 13 gr,'Other:', null from dual
         order by gr) l_list,
      (   
   select rownum rnm, ass.AS_ASSET_ID,
   nvl((select sum(ins_amount) from ven_p_cover where as_asset_id = :AS_ASSURED_ID_OLD and pc.t_prod_line_option_id = t_prod_line_option_id ),pc.ins_amount) ins_amount_old_cel1,
   pc.ins_amount ins_am_cel1,
    pkg_rep_utils.to_money(pc.ins_amount) ins_amount1, 
    plo.DESCRIPTION DESCRIPTION1, 
    round(months_between(pc.end_date,pc.start_date)/12,0) years1, 
    ll.BRIEF BRIEF1,
upper(ll.BRIEF) brief_risk1,
decode((select 1 from STATUS_HIST sh where sh.STATUS_HIST_ID = pc.STATUS_HIST_ID and sh.brief = 'DELETED'),1,'Decl',' ') decl1,
decode(nvl(pc.K_COEF_M,0),0,decode(nvl(pc.S_COEF_M,0),0,' ','+'||to_char(pc.S_COEF_M)||'‰'),'+'||to_char(pc.K_COEF_M)||'%') K_COEF_M1, 
decode(nvl(pc.K_COEF_NM,0),0,decode(nvl(pc.S_COEF_NM,0),0,' ','+'||to_char(pc.S_COEF_NM)||'‰'),'+'||to_char(pc.K_COEF_NM)||'%') K_COEF_NM1,
plt.brief brief_desc, plt.PRESENTATION_DESC
  ...
  where l_list.gr = a.rnm(+)
  order by a.brief_desc, a.PRESENTATION_DESC, a.rnm
]]>
      </select>
<group name="G_LIST">
        <dataItem name="rnm"/>
...
begin
  ...
  select to_char(sysdate,'dd.mm.yyyy') into :date_print from dual;
...
select case when pc.ins_amount <= 3000000 then '1'
            when pc.ins_amount > 3000000 and pc.ins_amount <= 7500000 then '2'
            when pc.ins_amount > 7500000 then '3'
            else '0' end
into :flag
from ven_p_policy pp, 
     ven_as_asset ass, 
...
<p class=MsoTitle><span lang=EN-US style='font-size:8.0pt'>Date / Дата: <rw:field id="" src="DATE_PRINT"></rw:field>
<o:p></o:p></span></p>
...
<table class=TableGrid1 border=1 cellspacing=0 cellpadding=0 width=696
 ...
 <td width=336 colspan=3 valign=top style='width:252.0pt;border:solid windowtext 1.0pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='text-align:center;tab-stops:18.0pt 125.25pt'><b><span
  lang=EN-US style='font-size:8.0pt;font-family:Arial'>LIST OF EVIDENCE ATTACHED</span></b><b><span
  lang=EN-US style='font-size:8.0pt;font-family:Arial;mso-ansi-language:RU'> </span></b><b><span
  lang=EN-US style='font-size:8.0pt;font-family:Arial'>/</span></b><b><span
  style='font-size:8.0pt;font-family:Arial;mso-ansi-language:RU'> СПИСОК ПРИЛАГАЕМЫХ ДОКУМЕНТОВ:<o:p></o:p></span></b></p>
  </td>
 </tr>
 
 <rw:foreach id="G_LIST" src="G_LIST">
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:15.8pt'>
  ...
  font-family:Arial;mso-ansi-language:RU;mso-bidi-font-weight:bold'><o:p><rw:field id="" src="DESCRIPTION1"></rw:field></o:p></span></p>
  </td>
  ...
  font-family:Arial;mso-ansi-language:RU;mso-bidi-font-weight:bold'><o:p><rw:field id="" src="INS_AMOUNT_OLD_CEL1" formatMask="999 999 990"></rw:field></o:p></span></p>
  </td>
  ...
  font-family:Arial;mso-ansi-language:RU;mso-bidi-font-weight:bold'><o:p><rw:field id="" src="YEARS1"></rw:field></o:p></span></p>
  </td>
  <td width=336 valign=top style='width:252.0pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:15.8pt'>
  <p class=MsoNormal style='tab-stops:18.0pt'>
  <span style='font-size:9.0pt;
  font-family:Arial;mso-ansi-language:RU;mso-bidi-font-weight:bold'><o:p><rw:field id="" src="val_list"></rw:field></o:p></span></p>
  </td>
  <td width=132 valign=top style='width:99.0pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:15.8pt'>
  <p align="right" class=MsoNormal style='tab-stops:18.0pt'><span style='font-size:9.0pt;
  font-family:Arial;mso-ansi-language:RU;mso-bidi-font-weight:bold'><o:p></o:p></span></p>
  </td>
  <td width=60 valign=top style='width:45.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:15.8pt'>
  <p align="center" class=MsoNormal style='tab-stops:18.0pt'><span style='font-size:9.0pt;
  font-family:Arial;mso-ansi-language:RU;mso-bidi-font-weight:bold'><o:p><rw:field id="" src="date_val"></rw:field></o:p></span></p>
  </td>
 </tr>
</rw:foreach>  
</table>
...
<p class=MsoNormal style='tab-stops:18.0pt'><b><span lang=EN-US
style='font-size:8.0pt;font-family:Arial;text-transform:uppercase'>1. General
...
lang=EN-US style='font-size:8.0pt;font-family:Arial;text-transform:uppercase'>2. Additional</span></b><b><span
...
<table class=TableNormal1 border=1 cellspacing=0 cellpadding=0 width=696
 ...
 <tr style='mso-yfti-irow:2;height:10.75pt'>
  ...
  style='font-size:8.0pt;font-family:Arial;mso-ansi-language:RU'> Рост (см) / Вес (кг):</span></b><span
  lang=EN-US style='font-size:8.0pt;font-family:Arial'><o:p></o:p></span></p>
  </td>
  <td width=120 colspan=2 style='width:90.0pt;border:solid windowtext 1.0pt;border-top:
  none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:21.75pt'>
  ...
  style='font-size:9.0pt;font-weight:normal;mso-bidi-font-weight:bold'><o:p><rw:field id="" src="HEIGHT"></rw:field> / <rw:field id="" src="WEIGHT"></rw:field></o:p></span></h2>
  </td>
  ...
  lang=EN-US style='font-size:8.0pt;font-family:Arial'> / </span></b><b><span
  style='font-size:8.0pt;font-family:Arial;mso-ansi-language:RU'>Алкоголь: NO / Нет</span></b><b><span
  lang=EN-US style='font-size:8.0pt;font-family:Arial'><o:p></o:p></span></b></p>
  </td>
  <td width=204 style='width:153.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  lang=EN-US style='font-size:8.0pt;font-family:Arial;mso-ansi-language:RU'> </span></b><b><span
  lang=EN-US style='font-size:8.0pt;font-family:Arial'>/</span></b><b><span
  style='font-size:8.0pt;font-family:Arial;mso-ansi-language:RU'> Курение: NO / Нет<o:p></o:p></span></b></p>
  </td>
 </tr>
...
<p class=MsoNormal style='margin-top:6.0pt;tab-stops:9.0pt'><b><span
lang=EN-US style='font-size:8.0pt;font-family:Arial;text-transform:uppercase'>3. abnormal test results:
</span></b><b><span lang=EN-US style='font-size:8.0pt;font-family:
Arial;text-transform:uppercase;mso-ansi-language:RU'><o:p></o:p></span></b></p>

<p class=MsoNormal style='margin-top:6.0pt;tab-stops:9.0pt'><b><span
lang=EN-US style='font-size:8.0pt;font-family:Arial;text-transform:uppercase'>4. missing or incomplete evidence:
on decision</span></b><b><span lang=EN-US style='font-size:8.0pt;font-family:
Arial;text-transform:uppercase;mso-ansi-language:RU'><o:p></o:p></span></b></p>

<p class=MsoNormal style='margin-top:6.0pt;tab-stops:9.0pt'><b><span
lang=EN-US style='font-size:8.0pt;font-family:Arial'>5. Decision / </span></b><b><span
...
<p class=MsoNormal style='margin-top:6.0pt;tab-stops:9.0pt'><b><span
lang=EN-US style='font-size:8.0pt;font-family:Arial;text-transform:uppercase'>6. comments
on decision</span></b><b><span lang=EN-US style='font-size:8.0pt;font-family:
...
<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span lang=EN-US
style='font-size:8.0pt;font-family:Arial'>Name of Underwriter / </span></b><b
style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;font-family:
