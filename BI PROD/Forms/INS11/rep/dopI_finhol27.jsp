...
основании Доверенности № 2009/203 от 12.02.2009 г., с одной стороны, и <%=strax_fio%>,
...
<p class=MsoNormal style='text-align:justify'><%=format.format(NUM_PP++)%>. Изложить пункт 3 раздела 
...
<p class=MsoNormal style='text-align:justify'><%=format.format(NUM_PP++)%>. Исключить Приложение № 1 к Договору. 
В связи с расторжением Договора в отношении программы "Инвест" исключить 
Приложение № 2 к Договору. Страхователю причитается выплата в размере выкупной суммы, <rw:field id="" src="s_surr"/> <rw:field id="" src="PA_KOD_VAL"/>
<% if (z.equals("1")) { %><% } else { %> Страхователь обязан 
