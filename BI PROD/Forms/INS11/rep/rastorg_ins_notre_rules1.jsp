...
style='mso-spacerun:yes'>  </span>п. 12.2.2. Правил страхования жизни / Правил страхования от несчастных случаев
 (по программе "Гармония жизни") с <i><rw:field id="f_decline_date" src="decline_date"/></i></span></p>
...
12.3.1, 12.3.2 Правил страхования, выплате подлежит «выкупная
