...
begin
 ...
 WHERE ac.ag_contract_id = ach.last_ver_id
   ...
   AND ach.ag_contract_header_id = :p_ch_id;
  exception
      when no_data_found then :NUM_VER := ''; :DEPT := ''; 
  end;
 return (TRUE);
...
@page Section1
	{size:595.3pt 841.9pt;
	margin:27.0pt 19.3pt 2.0cm 27.0pt;
	mso-header-margin:35.4pt;
	mso-footer-margin:35.4pt;
	mso-even-footer:url("ЗаявлениеСОГЛАШЕНИЕ.files/header.htm") ef1;
	mso-footer:url("ЗаявлениеСОГЛАШЕНИЕ.files/header.htm") f1;
	mso-paper-source:0;}
div.Section1
	{page:Section1;}
 /* List Definitions */
 @list l0
	{mso-list-id:328484087;
	mso-list-type:hybrid;
	mso-list-template-ids:-124380272 2059829336 68747267 68747269 68747265 68747267 68747269 68747265 68747267 68747269;}
@list l0:level1
	{mso-level-number-format:bullet;
	mso-level-text:\F0B7;
...
@list l0:level2
	...
	font-family:"Courier New";}
@list l1
	{mso-list-id:565072180;
	mso-list-type:hybrid;
	mso-list-template-ids:1189492022 -493480202 68747265 68747291 68747279 68747289 68747291 68747279 68747289 68747291;}
@list l1:level1
...
normal'><span style='font-size:10.5pt'>Заявление СОГЛАШЕНИЕ/ ЗАЯВЛЕНИЕ № <rw:field id="" src="NUM_VER"/> <o:p></o:p></span></b></p>

<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:10.5pt'>о безусловном присоединении к АГЕНТСКОМУ
ДОГОВОРУ (ПРИСОЕДИНЕНИЕ), <o:p></o:p></span></b></p>

<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:10.5pt'>утвержденному Управляющим директором ООО
«СК «Ренессанс Жизнь» Киселевым О.М. <o:p></o:p></span></b></p>

<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:10.5pt'><span
style='mso-spacerun:yes'> </span>«20» июня 2008 г. <st1:metricconverter
ProductID="2008 г" w:st="on">2008 г</st1:metricconverter>.<o:p></o:p></span></b></p>

<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:10.5pt'><o:p>&nbsp;</o:p></span></b></p>

<p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
normal'><span style='font-size:10.5pt'>К АГЕНТСКОМУ ДОГОВОРУ № <%=AGDOGNUM%> от <%=REG_DATE%>
 <o:p></o:p></span></b></p>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=732
 style='width:549.0pt;mso-cellspacing:0cm;mso-padding-alt:0cm 0cm 0cm 0cm'>
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  <td width=344 valign=top style='width:257.65pt;padding:0cm 0cm 0cm 0cm'>
  <p class=fr1 align=left style='margin:0cm;margin-bottom:.0001pt;text-align:
  left;tab-stops:467.8pt'><span style='font-size:10.5pt;font-family:"Times New Roman";
  font-weight:normal'>г. Москва</span><span style='font-size:10.5pt;font-weight:
  normal;mso-bidi-font-weight:bold'><o:p></o:p></span></p>
  </td>
  <td width=388 valign=top style='width:291.35pt;padding:0cm 0cm 0cm 0cm'>
  <p class=fr1 align=right style='margin:0cm;margin-bottom:.0001pt;text-align:
  right;tab-stops:467.8pt'><span style='font-size:10.5pt;font-family:"Times New Roman";
  color:#333333;font-weight:normal'><%=REG_DATE%></span><span style='font-size:
  10.5pt;font-weight:normal;mso-bidi-font-weight:bold'><o:p></o:p></span></p>
  </td>
 </tr>
</table>

<p class=MsoNormal style='text-align:justify'><span style='font-size:10.5pt'><span
...
«СТРАХОВЩИК», в лице <%=G_N_OBR%> <%=CHIEF_NAME%>, действующего на
основании Доверенности № <%=PNUM_DOC_DIR%>, выданной <%=DATAV_DOC_DIR%>, с одной
стороны, и <%=AGENT_NAME_INS%>, именуемый (-ая) в дальнейшем
«АГЕНТ», с другой стороны, составили и подписали настоящее Соглашение/Заявление
о безусловном присоединении к АГЕНТСКОМУ ДОГОВОРУ (ПРИСОЕДИНЕНИЕ),<span
style='mso-spacerun:yes'>  </span>утвержденному Управляющим директором ООО «СК
«Ренессанс Жизнь» Киселевым О.М.<span style='mso-spacerun:yes'>  </span>«20» июня 2008 г.
 <st1:metricconverter ProductID="2008 г" w:st="on">2008 г</st1:metricconverter>.
(Далее «Соглашение/Заявление») к Агентскому договору № <%=AGDOGNUM%> от 
<%=REG_DATE%> (далее – «Агентский Договор») о нижеследующем:<o:p></o:p></span></p>

<p class=MsoNormal style='margin-left:0cm;text-align:justify;text-indent:0cm;
mso-pagination:none;mso-list:l1 level1 lfo2;tab-stops:list 1.0cm'><![if !supportLists]><b
style='mso-bidi-font-weight:normal'><span style='font-size:10.5pt'><span
style='mso-list:Ignore'>1.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span></b><![endif]><span style='font-size:10.5pt'>Руководствуясь
взаимными интересами, Стороны договорились изменить способ заключения <span
style='text-transform:uppercase'>Агентского ДоговорА</span>. При этом Стороны
понимают и принимают <span style='text-transform:uppercase'>АгентскИЙ Договор </span>в
виде договора присоединения, условия которого определены в утвержденной <span
style='mso-spacerun:yes'> </span>СТРАХОВЩИКОМ форме, и могут быть приняты
АГЕНТОМ не иначе как путем присоединения к АГЕНТСКОМУ ДОГОВОРУ, указанному в п.
2 настоящего Соглашения/Заявления.<o:p></o:p></span></p>

<p class=MsoNormal style='margin-left:0cm;text-align:justify;text-indent:0cm;
mso-pagination:none;mso-list:l1 level1 lfo2;tab-stops:list 27.0pt'><![if !supportLists]><b
style='mso-bidi-font-weight:normal'><span style='font-size:10.5pt'><span
style='mso-list:Ignore'>2.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span></b><![endif]><span style='font-size:10.5pt'>Настоящим
Соглашением/Заявлением Агент присоединяется к условиям, изложенным в АГЕНТСКОМ
ДОГОВОРЕ (ПРИСОЕДИНЕНИЯ), утвержденным Управляющим директором ООО «СК
«Ренессанс Жизнь» Киселевым О.М.<span style='mso-spacerun:yes'>  </span>«20» июня 2008 г.
 <st1:metricconverter ProductID="2008 г" w:st="on">2008 г</st1:metricconverter>.
<o:p></o:p></span></p>

<p class=MsoNormal style='text-align:justify;mso-pagination:none'><span
style='font-size:10.5pt'>В соответствии с<span style='mso-spacerun:yes'> 
</span>АГЕНТСКИМ ДОГОВОРОМ (ПРИСОЕДИНЕНИЯ) СТРАХОВЩИК предоставляет АГЕНТУ
следующие полномочия:<o:p></o:p></span></p>

<h2 style='margin:0cm;margin-bottom:.0001pt;text-align:justify;text-indent:
0cm;mso-list:l0 level1 lfo1;tab-stops:list 27.0pt'><![if !supportLists]><span
style='font-size:8.0pt;font-family:Symbol;mso-fareast-font-family:Symbol;
mso-bidi-font-family:Symbol;font-weight:normal;font-style:normal'><span
style='mso-list:Ignore'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span style='font-size:10.5pt;font-family:"Times New Roman";
font-weight:normal;font-style:normal'>знакомить потенциальных страхователей с
условиями, Правилами страхования и тарифами СТРАХОВЩИКА;<o:p></o:p></span></h2>
...
font-weight:normal;font-style:normal'>проводить переговоры с потенциальными
страхователями о заключении ими со Страховщиком договоров страхования по видам,
указанным в АГЕНТСКОМ ДОГОВОРЕ (ПРИСОЕДИНЕНИЯ);<o:p></o:p></span></h2>
...
font-weight:normal;font-style:normal'>оформлять документы, необходимые для
...
А7 и т.п.) и передавать их СТРАХОВЩИКУ;<o:p></o:p></span></h2>
...
font-weight:normal;font-style:normal'>принимать и передавать в кассу
...
взносы), уплачиваемые страхователями по договорам страхования; <o:p></o:p></span></h2>
...
font-weight:normal;font-style:normal'>совершать иные действия, необходимые для
заключения договоров страхования в пределах полномочий (обязанностей),
предоставленных АГЕНТСКИМ <span style='text-transform:uppercase'>Договором </span>(ПРИСОЕДИНЕНИЯ)
(Доверенностью при необходимости), а также содействовать заключению
Страховщиком договоров страхования с физическими и юридическими лицами путем
привлечения к заключению агентских договоров со СТРАХОВЩИКОМ физических лиц и
юридических лиц (Банков, Брокеров).<o:p></o:p></span></h2>

<p class=MsoNormal style='margin-left:0cm;text-align:justify;text-indent:0cm;
mso-pagination:none;mso-list:l1 level1 lfo2;tab-stops:list 1.0cm'><![if !supportLists]><b
style='mso-bidi-font-weight:normal'><span style='font-size:10.5pt'><span
style='mso-list:Ignore'>3.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span></b><![endif]><span style='font-size:10.5pt'>С момента
присоединения Агента к <span style='text-transform:uppercase'>АгентскоМУ
ДоговорУ (ПРИСОЕДИНЕНИЯ),</span> прежняя редакция <span style='text-transform:
uppercase'>Агентского ДоговорА</span>, включая все Приложения и Дополнительные
соглашения к нему, заключенные до момента подписания настоящего Соглашения/Заявления,
утрачивают силу,<span style='mso-spacerun:yes'>  </span>вместе с тем, сохраняет
юридическую силу номер <span style='text-transform:uppercase'>Агентского
ДоговорА</span> и дата его заключения, а также<span style='mso-spacerun:yes'> 
</span>реквизиты Сторон.<span style='mso-spacerun:yes'>  </span><o:p></o:p></span></p>

<p class=MsoNormal style='margin-left:0cm;text-align:justify;text-indent:0cm;
mso-pagination:none;mso-list:l1 level1 lfo2;tab-stops:list 1.0cm'><![if !supportLists]><b
style='mso-bidi-font-weight:normal'><span style='font-size:10.5pt;text-transform:
uppercase'><span style='mso-list:Ignore'>4.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span></b><![endif]><span style='font-size:10.5pt'>Стороны
договорились о том, что действие <span style='text-transform:uppercase'>Агентского
ДоговорА (ПРИСОЕДИНЕНИЯ), </span>утвержденного Управляющим директором ООО «СК
«Ренессанс Жизнь» Киселевым О.М.<span style='mso-spacerun:yes'>  </span>«20» июня 2008 г.
 <st1:metricconverter ProductID="2008 г" w:st="on">2008 г</st1:metricconverter>.,
распространяются на отношения, фактически существовавшие между сторонами до подписания
настоящего Соглашения/Заявления<span style='mso-spacerun:yes'>  </span>и присоединения
АГЕНТА к указанному <span style='text-transform:uppercase'>Агентскому договору
(ПРИСОЕДИНЕНИЯ), </span>а именно в части:<span style='text-transform:uppercase'>
<o:p></o:p></span></span></p>

<p class=MsoNormal style='margin-left:0cm;text-align:justify;text-indent:0cm;
mso-pagination:none;mso-list:l1 level2 lfo2;tab-stops:list 72.0pt'><![if !supportLists]><span
style='font-size:10.5pt;font-family:Symbol;mso-fareast-font-family:Symbol;
mso-bidi-font-family:Symbol'><span style='mso-list:Ignore'>·<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span style='font-size:10.5pt'>пункт 3.5. Приложения
№2&nbsp; к <span style='text-transform:uppercase'>Агентскому Договору </span>с
01.08.2007 года;<o:p></o:p></span></p>
...
mso-bidi-font-family:Symbol'><span style='mso-list:Ignore'>·<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span style='font-size:10.5pt'>Приложение №
2&nbsp; к <span style='text-transform:uppercase'>Агентскому Договору </span>с
01.10.2007 года;<o:p></o:p></span></p>
...
mso-bidi-font-family:Symbol'><span style='mso-list:Ignore'>·<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span style='font-size:10.5pt'>пункты 4.6, 4.7.
Приложения №1 к <span style='text-transform:uppercase'>Агентскому Договору </span>с
01.12.2007 года;<o:p></o:p></span></p>
...
mso-bidi-font-family:Symbol'><span style='mso-list:Ignore'>·<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span style='font-size:10.5pt'>пункт 5
Приложения № 1к <span style='text-transform:uppercase'>Агентскому Договору<span
style='mso-spacerun:yes'>  </span></span>с<span style='text-transform:uppercase'>
</span>01.12.2007 года.<o:p></o:p></span></p>

<p class=MsoNormal style='margin-left:0cm;text-align:justify;text-indent:0cm;
mso-pagination:none;mso-list:l1 level1 lfo2;tab-stops:list 1.0cm'><![if !supportLists]><b
style='mso-bidi-font-weight:normal'><span style='font-size:10.5pt'><span
style='mso-list:Ignore'>5.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span></b><![endif]><span style='font-size:10.5pt'>Подписывая
настоящее Соглашение/Заявление АГЕНТ подтверждает ознакомление с текстом АГЕНТСКОГО
ДОГОВОРА <span style='text-transform:uppercase'>(ПРИСОЕДИНЕНИЯ),</span> утвержденного
Управляющим директором ООО «СК «Ренессанс Жизнь» Киселевым О.М.<span
style='mso-spacerun:yes'>  </span>«20» июня 2008 г. <st1:metricconverter
ProductID="2008 г" w:st="on">2008 г</st1:metricconverter>. <o:p></o:p></span></p>

<p class=MsoNormal style='margin-left:0cm;text-align:justify;text-indent:0cm;
mso-pagination:none;mso-list:l1 level1 lfo2;tab-stops:list 1.0cm'><![if !supportLists]><b
style='mso-bidi-font-weight:normal'><span style='font-size:10.5pt'><span
style='mso-list:Ignore'>6.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span></b><![endif]><span style='font-size:10.5pt'>Настоящее Соглашение/Заявление
составлено в двух экземплярах, по одному экземпляру для каждой из Сторон. <o:p></o:p></span></p>

<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 style='margin-left:32.4pt;border-collapse:collapse;mso-yfti-tbllook:480;
 mso-padding-alt:0cm 5.4pt 0cm 5.4pt'>
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  <td width=339 valign=top style='width:253.95pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal style='text-align:justify'><b style='mso-bidi-font-weight:
  normal'><span style='font-size:10.5pt'>Директор Филиала/Агентства <o:p></o:p></span></b></p>
  <p class=MsoNormal style='text-align:justify'><b style='mso-bidi-font-weight:
  normal'><span style='font-size:10.5pt'>ООО «СК «Ренессанс Жизнь» в
  городе <rw:field id="" src="DEPT"/><o:p></o:p></span></b></p>
  </td>
  <td width=299 valign=top style='width:224.6pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal style='text-align:justify'><b style='mso-bidi-font-weight:
  normal'><span style='font-size:10.5pt'>ФИО АГЕНТА <%=AGNAME%></span></b><b
  style='mso-bidi-font-weight:normal'><span style='font-size:10.5pt;font-family:
  Tahoma;color:#666666'><o:p></o:p></span></b></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:25.7pt'>
  <td width=339 valign=top style='width:253.95pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:25.7pt'>
  <p class=MsoNormal style='text-align:justify'><span style='font-size:10.5pt'>______________________/________________/<o:p></o:p></span></p>
  </td>
  <td width=299 valign=top style='width:224.6pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:25.7pt'>
  <p class=MsoNormal style='text-align:justify'><span style='font-size:10.5pt'>__________________/_________________/<o:p></o:p></span></p>
  </td>
 </tr>
</table>
