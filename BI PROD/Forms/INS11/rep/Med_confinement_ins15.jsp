 ...
 beforeReportTrigger="beforereport">
  ...
  <data>
    ...
    <userParameter name="AS_ASSURED_ID" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
     <userParameter name="INS_PWOP" datatype="character" width="400"
     precision="10" defaultWidth="0" defaultHeight="0"/>
     <userParameter name="INS_RISK" datatype="character" width="400"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="INS_DECL" datatype="character" width="400"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="INS_COEF_M" datatype="character" width="400"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="INS_COEF_NM" datatype="character" width="400"
     precision="10" defaultWidth="0" defaultHeight="0"/>
     <userParameter name="INS" datatype="character" width="200"
     defaultWidth="0" defaultHeight="0"/>
     <userParameter name="INS_DATE_BIRTH" datatype="character" width="400"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="INS_GENDER" datatype="character" width="400"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="INS_PROF" datatype="character" width="150"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="INS_AGE" datatype="character" width="400"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    <userParameter name="POL_ID" datatype="character" width="150"
     precision="10" defaultWidth="0" defaultHeight="0"/>
    ...
    <dataSource name="Q_Title">
      <select canParse="no">
      <![CDATA[select distinct vass.AS_ASSURED_ID,ame.underwriting_note,
...
where vass.AS_ASSURED_ID = asd.AS_ASSURED_ID(+) 
 ...
 decode(plo.description,'Освобождение от уплаты дальнейших взносов', null,
              'Защита страховых взносов',null,
	'Освобождение от уплаты страховых взносов',null,
	'Защита страховых взносов расчитанная по основной программе',null,
	'Освобождение от уплаты взносов расчитанное по основной программе',null,
	'Освобождение от уплаты дальнейших взносов расчитанное по основной программе',null,
...
decode(plo.description, 
             'Освобождение от уплаты дальнейших взносов', null,
             'Защита страховых взносов',null,
	'Освобождение от уплаты страховых взносов',null,
	'Защита страховых взносов расчитанная по основной программе',null,
	'Освобождение от уплаты взносов расчитанное по основной программе',null,
...
decode(nvl(pc.K_COEF_NM,0),0,decode(nvl(pc.S_COEF_NM,0),0,' ','+'||to_char(pc.S_COEF_NM)||'‰'),'+'||to_char(pc.K_COEF_NM)||'%') K_COEF_NM
    ...
    <dataSource name="Q_MO">
      <select>
      <![CDATA[select a.*,
decode(nvl(to_number(replace(rost,',','.'), '999D99'),0),0,0,round( nvl(to_number( replace(ves,',','.'), '999D99' ) ,0)/((to_number(replace(rost,',','.'), '999D99')*to_number(replace(rost,',','.'), '999D99'))/10000),0)) bmi
 from
(
...
begin
select ic.obj_name_orig,
	 nvl(to_char(per.date_of_birth,'dd.mm.yyyy'),' '),
decode(nvl(per.GENDER,0),0,'Женский',1,'Мужской'), 
nvl(prof.description,''),
nvl(trunc((sysdate-per.date_of_birth) / 365),0)
into :INS, :ins_date_birth, :ins_gender, :ins_prof, :ins_age
from p_policy pp,
        p_pol_header ph,
        p_policy_contact ii,
        contact ic,
...
where pp.policy_id = ph.policy_id
           and ii.policy_id = pp.policy_id and ii.contact_policy_role_id = 6
           and ii.contact_id = ic.contact_id (+)
           and ii.contact_id = per.contact_id (+)
           and per.profession = prof.id (+)
           and pp.policy_id = :POL_ID;
exception
      when no_data_found then  :INS:=' '; :ins_date_birth:=' '; :ins_gender:=' '; :ins_prof:=' '; :ins_age:=' ';
end;
...
select
upper(ll.BRIEF),
decode(ll.BRIEF,'PWOP_Life', 'X','PWOP', 'X',' '),
decode(hh.exp,1,'Decl',' '),
decode(nvl(pc.K_COEF_M,0),0,decode(nvl(pc.S_COEF_M,0),0,' ','+'||to_char(pc.S_COEF_M)||'‰'),'+'||to_char(pc.K_COEF_M)||'%'), 
decode(nvl(pc.K_COEF_NM,0),0,decode(nvl(pc.S_COEF_NM,0),0,' ','+'||to_char(pc.S_COEF_NM)||'‰'),'+'||to_char(pc.K_COEF_NM)||'%')
into :ins_risk, :ins_pwop, :ins_decl, :ins_coef_m, :ins_coef_nm
    from 
        ven_p_policy pp, 
        ven_as_asset ass, 
        ven_p_cover pc, 
        ...
        ven_t_product_line_type plt,
        t_lob_line ll,
       (select decode(pcp.p_cover_id, null,0,1) exp, pcp.p_cover_id
        from p_cover pcp,
               STATUS_HIST sh 
        where pcp.as_asset_id = :AS_ASSURED_ID
                  and sh.STATUS_HIST_ID = pcp.STATUS_HIST_ID 
                  and sh.brief = 'DELETED') hh
    where ass.p_policy_id = pp.policy_id
     and pc.as_asset_id = ass.as_asset_id
     and plo.id = pc.t_prod_line_option_id
     and plo.product_line_id = pl.id
     ...
     and plt.brief in ('RECOMMENDED','OPTIONAL','MANDATORY')
     and upper(trim(plo.description)) <> 'АДМИНИСТРАТИВНЫЕ ИЗДЕРЖКИ'
     and (ll.BRIEF = 'PWOP_Life' or ll.brief = 'PWOP')
     and pc.p_cover_id = hh.p_cover_id (+)
     and ass.AS_ASSET_ID =  :AS_ASSURED_ID;
  exception
      when no_data_found then :ins_risk := ' '; :ins_pwop := ' '; :ins_decl :=' '; :ins_coef_m  := ' '; :ins_coef_nm  := ' ';
  end;
...
<table class=TableGrid1 border=0 cellspacing=0 cellpadding=0 width=691
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  ...
  lang=EN-US style='font-size:8.0pt;line-height:150%;font-family:Arial'>Insurer
  Person/</span></b><b><span style='font-size:8.0pt;line-height:150%;
  font-family:Arial;mso-ansi-language:RU'>Страхователь<o:p></o:p></span></b></p>
  </td>
  ...
  RU;mso-bidi-font-weight:bold'><o:p><rw:field id="" src="INS"/></rw:field></o:p></span></p>
  </td>
 ...
 <tr style='mso-yfti-irow:1'>
  ...
  <p class=MsoNormal style='line-height:150%;tab-stops:18.0pt'><span
  style='font-size:9.0pt;line-height:150%;font-family:Arial;mso-ansi-language:
  RU;mso-bidi-font-weight:bold'><o:p><rw:field id="" src="INS_DATE_BIRTH" formatMask="DD.MM.YYYY"></rw:field></o:p></span></p>
  </td>
  <td width=180 valign=top style='width:135.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal style='line-height:150%;tab-stops:18.0pt'><b><span
...
<table class=TableGrid1 border=1 cellspacing=0 cellpadding=0 width=696
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:15.8pt'>
  ...
  font-family:Arial;mso-ansi-language:RU;mso-bidi-font-weight:bold'><o:p><rw:field id="" src="INS_AMOUNT_OLD_CEL" formatMask="999 999 990"></rw:field></o:p></span></p>
  </td>
...
<table class=TableNormal1 border=1 cellspacing=0 cellpadding=0 width=696
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:24.5pt'>
  ...
  font-family:Arial;mso-ansi-language:RU;mso-bidi-font-weight:bold'><o:p><rw:field id="" src="INS_GENDER"></rw:field></o:p></span></p>
  </td>
  ...
  <p class=MsoNormal align=center style='text-align:center;tab-stops:18.0pt'><span
  style='font-size:9.0pt;font-family:Arial;mso-ansi-language:RU;mso-bidi-font-weight:
  bold'><o:p><rw:field id="" src="INS_AGE"></rw:field></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:25.2pt'>
  ...
  <p class=MsoNormal><b><span style='font-size:8.0pt;font-family:Arial;mso-ansi-language:
  RU'><o:p><rw:field id="" src="INS_PROF"></rw:field></o:p></span></b></p>
  </td>
 </tr>
</table>
...
<table class=TableNormal1 border=1 cellspacing=0 cellpadding=0 width=696
 ...
 <tr style='mso-yfti-irow:3;page-break-inside:avoid;height:21.75pt'>
  ...
  style='font-size:9.0pt;font-weight:normal;mso-bidi-font-weight:bold'><o:p>&nbsp;</rw:field></o:p></span></h2>
  </td>
  <td width=108 style='width:81.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  ...
  style='font-size:9.0pt;font-family:Arial;mso-ansi-language:RU'><o:p>&nbsp;</rw:field></o:p></span></p>
  </td>
  <td width=60 style='width:45.0pt;border-top:none;border-left:none;border-bottom:
  solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
  solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
...
<table class=TableNormal1 border=1 cellspacing=0 cellpadding=0 width=696
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:21.75pt'>
  ...
  solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:21.75pt'>
  <p class=MsoNormal style='margin-left:2.85pt'><span style='font-size:9.0pt;
  font-family:Arial;mso-ansi-language:RU'>&nbsp;</rw:field></span><span style='font-size:
  9.0pt;font-family:Arial;mso-ansi-language:RU'><o:p></o:p></span></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:3;height:25.85pt'>
  ...
  RU;mso-bidi-font-weight:bold'><o:p>&nbsp;</rw:field></o:p></span></p>
  </td>
  <td width=72 style='width:54.0pt;border-top:none;border-left:none;border-bottom:
  solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
  solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  ...
  style='font-size:9.0pt;font-family:Arial;mso-bidi-font-weight:bold'><o:p>&nbsp;</rw:field></o:p></span></p>
  </td>
  <td width=108 style='width:81.0pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
 ...
 <tr style='mso-yfti-irow:7;mso-yfti-lastrow:yes;page-break-inside:avoid;
  ...
  style='font-size:9.0pt;font-family:Arial'><o:p>&nbsp;</rw:field></o:p></span></p>
  </td>
 </tr>
</table>
...
<rw:getValue id="j_has_pwop" src="ins_pwop"/>
<% if (!j_has_pwop.equals("X")) { %><% }
else { %> 
...
<tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:13.5pt'>
  ...
  <p class=MsoNormal align=center style='text-align:center'><b><span
  lang=EN-US style='font-size:8.0pt;font-family:Arial'><o:p><rw:field id="" src="INS_RISK"></rw:field></o:p></span></b></p>
  </td>
  <td width=120 valign=top style='width:90.0pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:13.5pt'>
  <p align="center" class=MsoNormal><span lang=EN-US style='font-size:9.0pt;font-family:Arial'><o:p><rw:field id="" src="INS_COEF_M"></rw:field></o:p></span></p>
  </td>
  <td width=120 valign=top style='width:90.0pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:13.5pt'>
  <p align="center" class=MsoNormal><span lang=EN-US style='font-size:9.0pt;font-family:Arial'><o:p><rw:field id="" src="INS_COEF_NM"></rw:field></o:p></span></p>
  </td>
  <td width=120 valign=top style='width:90.0pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:13.5pt'>
  <p align="center" class=MsoNormal><span lang=EN-US style='font-size:9.0pt;font-family:Arial'><o:p><rw:field id="" src="INS_DECL"></rw:field></o:p></span></p>
  </td>
...
style='mso-spacerun:yes'>  </span><u><rw:foreach id="G_ANDERRAITER" src="G_ANDERRAITER"> <rw:field id="" src="ANDERRAITER"></rw:field> </rw:foreach></u><o:p></o:p></span></span></b></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span lang=EN-US
style='font-size:8.0pt;font-family:Arial'><o:p>&nbsp;</o:p></span></b></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
style='font-size:8.0pt;font-family:Arial;mso-ansi-language:RU'>К.Д</span></b><b
style='mso-bidi-font-weight:normal'><span lang=EN-US style='font-size:8.0pt;
font-family:Arial'>. </span></b><b style='mso-bidi-font-weight:normal'><span
style='font-size:8.0pt;font-family:Arial;mso-ansi-language:RU'>Палванова</span></b><b
style='mso-bidi-font-weight:normal'><span lang=EN-US style='font-size:8.0pt;
font-family:Arial'><span style='mso-tab-count:3'>                                               </span></span></b><span
lang=EN-US style='font-size:9.0pt;font-family:Arial'>___________________________<span
style='mso-tab-count:1'>               </span>______/________/_________</span><b
style='mso-bidi-font-weight:normal'><span lang=EN-US style='font-size:8.0pt;
