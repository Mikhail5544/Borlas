...
<report name="letter_rastorg_notretnew" DTDVersion="9.0.2.0.10">
  <data>
...
<title>Письмо-уведомление о расторжении в связи с неуплатой очередного взноса (отсутствие необходимости возврата выкупной суммы и новые условия страхования)</title>
<style>
<!--
 /* Font Definitions */
 @font-face
